...
class  TorQLParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    ...
    RuleTorqlxTagElement = 60, RuleTorqlxTagAttribute = 61, RuleWithExprList = 62,
  ...
  explicit TorQLParser(antlr4::TokenStream *input);

  TorQLParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~TorQLParser() override;
  ...
  class TorqlxTagElementContext;
  class TorqlxTagAttributeContext;
  ...
  public:
    TorQLParser::IdentifierContext *catchVar = nullptr;
    TorQLParser::IdentifierContext *catchType = nullptr;
    TorQLParser::BlockContext *catchStmt = nullptr;
  ...
  public:
    TorQLParser::BlockContext *tryStmt = nullptr;
    TorQLParser::BlockContext *finallyStmt = nullptr;
  ...
  public:
    TorQLParser::VarDeclContext *initializerVarDeclr = nullptr;
    TorQLParser::VarAssignmentContext *initializerVarAssignment = nullptr;
    TorQLParser::ExpressionContext *initializerExpression = nullptr;
    TorQLParser::ExpressionContext *condition = nullptr;
    TorQLParser::VarDeclContext *incrementVarDeclr = nullptr;
    TorQLParser::VarAssignmentContext *incrementVarAssignment = nullptr;
    TorQLParser::ExpressionContext *incrementExpression = nullptr;
  ...
  public:
    ...
    TorqlxTagElementContext *torqlxTagElement();
  ...
  public:
    TorQLParser::WithClauseContext *with = nullptr;
    TorQLParser::ColumnExprListContext *columns = nullptr;
    TorQLParser::FromClauseContext *from = nullptr;
    TorQLParser::WhereClauseContext *where = nullptr;
  ...
  public:
    ...
    TorQLParser::ColumnExprContext *left = nullptr;
    antlr4::Token *operator_ = nullptr;
    TorQLParser::ColumnExprContext *right = nullptr;
    std::vector<ColumnExprContext *> columnExpr();
    ColumnExprContext* columnExpr(size_t i);
  ...
  public:
    ...
    TorQLParser::ColumnExprListContext *columnExprs = nullptr;
    TorQLParser::ColumnExprListContext *columnArgList = nullptr;
    std::vector<IdentifierContext *> identifier();
    IdentifierContext* identifier(size_t i);
  ...
  public:
    ...
    TorQLParser::ColumnExprContext *caseExpr = nullptr;
    TorQLParser::ColumnExprContext *whenExpr = nullptr;
    TorQLParser::ColumnExprContext *thenExpr = nullptr;
    TorQLParser::ColumnExprContext *elseExpr = nullptr;
  ...
  class  TorqlxTagElementContext : public antlr4::ParserRuleContext {
  public:
    TorqlxTagElementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
   
    TorqlxTagElementContext() = default;
    void copyFrom(TorqlxTagElementContext *context);
    using antlr4::ParserRuleContext::copyFrom;
  ...
  class  TorqlxTagElementClosedContext : public TorqlxTagElementContext {
  public:
    TorqlxTagElementClosedContext(TorqlxTagElementContext *ctx);

    antlr4::tree::TerminalNode *LT();
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *SLASH();
    antlr4::tree::TerminalNode *GT();
    std::vector<TorqlxTagAttributeContext *> torqlxTagAttribute();
    TorqlxTagAttributeContext* torqlxTagAttribute(size_t i);

    virtual std::any accept(antlr4::tree::ParseTreeVisitor *visitor) override;
  };

  class  TorqlxTagElementNestedContext : public TorqlxTagElementContext {
  public:
    TorqlxTagElementNestedContext(TorqlxTagElementContext *ctx);
  ...
  class  TorqlxTagAttributeContext : public antlr4::ParserRuleContext {
  public:
    TorqlxTagAttributeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
    antlr4::tree::TerminalNode *EQ_SINGLE();
    StringContext *string();
  ...
  TorqlxTagAttributeContext* torqlxTagAttribute();
