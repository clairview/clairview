...
from markettor.kafka_client.topics import KAFKA_CLICKHOUSE_SESSION_REPLAY_EVENTS
from markettor.models import Organization, Team
from markettor.models.event.util import format_clickhouse_timestamp
from markettor.test.base import APIBaseTest, ClickhouseTestMixin, QueryMatchingTest, snapshot_clickhouse_queries
    ...
    def _create_heatmap_event(
        ...
        p.produce(
            ...
            data={
                ...
                "type": type,
                "pointer_target_fixed": True,
                "current_url": current_url if current_url else "http://markettor.com",
            },
        )
