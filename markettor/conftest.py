...
from markettor.models.raw_sessions.sql import TRUNCATE_RAW_SESSIONS_TABLE_SQL
from markettor.test.base import MarketTorTestCase, run_clickhouse_statement_in_parallel


def create_clickhouse_tables(num_tables: int):
    # Create clickhouse tables to default before running test
    # Mostly so that test runs locally work correctly
    from markettor.clickhouse.schema import (
        CREATE_DATA_QUERIES,
...
def reset_clickhouse_tables():
    ...
    from markettor.clickhouse.plugin_log_entries import (
        TRUNCATE_PLUGIN_LOG_ENTRIES_TABLE_SQL,
    )
    from markettor.heatmaps.sql import TRUNCATE_HEATMAPS_TABLE_SQL
    from markettor.models.app_metrics.sql import TRUNCATE_APP_METRICS_TABLE_SQL
    from markettor.models.channel_type.sql import TRUNCATE_CHANNEL_DEFINITION_TABLE_SQL
    from markettor.models.cohort.sql import TRUNCATE_COHORTPEOPLE_TABLE_SQL
    from markettor.models.event.sql import TRUNCATE_EVENTS_TABLE_SQL
    from markettor.models.group.sql import TRUNCATE_GROUPS_TABLE_SQL
    from markettor.models.performance.sql import TRUNCATE_PERFORMANCE_EVENTS_TABLE_SQL
    ...
    from markettor.models.sessions.sql import TRUNCATE_SESSIONS_TABLE_SQL
