...
from markettor.clickhouse.log_entries import TRUNCATE_LOG_ENTRIES_TABLE_SQL
from markettor.constants import AvailableFeature
from markettor.models import Cohort, GroupTypeMapping, Person
...
class TestSessionRecordingsListFromFilters(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_operand_or_person_filters(self):
        ...
        Person.objects.create(team=self.team, distinct_ids=[user], properties={"email": "test@markettor.com"})

        second_user = "test_operand_or_filter-second_user"
        Person.objects.create(team=self.team, distinct_ids=[second_user], properties={"email": "david@markettor.com"})
    ...
    def test_top_level_event_host_property_test_account_filter(self):
        """
        This is a regression test. See: https://markettorhelp.zendesk.com/agent/tickets/18059
        """
        self.team.test_account_filters = [
