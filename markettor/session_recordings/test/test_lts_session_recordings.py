...
# see: https://github.com/MarketTor/markettor/blob/8ff764bb573c6a98368b2ae3503890551a1c3842/markettor/session_recordings/session_recording_helpers.py#L277
...
class TestSessionRecordings(APIBaseTest, ClickhouseTestMixin, QueryMatchingTest):
    ...
    @patch("markettor.session_recordings.session_recording_api.stream_from", return_value=setup_stream_from())
    @patch("markettor.session_recordings.session_recording_api.object_storage.tag")
    @patch("markettor.session_recordings.session_recording_api.object_storage.write")
    @patch("markettor.session_recordings.session_recording_api.object_storage.read")
    @patch("markettor.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch("markettor.session_recordings.session_recording_api.object_storage.list_objects")
