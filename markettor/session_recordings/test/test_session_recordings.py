...
from markettor.models import Organization, Person, SessionRecording
...
from markettor.session_recordings.test import setup_stream_from
...
class TestSessionRecordings(APIBaseTest, ClickhouseTestMixin, QueryMatchingTest):
    ...
    @patch("markettor.session_recordings.session_recording_api.SessionRecordingListFromFilters")
    ...
    @patch(
        "markettor.session_recordings.queries.session_replay_events.SessionReplayEvents.exists",
        return_value=True,
    )
    @patch("markettor.session_recordings.session_recording_api.object_storage.list_objects")
    ...
    @patch("markettor.session_recordings.session_recording_api.SessionRecording.get_or_build")
    @patch("markettor.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch("markettor.session_recordings.session_recording_api.stream_from", return_value=setup_stream_from())
    ...
    @patch("markettor.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch(
        "markettor.session_recordings.session_recording_api.stream_from",
    ...
    @patch("markettor.session_recordings.session_recording_api.SessionRecording.get_or_build")
    @patch("markettor.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch("markettor.session_recordings.session_recording_api.stream_from")
    ...
    @patch("markettor.session_recordings.session_recording_api.SessionRecording.get_or_build")
    @patch("markettor.session_recordings.session_recording_api.get_realtime_snapshots")
    @patch("markettor.session_recordings.session_recording_api.stream_from")
    def test_can_get_session_recording_realtime(
        ...
        see: https://markettor.sentry.io/issues/4981128697/
        """
