...
# DEPRECATED: MarketTor model is no longer supported or used
class SessionRecordingEvent(models.Model):
    ...
    class Meta:
        indexes = [
            ...
            # The migration is in 0110, and see https://github.com/MarketTor/markettor/issues/4969 for more info
