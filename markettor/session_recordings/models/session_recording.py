...
from markettor.session_recordings.models.metadata import (
...
from markettor.tasks.tasks import ee_persist_single_recording
...
class SessionRecording(UUIDModel):
    ...
    # Note: UUIDT is the MarketTor standard, but session_id's are generated with a different util in markettor-js
    # https://github.com/MarketTor/markettor-js/blob/e0dc2c005cfb5dd62b7c876676bcffe1654417a7/src/utils.ts#L457-L458
