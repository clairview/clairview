...
from markettor.metrics import LABEL_RESOURCE_TYPE
from markettor.session_recordings.models.metadata import (
    SessionRecordingEventSummary,
)
from markettor.utils import flatten
...
def preprocess_replay_events(
    ...
    1. Since markettor-js {version} we are grouping events on the frontend in a batch and passing their size in $snapshot_bytes
