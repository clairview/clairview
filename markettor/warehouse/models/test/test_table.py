...
from markettor.hogql.database.models import DateTimeDatabaseField, IntegerDatabaseField, StringDatabaseField
from markettor.test.base import BaseTest
from markettor.warehouse.models import DataWarehouseCredential, DataWarehouseTable
...
class TestTable(BaseTest):
    def test_get_columns(self):
        ...
        with patch("markettor.warehouse.models.table.sync_execute") as sync_execute_results:
