...
from markettor.models.utils import CreatedMetaFields, UUIDModel, UpdatedMetaFields, sane_repr
from markettor.settings import TEST
from markettor.warehouse.s3 import get_s3_client
...
class ExternalDataJob(CreatedMetaFields, UpdatedMetaFields, UUIDModel):
    ...
    pipeline = models.ForeignKey("markettor.ExternalDataSource", related_name="jobs", on_delete=models.CASCADE)
    schema = models.ForeignKey("markettor.ExternalDataSchema", on_delete=models.CASCADE, null=True, blank=True)
...
def get_external_data_job(job_id: UUID) -> ExternalDataJob:
    from markettor.warehouse.models import ExternalDataSchema
