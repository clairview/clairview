...
from markettor.cloud_utils import is_cloud, is_ci
from markettor.hogql import ast
from markettor.hogql.ast import (
    ArrayType,
    BooleanType,
    DateTimeType,
    DateType,
...
from markettor.hogql.base import ConstantType, UnknownType
...
HOGQL_MARKETTOR_FUNCTIONS: dict[str, HogQLFunctionMeta] = {
...
if is_cloud() or is_ci():
    from markettor.udf_versioner import augment_function_name
...
def find_hogql_markettor_function(name: str) -> Optional[HogQLFunctionMeta]:
    return _find_function(name, HOGQL_MARKETTOR_FUNCTIONS)
