from markettor.hogql.ast import FloatType, IntegerType
from markettor.test.base import BaseTest
from typing import Optional
from markettor.hogql.functions.mapping import (
    compare_types,
    find_hogql_function,
...
class TestMappings(BaseTest):
    ...
    def _get_hogql_markettor_function(self, name: str) -> HogQLFunctionMeta:
        return self._return_present_function(find_hogql_markettor_function(name))
    ...
    def test_find_case_sensitive_function(self):
        ...
        self.assertEqual(self._get_hogql_markettor_function("sparkline").clickhouse_name, "sparkline")
        self.assertEqual(find_hogql_markettor_function("SPARKLINE"), None)
    ...
    def test_find_non_existent_function(self):
        ...
        self.assertEqual(find_hogql_markettor_function("functionThatDoesntExist"), None)
