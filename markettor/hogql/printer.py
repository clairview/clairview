...
from markettor.hogql.base import AST
from markettor.hogql.constants import (
    MAX_SELECT_RETURNED_ROWS,
    HogQLGlobalSettings,
)
from markettor.hogql.functions import (
    ADD_OR_NULL_DATETIME_FUNCTIONS,
    FIRST_ARG_DATETIME_FUNCTIONS,
    find_hogql_aggregation,
    find_hogql_markettor_function,
    find_hogql_function,
)
from markettor.hogql.context import HogQLContext
from markettor.hogql.database.models import Table, FunctionCallTable, SavedQuery
from markettor.hogql.database.database import create_hogql_database
from markettor.hogql.database.s3_table import S3Table
from markettor.hogql.errors import ImpossibleASTError, InternalHogQLError, QueryError, ResolutionError
from markettor.hogql.escape_sql import (
    escape_clickhouse_identifier,
    escape_clickhouse_string,
    escape_hogql_identifier,
    escape_hogql_string,
)
from markettor.hogql.functions.mapping import ALL_EXPOSED_FUNCTION_NAMES, validate_function_args, HOGQL_COMPARISON_MAPPING
from markettor.hogql.modifiers import create_default_modifiers_for_team, set_default_in_cohort_via
from markettor.hogql.resolver import resolve_types
from markettor.hogql.resolver_utils import lookup_field_by_name
from markettor.hogql.transforms.in_cohort import resolve_in_cohorts, resolve_in_cohorts_conjoined
from markettor.hogql.transforms.lazy_tables import resolve_lazy_tables
from markettor.hogql.transforms.property_types import build_property_swapper, PropertySwapper
from markettor.hogql.visitor import Visitor, clone_expr
...
class _Printer(Visitor):
    ...
    def visit_call(self, node: ast.Call):
        ...
        elif func_meta := find_hogql_markettor_function(node.name):
            validate_function_args(node.args, func_meta.min_args, func_meta.max_args, node.name)
            args = [self.visit(arg) for arg in node.args]
