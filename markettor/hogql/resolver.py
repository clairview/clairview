...
from markettor.hogql.ast import ConstantType, FieldTraverserType
...
from markettor.hogql.database.schema.persons import PersonsTable
from markettor.hogql.errors import ImpossibleASTError, QueryError, ResolutionError
from markettor.hogql.functions import find_hogql_markettor_function
from markettor.hogql.functions.action import matches_action
from markettor.hogql.functions.cohort import cohort_query_node
from markettor.hogql.functions.mapping import HOGQL_CLICKHOUSE_FUNCTIONS, compare_types, validate_function_args
from markettor.hogql.functions.recording_button import recording_button
from markettor.hogql.functions.sparkline import sparkline
from markettor.hogql.hogqlx import HOGQLX_COMPONENTS, convert_to_hx
from markettor.hogql.parser import parse_select
from markettor.hogql.resolver_utils import expand_hogqlx_query, lookup_cte_by_name, lookup_field_by_name
from markettor.hogql.visitor import CloningVisitor, TraversingVisitor, clone_expr
...
class Resolver(CloningVisitor):
    ...
    def visit_call(self, node: ast.Call):
        ...
        if func_meta := find_hogql_markettor_function(node.name):
