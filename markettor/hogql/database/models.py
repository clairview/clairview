...
from markettor.hogql.errors import ResolutionError, NotImplementedError

if TYPE_CHECKING:
    from markettor.hogql.context import HogQLContext
    from markettor.hogql.ast import SelectQuery, LazyJoinType
    from markettor.hogql.base import ConstantType
...
class DatabaseField(FieldOrTable):
    ...
    def get_constant_type(self) -> "ConstantType":
        from markettor.hogql.ast import UnknownType
...
class IntegerDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from markettor.hogql.ast import IntegerType
...
class FloatDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from markettor.hogql.ast import FloatType
...
class StringDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from markettor.hogql.ast import StringType
...
class DateDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from markettor.hogql.ast import DateType
...
class DateTimeDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from markettor.hogql.ast import DateTimeType
...
class BooleanDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from markettor.hogql.ast import BooleanType
