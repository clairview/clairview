...
from markettor.hogql.ast import CompareOperationOp, ArithmeticOperationOp
from markettor.hogql.context import HogQLContext
from markettor.hogql.database.models import DatabaseField, LazyJoinToAdd, LazyTableToAdd
from markettor.hogql.errors import NotImplementedError

from markettor.hogql.visitor import clone_expr, CloningVisitor, Visitor, TraversingVisitor
...
class IsSimpleTimestampFieldExpressionVisitor(Visitor[bool]):
    ...
    def visit_alias(self, node: ast.Alias) -> bool:
        ...
        from markettor.hogql.database.schema.sessions_v1 import SessionsTableV1
        from markettor.hogql.database.schema.sessions_v2 import SessionsTableV2

        from markettor.hogql.database.schema.session_replay_events import RawSessionReplayEventsTable
