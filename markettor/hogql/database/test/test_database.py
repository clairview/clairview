...
from markettor.hogql.constants import MAX_SELECT_RETURNED_ROWS
from markettor.hogql.database.database import create_hogql_database, serialize_database
from markettor.hogql.database.models import FieldTraverser, LazyJoin, StringDatabaseField, ExpressionField, Table
...
from markettor.schema import DatabaseSchemaDataWarehouseTable, HogQLQueryModifiers, PersonsOnEventsMode
...
from markettor.hogql.test.utils import pretty_print_in_tests
...
class TestDatabase(BaseTest, QueryMatchingTest):
    ...
    @patch("markettor.hogql.query.sync_execute", return_value=([], []))
    @pytest.mark.usefixtures("unittest_snapshot")
