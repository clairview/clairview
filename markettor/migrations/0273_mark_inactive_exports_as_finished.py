...
def mark_inactive_exports_as_finished(apps, _):
    ...
    ActivityLog = apps.get_model("markettor", "ActivityLog")
    PluginStorage = apps.get_model("markettor", "PluginStorage")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("markettor", "0272_alter_organization_plugins_access_level"),
    ]
