...
def populate_instance_settings(apps, schema_editor):
    try:
        InstanceSetting = apps.get_model("markettor", "InstanceSetting")
        ...
        logger.info("constance_config table did not exist, skipping populating markettor_instance_setting table")
