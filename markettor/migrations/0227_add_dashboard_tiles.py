...
def migrate_dashboard_insight_relations(apps, _) -> None:
    ...
    with connection.cursor() as cursor:
        ...
        and don't already have a markettor_dashboardtile relation
        """
        cursor.execute(
            """
            SELECT old_relation.id, old_relation.dashboard_id, old_relation.layouts, old_relation.color
            FROM markettor_dashboarditem as old_relation
            LEFT JOIN markettor_dashboardtile new_relation
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dashboard",
                    models.ForeignKey(on_delete=models.deletion.CASCADE, to="markettor.dashboard"),
                ),
                (
                    "insight",
                    models.ForeignKey(on_delete=models.deletion.CASCADE, to="markettor.insight"),
                ),
