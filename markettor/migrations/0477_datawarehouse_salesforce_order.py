...
def insert_salesforce_order_schemas(apps, schema_editor):
    with connection.cursor() as cursor:
        cursor.execute("SELECT id, team_id FROM markettor_externaldatasource where source_type = 'Salesforce'")
        salesforce_sources = cursor.fetchall()

    ExternalDataSchema = apps.get_model("markettor", "ExternalDataSchema")
...
class Migration(migrations.Migration):
    dependencies = [
        ("markettor", "0476_alter_integration_sensitive_config"),
    ]
