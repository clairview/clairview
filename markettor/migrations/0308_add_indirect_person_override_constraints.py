...
class Migration(migrations.Migration):
    dependencies = [
        ("markettor", "0307_pluginconfig_admin"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="markettor.personoverridemapping",
            ),
        ),
        ...
        migrations.RunSQL(
            """
            ALTER TABLE markettor_personoverride
            ...
            INITIALLY DEFERRED
            """,
            "ALTER TABLE markettor_personoverride DROP CONSTRAINT exclude_override_person_id_from_being_old_person_id",
        ),
        migrations.AddConstraint(
