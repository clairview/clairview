...
from markettor.schema import ActorsQuery, CohortPropertyFilter, DataTableNode, NodeKind, PersonsNode
...
class Migration(migrations.Migration):
    dependencies = [
        ("markettor", "0458_alter_insightviewed_team_alter_insightviewed_user"),
    ]
