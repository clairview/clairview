...
import markettor.warehouse.models.modeling


class Migration(migrations.Migration):
    dependencies = [
        ("markettor", "0462_change_replay_team_setting_defaults"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("path", markettor.warehouse.models.modeling.LabelTreeField()),
                (
                    "created_by",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="markettor.datawarehousesavedquery",
                    ),
                ),
                (
                    "table",
