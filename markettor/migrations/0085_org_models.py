...
def forwards_func(apps, schema_editor):
    User = apps.get_model("markettor", "User")
    Organization = apps.get_model("markettor", "Organization")
    OrganizationMembership = apps.get_model("markettor", "OrganizationMembership")
    Annotation = apps.get_model("markettor", "Annotation")
