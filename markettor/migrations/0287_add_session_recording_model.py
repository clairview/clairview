...
def migrate_playlist_item_recording_relations(apps, _) -> None:
    Recording = apps.get_model("markettor", "SessionRecording")
    PlaylistItem = apps.get_model("markettor", "SessionRecordingPlaylistItem")
...
class Migration(migrations.Migration):
    dependencies = [
        ("markettor", "0286_index_insightcachingstate_lookup"),
    ]
