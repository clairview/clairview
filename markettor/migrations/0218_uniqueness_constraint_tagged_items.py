...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            sql="""
                DELETE FROM "markettor_taggeditem" T1
                    USING   "markettor_taggeditem" T2
                WHERE
        ...
        migrations.RunSQL(
            sql="""
                CREATE UNIQUE INDEX CONCURRENTLY "unique_dashboard_tagged_item" ON "markettor_taggeditem" ("tag_id", "dashboard_id")
        ...
        migrations.RunSQL(
            sql="""
                CREATE UNIQUE INDEX CONCURRENTLY "unique_insight_tagged_item" ON "markettor_taggeditem" ("tag_id", "insight_id")
        ...
        migrations.RunSQL(
            sql="""
                CREATE UNIQUE INDEX CONCURRENTLY "unique_event_definition_tagged_item" ON "markettor_taggeditem" ("tag_id", "event_definition_id")
        ...
        migrations.RunSQL(
            sql="""
                CREATE UNIQUE INDEX CONCURRENTLY "unique_property_definition_tagged_item" ON "markettor_taggeditem" ("tag_id", "property_definition_id")
        ...
        migrations.RunSQL(
            sql="""
                CREATE UNIQUE INDEX CONCURRENTLY "unique_action_tagged_item" ON "markettor_taggeditem" ("tag_id", "action_id")
