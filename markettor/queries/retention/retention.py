...
from markettor.constants import RETENTION_FIRST_TIME, RetentionQueryType
...
from markettor.queries.retention.actors_query import (
...
from markettor.queries.retention.sql import RETENTION_BREAKDOWN_SQL
from markettor.queries.retention.types import BreakdownValues, CohortKey
...
class Retention:
    ...
    def _get_retention_by_breakdown_values(
        ...
        result = insight_sync_execute(
            ...
            {**actor_query_params, **filter.torql_context.values},
