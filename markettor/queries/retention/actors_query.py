...
from markettor.queries.retention.sql import RETENTION_BREAKDOWN_ACTOR_SQL
from markettor.queries.retention.types import BreakdownValues
...
def build_actor_activity_query(
    ...
    from markettor.queries.retention import (
