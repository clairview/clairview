...
from markettor.constants import INSIGHT_FUNNELS, INSIGHT_PATHS, INSIGHT_TRENDS
from markettor.torql_queries.actor_strategies import PersonStrategy
from markettor.torql_queries.insights.paginators import TorQLHasMorePaginator
from markettor.models import Entity, Filter, PersonDistinctId, SessionRecording, Team
...
def get_serialized_people(
    ...
    from markettor.api.person import get_person_name_helper
...
def serialize_people(
    ...
    from markettor.api.person import get_person_name
