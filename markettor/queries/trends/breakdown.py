...
from markettor.queries.column_optimizer.column_optimizer import ColumnOptimizer
from markettor.queries.event_query import EventQuery
from markettor.queries.groups_join_query import GroupsJoinQuery
...
from markettor.queries.query_date_range import TIME_IN_SECONDS, QueryDateRange
from markettor.schema import PersonsOnEventsMode
from markettor.session_recordings.queries.session_query import SessionQuery
from markettor.queries.trends.sql import (
...
from markettor.queries.trends.util import (
...
from markettor.queries.util import (
    alias_poe_mode_for_legacy,
    get_interval_func_ch,
    get_person_properties_mode,
    get_start_of_interval_sql,
)
from markettor.utils import encode_get_request_params, generate_short_id
from markettor.queries.person_on_events_v2_sql import PERSON_DISTINCT_ID_OVERRIDES_JOIN_SQL

BREAKDOWN_OTHER_DISPLAY = "Other (i.e. all remaining values)"
BREAKDOWN_NULL_DISPLAY = "None (i.e. no value)"


BREAKDOWN_OTHER_STRING_LABEL = "$$_markettor_breakdown_other_$$"
BREAKDOWN_OTHER_NUMERIC_LABEL = 9007199254740991  # pow(2, 53) - 1, for JS compatibility
BREAKDOWN_NULL_STRING_LABEL = "$$_markettor_breakdown_null_$$"
...
class TrendsBreakdown:
    ...
    def get_query(self) -> tuple[str, dict, Callable]:
        ...
        if len(_params["values"]) == 0:
            ...
            # See https://github.com/MarketTor/markettor/pull/5674 for context.
            return (
