...
from markettor.constants import TRENDS_CUMULATIVE, TRENDS_PIE, TRENDS_BOLD_NUMBER
from markettor.models import Cohort, Person
...
class TestFormula(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_breakdown_with_different_breakdown_values_per_series(self):
        ...
        self.assertEqual(response[3]["label"], "$$_markettor_breakdown_null_$$")
