...
from markettor.queries.base import match_property, relative_date_parse_for_feature_flag_matching, sanitize_property_key
from markettor.test.base import APIBaseTest


class TestBase(APIBaseTest):
    def test_determine_compared_filter(self):
        from markettor.queries.base import determine_compared_filter
