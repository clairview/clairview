...
from markettor.models.property import PropertyGroup, PropertyName
...
class EventQuery(metaclass=ABCMeta):
    ...
    def _determine_should_join_persons(self) -> None:
        ...
        # Can be simplified significantly after https://github.com/MarketTor/markettor/issues/5854
