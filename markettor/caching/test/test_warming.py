from markettor.caching.warming import priority_insights, schedule_warming_for_teams_task
from markettor.models import Insight, DashboardTile, InsightViewed, Dashboard
...
class TestWarming(APIBaseTest):
    ...
    @patch("markettor.hogql_queries.query_cache.QueryCacheManager.get_stale_insights")
...
class TestScheduleWarmingForTeamsTask(APIBaseTest):
    ...
    @patch("markettor.caching.warming.largest_teams")
    @patch("markettor.caching.warming.priority_insights")
    @patch("markettor.caching.warming.warm_insight_cache_task.si")
