...
from markettor.caching.calculate_results import get_cache_type
from markettor.caching.insight_cache import (
    fetch_states_in_need_of_updating,
    schedule_cache_updates,
    update_cache,
)
from markettor.caching.insight_caching_state import upsert
from markettor.caching.test.test_insight_caching_state import create_insight, filter_dict
...
from markettor.models import Filter, InsightCachingState, RetentionFilter, Team, User
...
from markettor.utils import get_safe_cache
...
@patch("markettor.caching.insight_cache.update_cache_task")
...
@freeze_time("2020-01-04T13:01:01Z")
@patch("markettor.caching.insight_cache.update_cache_task")
@patch("markettor.caching.insight_cache.process_query_dict", side_effect=Exception())  # TorQL branch
