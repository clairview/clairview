import itertools
from markettor.hogql.constants import HogQLGlobalSettings, MAX_BYTES_BEFORE_EXTERNAL_GROUP_BY
...
from markettor.constants import PAGEVIEW_EVENT, SCREEN_EVENT, HOGQL
...
from markettor.hogql.property import property_to_expr
...
from markettor.hogql_queries.insights.funnels.utils import funnel_window_interval_unit_to_sql
...
class PathsQueryRunner(QueryRunner):
    ...
    def funnel_join(self) -> ast.JoinExpr:
        ...
        from markettor.hogql_queries.insights.insight_actors_query_runner import InsightActorsQueryRunner
