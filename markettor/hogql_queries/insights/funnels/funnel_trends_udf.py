...
from markettor.hogql_queries.insights.funnels import FunnelTrends
from markettor.hogql_queries.insights.utils.utils import get_start_of_interval_hogql_str
