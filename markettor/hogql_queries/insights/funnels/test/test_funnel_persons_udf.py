...
from markettor.hogql_queries.insights.funnels.test.test_funnel_persons import (
    get_actors,
...
class TestFunnelPersonsUDF(BaseTestFunnelPersons):
    ...
    @patch("markettor.hogql_queries.insights.funnels.funnel_udf.FunnelUDF.actor_query", return_value=None)
