from markettor.constants import FUNNEL_WINDOW_INTERVAL_TYPES
...
from markettor.schema import FunnelConversionWindowTimeUnit, FunnelVizType, FunnelsFilter, StepOrderValue
...
def get_funnel_order_class(funnelsFilter: FunnelsFilter, use_udf=False):
    from markettor.hogql_queries.insights.funnels import (
        Funnel,
        FunnelUDF,
        FunnelStrict,
        FunnelUnordered,
