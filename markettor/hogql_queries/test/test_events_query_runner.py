...
from markettor.hogql.ast import CompareOperationOp
from markettor.hogql_queries.events_query_runner import EventsQueryRunner
from markettor.models import Person, Team
...
class TestEventsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_is_not_set_boolean(self):
        # see https://github.com/MarketTor/markettor/issues/18030
    ...
    def test_test_account_filters(self):
        ...
        self.assertEqual(right_expr.value, "%markettor.com%")
