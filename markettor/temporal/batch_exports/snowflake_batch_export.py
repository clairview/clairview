...
from markettor.temporal.batch_exports.utils import (
    JsonType,
...
from markettor.temporal.common.utils import (
...
class SnowflakeClient:
    ...
    async def acreate_table(self, table_name: str, fields: list[SnowflakeField]) -> None:
        ...
        await self.execute_async_query(
            ...
            COMMENT = 'MarketTor generated events table'
            """,
        )
...
class SnowflakeBatchExportWorkflow(MarketTorWorkflow):
