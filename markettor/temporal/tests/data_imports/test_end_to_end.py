...
from markettor.temporal.data_imports import ACTIVITIES
from markettor.temporal.data_imports.external_data_job import ExternalDataJobWorkflow
from markettor.temporal.utils import ExternalDataWorkflowInputs
from markettor.warehouse.models.external_table_definitions import external_tables
...
from markettor.warehouse.models.external_data_job import get_latest_run_if_exists
...
async def test_zendesk_brands(team, zendesk_brands):
    await _run(
        ...
        job_inputs={
            ...
            "zendesk_email_address": "test@markettor.com",
        },
...
async def test_make_sure_deletions_occur(team, stripe_balance_transaction):
    ...
    with mock.patch("markettor.warehouse.models.external_data_job.get_s3_client") as mock_s3_client:
...
async def test_billing_limits(team, stripe_customer):
    ...
    with mock.patch(
        "markettor.temporal.data_imports.workflow_activities.check_billing_limits.list_limited_team_attributes",
