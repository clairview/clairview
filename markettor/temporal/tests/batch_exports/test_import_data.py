...
from markettor.warehouse.models.credential import DataWarehouseCredential
...
async def test_postgres_source_without_ssh_tunnel(activity_environment, team, **kwargs):
    ...
    with (
        mock.patch("markettor.temporal.data_imports.pipelines.sql_database.sql_source_for_type") as sql_source_for_type,
        mock.patch("markettor.temporal.data_imports.workflow_activities.import_data._run"),
    ):
