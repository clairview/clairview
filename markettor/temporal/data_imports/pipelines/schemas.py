from markettor.warehouse.types import IncrementalField
from markettor.temporal.data_imports.pipelines.zendesk.settings import (
    BASE_ENDPOINTS,
    SUPPORT_ENDPOINTS,
    INCREMENTAL_ENDPOINTS as ZENDESK_INCREMENTAL_ENDPOINTS,
    INCREMENTAL_FIELDS as ZENDESK_INCREMENTAL_FIELDS,
)
from markettor.warehouse.models import ExternalDataSource
from markettor.temporal.data_imports.pipelines.stripe.settings import (
...
from markettor.temporal.data_imports.pipelines.hubspot.settings import ENDPOINTS as HUBSPOT_ENDPOINTS
from markettor.temporal.data_imports.pipelines.salesforce.settings import (
...
from markettor.temporal.data_imports.pipelines.vitally.settings import (
