...
from markettor.temporal.common.asyncpa import AsyncRecordBatchReader
...
class ClickHouseClient:
    ...
    @classmethod
    def from_markettor_settings(cls, session, settings, **kwargs):
        """Initialize a ClickHouseClient from MarketTor settings."""
        return cls(
            session=session,
