...
from markettor.utils import absolute_uri as util_absolute_uri
...
def absolute_asset_url(path: str) -> str:
    """
    Returns a versioned absolute asset URL (located within MarketTor's static files).
    Example:
      {% absolute_asset_url 'dist/markettor.css' %}
      =>  "http://markettor.example.com/_static/74d127b78dc7daf2c51f/dist/markettor.css"
    """
...
def strip_protocol(path: str) -> str:
    ...
    Example:
      {% strip_protocol 'https://app.markettor.com' %}
      =>  "app.markettor.com"
    """
