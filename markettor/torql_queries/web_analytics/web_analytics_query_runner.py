    ...
    def session_where(self, include_previous_period: Optional[bool] = None):
        properties = [
            parse_expr(
                ...
                placeholders={
                    "date_from": self.query_date_range.previous_period_date_from_as_torql()
                    if include_previous_period
                    else self.query_date_range.date_from_as_torql(),
                    "date_to": self.query_date_range.date_to_as_torql(),
                },
            ),
        ...
        return property_to_expr(
            [
                parse_expr(
                    ...
                    placeholders={"date_from": self.query_date_range.date_from_as_torql()},
                ),
                parse_expr(
                    "events.timestamp < {date_to}",
                    placeholders={"date_to": self.query_date_range.date_to_as_torql()},
                ),
            ],
            self.team,
        )
