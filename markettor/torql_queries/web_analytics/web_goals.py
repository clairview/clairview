...
from markettor.torql.property import property_to_expr, get_property_type, action_to_expr
...
from markettor.torql_queries.web_analytics.web_analytics_query_runner import (
    WebAnalyticsQueryRunner,
)
from markettor.models import Action
from markettor.models.filters.mixins.utils import cached_property
from markettor.schema import WebGoalsQueryResponse, WebGoalsQuery, CachedWebGoalsQueryResponse
...
class WebGoalsQueryRunner(WebAnalyticsQueryRunner):
    ...
    def to_query(self) -> ast.SelectQuery | ast.SelectUnionQuery:
        with self.timings.measure("date_expr"):
            start = self.query_date_range.date_from_as_torql()
            end = self.query_date_range.date_to_as_torql()
