...
from markettor.torql_queries.legacy_compatibility.clean_properties import clean_entity_properties, clean_global_properties
from markettor.models.entity.entity import Entity as LegacyEntity
    ...
    if _insight_type(filter) == "TRENDS":
        ...
        insight_filter = {
            "funnelsFilter": FunnelsFilter(
                ...
                funnelAggregateByTorQL=filter.get("funnel_aggregate_by_torql"),
            ),
        }
        ...
        insight_filter = {
            "pathsFilter": PathsFilter(
                pathsTorQLExpression=filter.get("paths_torql_expression"),
