    ...
    "values": [
        {
            ...
            "values": [
                ...
                {"type": "torql", "key": "properties.name", "value": None},
            ],
        },
        {"type": "OR", "values": [{}]},
    ],
...
class TestFilterToQuery(BaseTest):
        ...
        filter = {
            "events": [
                ...
                },  # unique group
                {
                    "id": "$pageview",
                    "math": "torql",
                    "math_torql": "avg(toInt(properties.$session_id)) + 1000",
                },  # torql
            ]
        }
        ...
        self.assertEqual(
            ...
            [
                ...
                EventsNode(
                    event="$pageview",
                    name="$pageview",
                    properties=[TorQLPropertyFilter(key="dateDiff('minute', timestamp, now()) < 30")],
                ),
                EventsNode(
                    event="$pageview",
                    name="$pageview",
    ...
    def test_funnels_filter(self):
        filter = {
            ...
            "funnel_aggregate_by_torql": "person_id",
            "exclusions": [
                {
                    "id": "$pageview",
                    "type": "events",
        ...
        self.assertEqual(
            ...
            FunnelsFilter(
                ...
                binCount=15,
                funnelAggregateByTorQL="person_id",
    ...
    def test_paths_filter(self):
        ...
        self.assertEqual(
            query.pathsFilter,
            PathsFilter(
                includeEventTypes=[PathType.FIELD_PAGEVIEW, PathType.TORQL],
                pathsTorQLExpression="event",
