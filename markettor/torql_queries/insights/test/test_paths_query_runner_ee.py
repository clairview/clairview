...
from markettor.schema import CachedPathsQueryResponse
...
@patch("markettoranalytics.feature_enabled", new=Mock(side_effect=insight_funnels_use_udf_funnel_flag_side_effect))
