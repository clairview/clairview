...
from markettor.warehouse.models import DataWarehouseTable, DataWarehouseCredential
...
TEST_BUCKET = "test_storage_bucket-markettor.torql.datawarehouse.trendquery" + XDIST_SUFFIX
...
class TestTrendsDataWarehouseQuery(ClickhouseTestMixin, BaseTest):
    ...
    def test_trends_breakdown_on_view(self):
        from markettor.warehouse.models import DataWarehouseSavedQuery
