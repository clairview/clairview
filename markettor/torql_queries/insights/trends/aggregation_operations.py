...
from markettor.constants import NON_TIME_SERIES_DISPLAY_TYPES
...
from markettor.torql_queries.insights.utils.aggregations import (
...
class AggregationOperations(DataWarehouseInsightQueryMixin):
    ...
    def select_aggregation(self) -> ast.Expr:
        if self.series.math == "torql" and self.series.math_torql is not None:
            return parse_expr(self.series.math_torql)
