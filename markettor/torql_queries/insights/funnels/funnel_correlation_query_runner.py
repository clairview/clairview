...
from markettor.torql_queries.insights.funnels import FunnelUDF
from markettor.torql_queries.insights.funnels.funnel_event_query import FunnelEventQuery
from markettor.torql_queries.insights.funnels.funnel_persons import FunnelActors
from markettor.torql_queries.insights.funnels.funnel_strict_persons import FunnelStrictActors
from markettor.torql_queries.insights.funnels.funnel_unordered_persons import FunnelUnorderedActors
...
from markettor.torql_queries.insights.funnels.utils import (
...
class FunnelCorrelationQueryRunner(QueryRunner):
    ...
    def calculate(self) -> FunnelCorrelationResponse:
        ...
        events, skewed_totals, torql, response = self._calculate()
    ...
    def _calculate(self) -> tuple[list[EventOddsRatio], bool, str, TorQLQueryResponse]:
        query = self.to_query()
        ...
        return events, skewed_totals, torql, response
    ...
    def events_actor_query(self) -> ast.SelectQuery | ast.SelectUnionQuery:
        ...
        date_from = funnel_event_query._date_range().date_from_as_torql()
        date_to = funnel_event_query._date_range().date_to_as_torql()
    ...
    def get_event_query(self) -> ast.SelectQuery | ast.SelectUnionQuery:
        ...
        event_correlation_query = parse_select(
            ...
            -- :HACKY: TorQL does not have access to a CTE in the second union query, thus
