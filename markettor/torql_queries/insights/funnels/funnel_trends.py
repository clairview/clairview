...
from markettor.torql_queries.insights.funnels.base import FunnelBase
from markettor.torql_queries.insights.funnels.funnel_query_context import FunnelQueryContext
from markettor.torql_queries.insights.funnels.utils import get_funnel_order_class
from markettor.torql_queries.insights.utils.utils import get_start_of_interval_torql
...
from markettor.queries.util import correct_result_for_sampling, get_earliest_timestamp, get_interval_func_ch
...
class FunnelTrends(FunnelBase):
        ...
        fill_select: list[ast.Expr] = [
            ast.Alias(
                ...
                expr=ast.ArithmeticOperation(
                    left=get_start_of_interval_torql(interval.value, team=team, source=date_from_as_torql),
                ...
                ast.ArithmeticOperation(
                    left=ast.Call(
                        ...
                        args=[
                            ...
                            get_start_of_interval_torql(interval.value, team=team, source=date_from_as_torql),
                            get_start_of_interval_torql(interval.value, team=team, source=date_to_as_torql),
                        ],
                    ),
    ...
    def get_step_counts_without_aggregation_query(
        ...
        select: list[ast.Expr] = [
            ...
            ast.Alias(alias="entrance_period_start", expr=get_start_of_interval_torql(interval.value, team=team)),
