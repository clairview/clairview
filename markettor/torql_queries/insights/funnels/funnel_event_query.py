...
from markettor.torql_queries.insights.utils.properties import Properties
...
class FunnelEventQuery:
    ...
    def _aggregation_target_expr(self) -> ast.Expr:
        ...
        elif funnelsFilter.funnelAggregateByTorQL and funnelsFilter.funnelAggregateByTorQL != "person_id":
            aggregation_target = parse_expr(funnelsFilter.funnelAggregateByTorQL)
