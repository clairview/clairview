...
from markettor.constants import INSIGHT_FUNNELS, TRENDS_LINEAR, FunnelOrderType
...
from markettor.queries.funnels.funnel_trends_persons import ClickhouseFunnelTrendsActors
