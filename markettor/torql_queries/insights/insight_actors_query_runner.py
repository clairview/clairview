...
from markettor.torql.constants import TorQLGlobalSettings
from markettor.torql.query import execute_torql_query
from markettor.torql_queries.insights.funnels.funnel_correlation_query_runner import FunnelCorrelationQueryRunner
from markettor.torql_queries.insights.funnels.funnels_query_runner import FunnelsQueryRunner
from markettor.torql_queries.insights.lifecycle_query_runner import LifecycleQueryRunner
from markettor.torql_queries.insights.paths_query_runner import PathsQueryRunner
from markettor.torql_queries.insights.retention_query_runner import RetentionQueryRunner
from markettor.torql_queries.insights.stickiness_query_runner import StickinessQueryRunner
from markettor.torql_queries.insights.trends.trends_query_runner import TrendsQueryRunner
from markettor.torql_queries.query_runner import QueryRunner, get_query_runner
...
from markettor.types import InsightActorsQueryNode
...
class InsightActorsQueryRunner(QueryRunner):
    ...
    def calculate(self) -> TorQLQueryResponse:
        settings = None
        ...
        if isinstance(self.source_runner, FunnelsQueryRunner):
            settings = TorQLGlobalSettings(allow_experimental_analyzer=True)

        return execute_torql_query(
