...
from markettor.models.team.team import Team, WeekStartDay
from markettor.queries.util import get_trunc_func_ch


def get_start_of_interval_torql(interval: str, *, team: Team, source: Optional[ast.Expr] = None) -> ast.Expr:
...
def get_start_of_interval_torql_str(interval: str, *, team: Team, source: str) -> str:
    trunc_func = get_trunc_func_ch(interval)
