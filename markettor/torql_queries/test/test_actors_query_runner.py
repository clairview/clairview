...
class TestActorsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_persons_query_search_email(self):
        ...
        runner = self._create_runner(ActorsQuery(search=f"jacob4@{self.random_uuid}.markettor"))
    ...
    def test_persons_query_order_by(self):
        ...
        results = runner.calculate().results
        self.assertEqual(results[0], [f"jacob9@{self.random_uuid}.markettor.com"])
    ...
    def test_persons_query_order_by_with_aliases(self):
        ...
        results = runner.calculate().results
        self.assertEqual(results[0], [f"jacob0@{self.random_uuid}.markettor.com"])
    ...
    def test_persons_query_limit(self):
        ...
        response = runner.calculate()
        self.assertEqual(response.results, [[f"jacob9@{self.random_uuid}.markettor.com"]])
        ...
        response = runner.calculate()
        self.assertEqual(response.results, [[f"jacob7@{self.random_uuid}.markettor.com"]])
        self.assertEqual(response.hasMore, True)
    ...
    def test_source_torql_query_poe_on(self):
        ...
        response = runner.calculate()
        self.assertEqual(response.results, [[f"jacob4@{self.random_uuid}.markettor.com"]])
    ...
    def test_persons_query_grouping(self):
        ...
        _create_person(
            properties={
                "email": f"jacob0@{random_uuid}.markettor.com",
                "name": f"Mr Jacob {random_uuid}",
                "random_uuid": random_uuid,
                "index": 0,
            },
        ...
        flush_persons_and_events()
        runner = self._create_runner(ActorsQuery(search="markettor.com"))
