...
from markettor.torql_queries.error_tracking_query_runner import ErrorTrackingQueryRunner
...
from markettor.models import ErrorTrackingGroup
                ...
                filterGroup=PropertyGroupFilter(
                    ...
                    values=[
                        PropertyGroupFilterValue(
                            ...
                            values=[
                                PersonPropertyFilter(
                                    key="email", value="email@markettor.com", operator=PropertyOperator.EXACT
                                ),
                            ],
                        )
                    ],
