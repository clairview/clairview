...
from markettor.torql_queries.query_runner import ExecutionMode, QueryRunner
...
class TestQueryRunner(BaseTest):
    ...
    def test_modifier_passthrough(self):
        ...
        runner = TorQLQueryRunner(
            query=TorQLQuery(query="select properties.$browser from events"),
            team=self.team,
