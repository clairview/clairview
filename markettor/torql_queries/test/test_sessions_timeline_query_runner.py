...
from markettor.torql_queries.sessions_timeline_query_runner import SessionsTimelineQueryRunner
from markettor.schema import EventType, SessionsTimelineQuery, TimelineEntry
from markettor.session_recordings.queries.test.session_replay_sql import produce_replay_summary
from markettor.test.base import APIBaseTest, ClickhouseTestMixin, snapshot_clickhouse_queries
...
class TestSessionsTimelineQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    @snapshot_clickhouse_queries
    @patch("markettor.torql_queries.sessions_timeline_query_runner.SessionsTimelineQueryRunner.EVENT_LIMIT", 2)
