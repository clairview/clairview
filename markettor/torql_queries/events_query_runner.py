...
from markettor.api.element import ElementSerializer
from markettor.api.utils import get_pk_or_uuid
from markettor.torql import ast
from markettor.torql.ast import Alias
from markettor.torql.parser import parse_expr, parse_order_expr
from markettor.torql.property import action_to_expr, has_aggregation, property_to_expr
...
from markettor.models import Action, Person
from markettor.models.element import chain_to_elements
from markettor.models.person.person import get_distinct_ids_for_subquery
from markettor.models.person.util import get_persons_by_distinct_ids
from markettor.schema import DashboardFilter, EventsQuery, EventsQueryResponse, CachedEventsQueryResponse
...
class EventsQueryRunner(QueryRunner):
    ...
    def to_query(self) -> ast.SelectQuery:
        # Note: This code is inefficient and problematic, see https://github.com/MarketTor/markettor/issues/13485 for details.
        if self.timings is None:
            self.timings = TorQLTimings()
    ...
    def calculate(self) -> EventsQueryResponse:
        query_result = self.paginator.execute_torql_query(
            query=self.to_query(),
            team=self.team,
