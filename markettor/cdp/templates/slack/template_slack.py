from markettor.cdp.templates.hog_function_template import HogFunctionTemplate, HogFunctionSubTemplate, SUB_TEMPLATE_COMMON
...
""".strip(),
    inputs_schema=[
        ...
        },
        {
            ...
            "description": "Select the channel to post to (e.g. #general). The MarketTor app must be installed in the workspace.",
            "secret": False,
            "required": True,
        },
        {
            ...
            "default": [
                ...
                },
                {
                    ...
                    "elements": [
                        {
                            "url": "{person.url}",
                            "text": {"text": "View Person in MarketTor", "type": "plain_text"},
                            "type": "button",
                        },
                        {
                            "url": "{source.url}",
