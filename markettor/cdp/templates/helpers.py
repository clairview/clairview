...
from markettor.cdp.templates.hog_function_template import HogFunctionTemplate
...
class BaseHogFunctionTemplateTest(BaseTest):
    ...
    mock_markettor_capture = MagicMock()
    ...
    def setUp(self):
        ...
        self.mock_markettor_capture = MagicMock(
    ...
    def get_mock_markettor_capture_calls(self):
        # Return a simple array which is easier to debug
        return [call.args for call in self.mock_markettor_capture.mock_calls]
    ...
    def createHogGlobals(self, globals=None) -> dict:
        ...
        data = {
            ...
            "person": {"id": "person-id", "properties": {"email": "example@markettor.com"}},
            "source": {"url": "https://us.markettor.com/hog_functions/1234"},
        }
    ...
    def run_function(self, inputs: dict, globals=None, functions: Optional[dict] = None):
        ...
        final_functions: dict = {
            ...
            "marketTorCapture": self.mock_markettor_capture,
        }
