...
from markettor.cdp.templates.salesforce.template_salesforce import (
    ...
    def test_add_all_person_properties(self):
        ...
        assert self.get_mock_fetch_calls()[0] == snapshot(
            (
                "https://example.my.salesforce.com/services/data/v61.0/sobjects/Contact",
                {
                    "body": {"email": "example@markettor.com", "foo": "bar"},
                    "method": "POST",
                    "headers": {"Authorization": "Bearer oauth-1234", "Content-Type": "application/json"},
                },
            )
...
class TestTemplateSalesforceUpdate(BaseHogFunctionTemplateTest):
    ...
    def _inputs(self, **kwargs):
        inputs = {
            ...
            "path": "Lead/Email/example@markettor.com",
            "properties": {
                "foo": "bar",
            },
        }
    ...
    def test_function_works(self):
        ...
        assert self.get_mock_fetch_calls()[0] == snapshot(
            (
                "https://example.my.salesforce.com/services/data/v61.0/sobjects/Lead/Email/example@markettor.com",
                {
                    "body": {"foo": "bar"},
                    "method": "PATCH",
                    "headers": {"Authorization": "Bearer oauth-1234", "Content-Type": "application/json"},
