...
from markettor.cdp.templates.mailgun.template_mailgun import template_mailgun_send_email
...
def create_inputs(overrides: Optional[dict] = None):
    inputs = {
        ...
        "template": {
            "to": "example@markettor.com",
            "from": "noreply@markettor.com",
...
\r
noreply@markettor.com\r
-----011000010111000001101001\r
Content-Disposition: form-data; name="to"\r
\r
example@markettor.com\r
-----011000010111000001101001\r
