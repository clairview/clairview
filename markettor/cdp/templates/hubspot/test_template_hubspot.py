...
from markettor.cdp.templates.hubspot.template_hubspot import template as template_hubspot, TemplateHubspotMigrator
...
class TestTemplateHubspot(BaseHogFunctionTemplateTest):
    ...
    def test_function_works(self):
            ...
            (
                "https://api.hubapi.com/crm/v3/objects/contacts/batch/upsert",
                {
                    ...
                    "body": {
                        "inputs": [
                            {
                                "properties": {"company": "MarketTor", "email": "example@markettor.com"},
                                "id": "example@markettor.com",
                                "idProperty": "email",
                            }
                        ]
                    },
        ...
        assert self.get_mock_print_calls() == [("Contact example@markettor.com updated successfully!",)]
