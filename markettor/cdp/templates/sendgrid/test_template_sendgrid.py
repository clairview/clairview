...
from markettor.cdp.templates.sendgrid.template_sendgrid import template as template_sendgrid, TemplateSendGridMigrator
...
class TestTemplateSendgrid(BaseHogFunctionTemplateTest):
        ...
        assert self.get_mock_fetch_calls()[0] == snapshot(
            (
                "https://api.sendgrid.com/v3/marketing/contacts",
                {
                    ...
                    "body": {"contacts": [{"email": "example@markettor.com", "last_name": "example"}]},
                },
            )
        )
    ...
    def test_function_doesnt_include_empty_properties(self):
        ...
        assert self.get_mock_fetch_calls()[0][1]["body"]["contacts"] == snapshot(
            [{"email": "example@markettor.com", "last_name": "included"}]
        )
