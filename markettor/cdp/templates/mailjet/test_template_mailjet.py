...
from markettor.cdp.templates.mailjet.template_mailjet import template_create_contact, template_update_contact_list
        ...
        assert self.get_mock_fetch_calls()[0] == snapshot(
            (
                "https://api.mailjet.com/v3/REST/contact/",
                {
                    ...
                    "body": {"Email": "example@markettor.com", "Name": "Example", "IsExcludedFromCampaigns": False},
                },
            )
        )
...
class TestTemplateMailjetUpdateContactList(BaseHogFunctionTemplateTest):
    ...
    def test_function_works(self):
        ...
        assert self.get_mock_fetch_calls()[0] == snapshot(
            (
                "https://api.mailjet.com/v3/REST/contact/example@markettor.com/managecontactlists",
                {
                    "method": "POST",
                    "headers": {"Authorization": "Bearer API_KEY", "Content-Type": "application/json"},
