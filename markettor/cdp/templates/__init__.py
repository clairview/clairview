...
from .markettor.template_markettor import template as markettor, TemplateMarketTorMigrator
...
HOG_FUNCTION_MIGRATORS = {
    ...
    TemplateMarketTorMigrator.plugin_url: TemplateMarketTorMigrator,
