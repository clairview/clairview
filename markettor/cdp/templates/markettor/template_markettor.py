...
template: HogFunctionTemplate = HogFunctionTemplate(
    status="beta",
    id="template-markettor-replicator",
    name="MarketTor",
    description="Send a copy of the incoming data in realtime to another MarketTor instance",
    ...
    inputs_schema=[
        {
            "key": "host",
            "type": "string",
            "label": "MarketTor host",
            "description": "For cloud accounts this is either https://us.i.markettor.com or https://eu.i.markettor.com",
            "default": "https://us.i.markettor.com",
            "secret": False,
            "required": True,
        },
        {
...
class TemplateMarketTorMigrator(HogFunctionTemplateMigrator):
    plugin_url = "https://github.com/MarketTor/markettor-plugin-replicator"
