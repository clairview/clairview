...
from markettor.cdp.templates.avo.template_avo import template as template_avo, TemplateAvoMigrator
    ...
    def test_function_works(self):
        self.run_function(
            ...
            globals={
                ...
                "person": {
                    "properties": {"email": "max@markettor.com", "name": "Max", "company": "MarketTor"},
                },
            },
        )
        ...
        assert res == snapshot(
            (
                "https://api.avo.app/inspector/markettor/v1/track",
                {
                    "method": "POST",
                    "headers": {
                        "env": "dev",
        ...
        for filters, expected_result in [
            ...
            self.run_function(
                ...
                globals={
                    "event": {
                        "event": "sign up",
                        "properties": {"name": "Max", "company": "MarketTor", "job": "Product Engineer"},
                    },
                },
            )
