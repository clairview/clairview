...
fetch('https://api.avo.app/inspector/markettor/v1/track', {
    'method': 'POST',
    'headers': {
        'env': inputs.environment,
...
class TemplateAvoMigrator(HogFunctionTemplateMigrator):
    plugin_url = "https://github.com/MarketTor/markettor-avo-plugin"
    ...
    def migrate(cls, obj):
        ...
        appName = obj.config.get("appName", "MarketTor")
