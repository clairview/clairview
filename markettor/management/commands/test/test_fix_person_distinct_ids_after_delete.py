...
import markettor.management.commands.fix_person_distinct_ids_after_delete
from markettor.client import sync_execute
from markettor.management.commands.fix_person_distinct_ids_after_delete import run
from markettor.models.person.person import Person, PersonDistinctId
from markettor.models.person.sql import PERSON_DISTINCT_ID2_TABLE
from markettor.models.person.util import create_person, create_person_distinct_id
...
class TestFixPersonDistinctIdsAfterDelete(BaseTest, ClickhouseTestMixin):
    ...
    @mock.patch(
        f"{markettor.management.commands.fix_person_distinct_ids_after_delete.__name__}.create_person_distinct_id",
        wraps=markettor.management.commands.fix_person_distinct_ids_after_delete.create_person_distinct_id,
    )
