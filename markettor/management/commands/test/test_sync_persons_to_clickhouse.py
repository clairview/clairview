...
import markettor.management.commands.sync_persons_to_clickhouse
from markettor.client import sync_execute
from markettor.management.commands.sync_persons_to_clickhouse import (
    run,
...
class TestSyncPersonsToClickHouse(BaseTest, ClickhouseTestMixin):
    ...
    @mock.patch(
        f"{markettor.management.commands.sync_persons_to_clickhouse.__name__}.raw_create_group_ch",
        wraps=markettor.management.commands.sync_persons_to_clickhouse.raw_create_group_ch,
    )
