...
from markettor.temporal.batch_exports import WORKFLOWS as BATCH_EXPORT_WORKFLOWS
from markettor.temporal.common.client import connect
from markettor.temporal.data_imports import WORKFLOWS as DATA_IMPORT_WORKFLOWS
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            raise TypeError(
                f"Workflow '{workflow_name}' is not a `MarketTorWorkflow` that can invoked by `execute_temporal_workflow`."
            )
