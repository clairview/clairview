...
from markettor.batch_exports.models import BATCH_EXPORT_INTERVALS
...
EXPORT_NAME = "MarketTor HTTP Migration"
VALID_INTERVALS = {i[0] for i in BATCH_EXPORT_INTERVALS}
REGION_URLS = {
    "us": "https://app.markettor.com/batch",
    "eu": "https://eu.markettor.com/batch",
}


class Command(BaseCommand):
    help = "Creates an HTTP batch export for a team to migrate data to another MarketTor instance, \
