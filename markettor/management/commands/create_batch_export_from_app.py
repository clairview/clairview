...
from markettor.batch_exports.models import BatchExport, BatchExportDestination
from markettor.batch_exports.service import backfill_export, sync_batch_export
from markettor.models.plugin import PluginAttachment, PluginConfig
...
def map_plugin_config_to_destination(plugin_config: PluginConfig) -> tuple[str, dict]:
    ...
    if plugin.name == "S3 Export Plugin":
        ...
        config = {
            ...
            "table_name": plugin_config.config.get("tableName", "markettor_event"),
