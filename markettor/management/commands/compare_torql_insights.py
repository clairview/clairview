...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        from markettor.schema import TorQLQueryModifiers, TorQLQueryResponse, MaterializationMode
        from markettor.models import Insight, Filter
        ...
        for insight in insights[0:500]:
            ...
            try:
                ...
                url = f"https://us.markettor.com/project/{insight.team_id}/insights/{insight.short_id}/edit"
            ...
            try:
                all_ok = True
                sorter = lambda x: (
                    "$$_markettor_breakdown_other_$$" if x.get("breakdown_value") == "Other" else x.get("breakdown_value")
                )
                        ...
                        if legacy_value != torql_value:
                            if (
                                ...
                                or (
                                    ...
                                    and torql_value == "$$_markettor_breakdown_other_$$"
                                )
                            ):
                                continue
                            print(  # noqa: T201
                                f"Insight https://us.markettor.com/project/{insight.team_id}/insights/{insight.short_id}/edit"
