...
from markettor.api.utils import action, format_paginated_url
from markettor.auth import SharingAccessTokenAuthentication
from markettor.caching.fetch_from_cache import InsightResult
from markettor.clickhouse.cancel import cancel_query_on_cluster
...
from markettor.kafka_client.topics import KAFKA_METRICS_TIME_TO_SEE_DATA
from markettor.models import DashboardTile, Filter, Insight, User
...
from markettor.models.alert import are_alerts_supported_for_insight
from markettor.models.dashboard import Dashboard
from markettor.models.filters import RetentionFilter
...
from markettor.models.insight import InsightViewed
...
from markettor.queries.funnels.utils import get_funnel_order_class
...
from markettor.settings import CAPTURE_TIME_TO_SEE_DATA, SITE_URL
...
When set, the specified dashboard's filters and date range override will be applied.""",
    ...
    def trend(self, request: request.Request, *args: Any, **kwargs: Any):
        ...
        if self.request.accepted_renderer.format == "csv":
            ...
            response["Content-Disposition"] = (
                'attachment; filename="{name} ({date_from} {date_to}) from MarketTor.csv"'.format(
    ...
    def timing(self, request: request.Request, **kwargs):
        from markettor.kafka_client.client import KafkaProducer
        from markettor.models.event.util import format_clickhouse_timestamp
