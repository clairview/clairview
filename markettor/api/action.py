...
from markettor.constants import TREND_FILTER_TYPE_EVENTS
from markettor.event_usage import report_user_action
from markettor.models import Action
from markettor.models.action.action import ACTION_STEP_MATCHING_OPTIONS
...
class ActionViewSet(
    ...
    def migrate(self, request: request.Request, **kwargs):
        ...
        from markettor.management.commands.migrate_action_webhooks import convert_to_hog_function
