...
from markettor.api import capture
from markettor.api.capture import (
...
from markettor.api.test.openapi_validation import validate_response
...
from markettor.storage.object_storage import ObjectStorageError
...
android_json = {
    ...
    "properties": {
        ...
        "$screen_width": 1080,
        "$app_version": "1.0",
        "$app_namespace": "com.markettor.android.sample",
        "$app_build": 1,
        "$app_name": "MarketTor Android Sample",
...
TEST_SAMPLES_BUCKET = "markettor-test-replay-samples"
...
class TestCapture(BaseTest):
    ...
    def test_cached_is_randomly_partitioned(self):
        ...
        with patch("markettor.api.capture.LIMITER", new=limiter):
    ...
    @patch("markettor.api.capture.configure_scope")
    @patch("markettor.kafka_client.client._KafkaProducer.produce", MagicMock())
    ...
    @patch("markettor.models.utils.UUIDT", return_value="fake-uuid")
    @patch("markettor.kafka_client.client._KafkaProducer.produce")
    ...
    @patch("markettor.kafka_client.client.SessionRecordingKafkaProducer")
    ...
    @patch("markettor.api.capture.session_recording_kafka_producer")
    @patch("markettor.api.capture.KafkaProducer")
    @patch("markettor.kafka_client.client._KafkaProducer.produce")
