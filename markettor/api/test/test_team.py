...
from markettor.api.test.batch_exports.conftest import start_test_worker
from markettor.constants import AvailableFeature
from markettor.models import ActivityLog, EarlyAccessFeature
from markettor.models.async_deletion.async_deletion import AsyncDeletion, DeletionType
...
from markettor.temporal.common.schedule import describe_schedule
...
def team_api_test_factory():
    class TestTeamAPI(APIBaseTest):
        ...
        @patch("markettor.api.project.get_geoip_properties")
        @patch("markettor.api.team.get_geoip_properties")
        ...
        @patch("markettor.api.project.delete_bulky_postgres_data")
        @patch("markettor.api.team.delete_bulky_postgres_data")
        ...
        def test_delete_bulky_postgres_data(self):
            ...
            from markettor.models.cohort import Cohort, CohortPeople
            from markettor.models.feature_flag.feature_flag import (
                FeatureFlag,
                FeatureFlagHashKeyOverride,
            )

            # from markettor.models.insight_caching_state import InsightCachingState
        ...
        def test_configure_exception_autocapture_event_dropping_only_allows_simple_config(self):
            ...
            assert (
                response.json()["detail"]
                == "Field autocapture_exceptions_errors_to_ignore must be less than 300 characters. Complex config should be provided in markettor-js initialization."
            )
