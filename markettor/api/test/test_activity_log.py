...
from markettor.models import User, NotificationViewed
from markettor.test.base import APIBaseTest, QueryMatchingTest, FuzzyInt
...
class TestActivityLog(APIBaseTest, QueryMatchingTest):
    def setUp(self) -> None:
        ...
        self.other_user = User.objects.create_and_join(
            ...
            email="other_user@markettor.com",
            password="",
        )
        self.third_user = User.objects.create_and_join(
            organization=self.organization,
            email="third_user@markettor.com",
            password="",
        )
