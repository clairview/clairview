...
from markettor.api.annotation import AnnotationSerializer
from markettor.api.routing import DefaultRouterPlusPlus
from markettor.models.annotation import Annotation
...
@override_settings(ROOT_URLCONF=__name__)  # Use `urlpatterns` from this file and not from `markettor.urls`
