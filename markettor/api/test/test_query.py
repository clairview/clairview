...
from markettor.torql.query import LimitContext
...
class TestQuery(ClickhouseTestMixin, APIBaseTest):
    ...
    @patch("markettor.torql.constants.DEFAULT_RETURNED_ROWS", 10)
    @patch("markettor.torql.constants.MAX_SELECT_RETURNED_ROWS", 15)
