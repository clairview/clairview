...
from markettor.api.sharing import shared_url_as_png
from markettor.models import ExportedAsset, ActivityLog
...
class TestSharing(APIBaseTest):
    ...
    @patch("markettor.api.exports.exporter.export_asset.delay")
    ...
    @patch("markettor.api.exports.exporter.export_asset.delay")
    @patch("markettor.models.exported_asset.object_storage.read_bytes")
    @patch("markettor.api.sharing.asset_for_token")
