...
from markettor.models import Action, Element, Organization, Person, User
from markettor.models.cohort import Cohort
from markettor.models.event.query_event_list import insight_query_with_columns
...
class TestEvents(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_filter_events_by_event_name(self):
        ...
        # Django session, MarketTor user, MarketTor team, MarketTor org membership,
    ...
    def test_get_event_by_id(self):
        _create_person(
            properties={"email": "someone@markettor.com"},
            team=self.team,
            distinct_ids=["1"],
            is_identified=True,
        )
    ...
    def test_get_events_with_specified_token(self):
        _, _, user2 = User.objects.bootstrap("Test", "team2@markettor.com", None)
    ...
    @patch("markettor.models.event.query_event_list.insight_query_with_columns")
    ...
    @patch("markettor.models.event.query_event_list.insight_query_with_columns", wraps=insight_query_with_columns)
