...
from markettor.api.insight import InsightSerializer
from markettor.models import DashboardTile
...
from markettor.tasks.exports.image_exporter import export_image
...
class TestExports(APIBaseTest):
    ...
    @patch("markettor.api.exports.exporter")
    ...
    def test_swallow_missing_schema_and_allow_front_end_to_poll(self, mock_exporter_task) -> None:
        # regression test see https://github.com/MarketTor/markettor/issues/11204
    ...
    @patch("markettor.tasks.exports.image_exporter._export_to_png")
    @patch("markettor.api.exports.exporter")
    ...
    def test_can_create_new_valid_export_insight(self, mock_exporter_task, mock_export_to_png) -> None:
        ...
        with patch("markettor.tasks.exports.image_exporter.process_query_dict") as mock_process_query_dict:
    ...
    @patch("markettor.tasks.exports.csv_exporter.requests.request")
