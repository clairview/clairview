...
from markettor.models import Cohort, Organization, Person, Team
...
from markettor.models.person.util import create_person
...
class TestPerson(ClickhouseTestMixin, APIBaseTest):
    ...
    @mock.patch("markettor.api.person.capture_internal")
    ...
    @patch("markettor.api.person.PersonsThrottle.rate", new="6/minute")
