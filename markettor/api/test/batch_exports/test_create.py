...
from markettor.api.test.batch_exports.operations import create_batch_export
...
def test_create_batch_export_with_interval_schedule(client: HttpClient, interval):
    ...
    with start_test_worker(temporal):
        with mock.patch(
            "markettor.batch_exports.http.markettoranalytics.feature_enabled",
            return_value=True,
        ) as feature_enabled:
        ...
        assert args["prefix"] == "markettor-events/"
