...
from markettor.api.survey import nh3_clean_with_allow_list
from markettor.constants import AvailableFeature
from markettor.models import Action, FeatureFlag
...
class TestSurvey(APIBaseTest):
    ...
    def test_can_create_survey_with_linked_flag_and_targeting(self):
        ...
        assert response_data["conditions"] == {"url": "https://app.markettor.com/notebooks"}
        assert response_data["questions"] == [
            {
                "type": "open",
                "question": "What would you want to improve from notebooks?",
    ...
    @patch("markettor.api.survey.report_user_action")
    @freeze_time("2023-05-01 12:00:00")
        ...
        response = self.client.patch(
            ...
            data={
                ...
                "questions": [
                    {
                        "type": "link",
                        "link": "mailto:phani@markettor.com",
                        "question": "<b>What</b> do you think of the new notebooks feature?",
                    },
                ],
            },
...
class TestSurveyQuestionValidationWithEnterpriseFeatures(APIBaseTest):
    ...
    def test_create_survey_with_html_without_feature_flag(self):
        ...
        response_data = response.json()
        assert response.status_code == status.HTTP_400_BAD_REQUEST, response_data
        assert response_data["detail"] == "You need to upgrade to MarketTor Enterprise to use HTML in survey questions"
