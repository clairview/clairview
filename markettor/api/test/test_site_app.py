...
from markettor.api.site_app import get_site_config_from_schema
from markettor.models import Plugin, PluginConfig, PluginSourceFile
...
class TestSiteApp(BaseTest):
    ...
    def test_site_app(self):
        ...
        self.assertEqual(
            ...
            f"function inject(){{}}().inject({{config:{{}},markettor:window['__$$ph_site_app_{plugin_config.id}']}})",
        )
