...
from markettor.api.test.test_exports import TestExportMixin
from markettor.clickhouse.client.execute import sync_execute
from markettor.models import FeatureFlag, Person
...
from markettor.schema import PropertyOperator
from markettor.tasks.calculate_cohort import calculate_cohort_ch, calculate_cohort_from_list
from markettor.tasks.tasks import clickhouse_clear_removed_data
...
class TestCohort(TestExportMixin, ClickhouseTestMixin, APIBaseTest, QueryMatchingTest):
    ...
    @patch("markettor.api.cohort.report_user_action")
    @patch("markettor.tasks.calculate_cohort.calculate_cohort_ch.delay", side_effect=calculate_cohort_ch)
    @patch("markettor.models.cohort.util.sync_execute", side_effect=sync_execute)
    ...
    @patch("markettor.api.cohort.report_user_action")
    @patch("markettor.tasks.calculate_cohort.calculate_cohort_ch.delay")
    ...
    @patch("markettor.tasks.calculate_cohort.calculate_cohort_from_list.delay")
