...
from markettor.test.base import APIBaseTest, QueryMatchingTest


class TestOrganizationMembersAPI(APIBaseTest, QueryMatchingTest):
    def test_list_organization_members(self):
        User.objects.create_and_join(self.organization, "1@markettor.com", None)
        User.objects.create_and_join(self.organization, "2@markettor.com", None, is_active=False)
    ...
    def test_cant_list_members_for_an_alien_organization(self):
        ...
        user = User.objects.create(email="another_user@markettor.com")
    ...
    @patch("markettor.models.user.User.update_billing_organization_users")
