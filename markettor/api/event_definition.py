...
from markettor.api.utils import create_event_definitions_sql
from markettor.constants import AvailableFeature, EventDefinitionType
...
class EventDefinitionViewSet(
    ...
    def dangerously_get_queryset(self):
        ...
        params = {"team_id": self.team.project_id, "is_markettor_event": "$%", **search_kwargs}
