...
from markettor.async_migrations.runner import (
    ...
    is_markettor_version_compatible,
)
from markettor.async_migrations.setup import get_async_migration_definition
...
from markettor.permissions import IsStaffUser
...
class AsyncMigrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "started_at",
            "finished_at",
            "markettor_max_version",
            "markettor_min_version",
            "parameters",
            "error_count",
    ...
    def get_is_available(self, async_migration: AsyncMigration):
        return (
            ...
            or Version(async_migration.markettor_min_version) <= FROZEN_MARKETTOR_VERSION
        )
...
class AsyncMigrationsViewset(viewsets.ModelViewSet):
    ...
    def trigger(self, request, **kwargs):
        ...
        if not is_markettor_version_compatible(
            ...
            return response.Response(
                {
                    "success": False,
                    "error": f"Can't run migration. Minimum MarketTor version: {migration_instance.markettor_min_version}. Maximum MarketTor version: {migration_instance.markettor_max_version}",
                },
                status=400,
            )
