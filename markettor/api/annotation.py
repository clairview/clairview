...
from markettor.models import Annotation
...
class AnnotationsViewSet(TeamAndOrgViewSetMixin, ForbidDestroyModel, viewsets.ModelViewSet):
    """
    Create, Read, Update and Delete annotations. [See docs](https://markettor.com/docs/user-guides/annotations) for more information on annotations.
    """
