...
from markettor.api.utils import ClassicBehaviorBooleanFieldSerializer, action
from markettor.cdp.templates import HOG_FUNCTION_MIGRATORS
from markettor.models import Plugin, PluginAttachment, PluginConfig, User
...
from markettor.models.activity_logging.serializers import ActivityLogSerializer
from markettor.models.organization import Organization
from markettor.models.plugin import (
    PluginSourceFile,
    update_validated_data_from_url,
    validate_plugin_job_payload,
    transpile,
)
from markettor.models.utils import UUIDT, generate_random_token
from markettor.permissions import APIScopePermission
from markettor.plugins import can_configure_plugins, can_install_plugins, parse_url
from markettor.plugins.access import can_globally_manage_plugins, has_plugin_access_level
from markettor.plugins.plugin_server_api import populate_plugin_capabilities_on_workers
from markettor.queries.app_metrics.app_metrics import TeamPluginsDeliveryRateQuery
...
class PluginViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    def repository(self, request: request.Request, **kwargs):
        url = "https://raw.githubusercontent.com/MarketTor/integrations-repository/main/plugins.json"
