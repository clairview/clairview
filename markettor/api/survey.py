...
from markettor.api.action import ActionSerializer
from markettor.api.feature_flag import (
...
from markettor.api.utils import action, get_token
...
from markettor.models.feature_flag.feature_flag import FeatureFlag
    ...
    def validate_appearance(self, value):
        ...
        if thank_you_description_content_type == "html" and not use_survey_html_descriptions:
            raise serializers.ValidationError(
                "You need to upgrade to MarketTor Enterprise to use HTML in survey thank you message"
            )
    ...
    def validate_questions(self, value):
        ...
        for raw_question in value:
            ...
            if description_content_type == "html" and not use_survey_html_descriptions:
                raise serializers.ValidationError(
                    "You need to upgrade to MarketTor Enterprise to use HTML in survey questions"
                )
...
class SurveyAPISerializer(serializers.ModelSerializer):
    """
    Serializer for the exposed /api/surveys endpoint, to be used in markettor-js and for headless APIs.
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            # (https://markettorhelp.zendesk.com/agent/tickets/15210), which was a problem for them
...
def surveys(request: Request):
    ...
    if not token:
        return cors_response(
            ...
            generate_exception_response(
                "surveys",
                "API key not provided. You can find your project API key in your MarketTor project settings.",
    ...
    if team is None:
        return cors_response(
            ...
            generate_exception_response(
                "surveys",
                "Project API key invalid. You can find your project API key in your MarketTor project settings.",
                type="authentication_error",
