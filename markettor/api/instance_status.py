...
from markettor.async_migrations.status import async_migrations_ok
from markettor.cloud_utils import is_cloud
from markettor.git import get_git_commit_short
from markettor.permissions import SingleTenancyOrAdmin
...
class InstanceStatusViewSet(viewsets.ViewSet):
    ...
    def list(self, request: Request) -> Response:
        ...
        metrics.append(
            {"key": "markettor_git_sha", "metric": "MarketTor Git SHA", "value": get_git_commit_short() or "unknown"}
        )
    ...
    def navigation(self, request: Request) -> Response:
        ...
        from markettor.clickhouse.system_status import dead_letter_queue_ratio_ok_cached
    ...
    def queries(self, request: Request) -> Response:
        ...
        from markettor.clickhouse.system_status import (
