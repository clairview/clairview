...
from markettor.api.documentation import (
...
from markettor.models.team import TIMEZONES
...
class GenericInsightsSerializer(serializers.Serializer):
    ...
    filter_test_accounts = serializers.BooleanField(
        help_text='Whether to filter out internal and test accounts. See "project settings" in your MarketTor account for the filters.',
        default=False,
    )
