...
from markettor.models.property import OperatorType, PropertyType
...
class PersonalAPIKeyScheme(OpenApiAuthenticationExtension):
    target_class = "markettor.auth.PersonalAPIKeyAuthentication"
...
def custom_postprocessing_hook(result, generator, request, public):
    ...
    return {
        **result,
        "info": {"title": "MarketTor API", "version": None, "description": ""},
        "paths": paths,
