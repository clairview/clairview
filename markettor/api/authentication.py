...
from markettor.api.email_verification import EmailVerifier, is_email_verification_disabled
from markettor.email import is_email_available
from markettor.event_usage import report_user_logged_in, report_user_password_reset
from markettor.models import OrganizationDomain, User
from markettor.rate_limit import UserPasswordResetThrottle
from markettor.tasks.email import send_password_reset
from markettor.utils import get_instance_available_sso_providers
        ...
        for key, value in self.context["request"].COOKIES.items():
            if key.startswith(REMEMBER_COOKIE_PREFIX) and value:
                try:
                    ...
                    # See https://github.com/MarketTor/markettor/issues/19350
                    pass
        return True
