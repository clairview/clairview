...
from markettor.api.shared import ProjectBasicSerializer, TeamBasicSerializer
from markettor.cloud_utils import is_cloud
from markettor.constants import INTERNAL_BOT_EMAIL_SUFFIX, AvailableFeature
from markettor.event_usage import report_organization_deleted
from markettor.models import Organization, User
...
from markettor.models.team.util import delete_bulky_postgres_data
from markettor.models.uploaded_media import UploadedMedia
...
class PremiumMultiorganizationPermissions(permissions.BasePermission):
    ...
    message = "You must upgrade your MarketTor plan to be able to create and manage multiple organizations."
