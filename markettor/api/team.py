...
from markettor.api.shared import TeamBasicSerializer
...
from markettor.models.personal_api_key import APIScopeObjectOrNotSupported
from markettor.models.project import Project
from markettor.models.signals import mute_selected_signals
from markettor.models.team.util import delete_batch_exports, delete_bulky_postgres_data
from markettor.models.utils import UUIDT
from markettor.permissions import (
    CREATE_METHODS,
    APIScopePermission,
...
from markettor.utils import get_ip_address, get_week_start_for_country_code


class PremiumMultiProjectPermissions(BasePermission):  # TODO: Rename to include "Env" in name
    """Require user to have all necessary premium features on their plan for create access to the endpoint."""

    message = "You must upgrade your MarketTor plan to be able to create and manage multiple projects or environments."
