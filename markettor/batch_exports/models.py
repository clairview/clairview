...
class BatchExportDestination(UUIDModel):
    """A model for the destination that a MarketTor BatchExport will target.
    ...
    class Destination(models.TextChoices):
        """Enumeration of supported destinations for MarketTor BatchExports."""
...
class BatchExportRun(UUIDModel):
    """A model of a single run of a MarketTor BatchExport given a time interval.
...
class BatchExport(UUIDModel):
    """
    Defines the configuration of MarketTor to export data to a destination,
