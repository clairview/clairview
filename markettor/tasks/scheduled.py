...
from markettor.caching.warming import schedule_warming_for_teams_task
from markettor.celery import app
from markettor.tasks.alerts.checks import (
    check_alerts_task,
    checks_cleanup_task,
    alerts_backlog_task,
)
from markettor.tasks.integrations import refresh_integrations
from markettor.tasks.tasks import (
    calculate_cohort,
...
from markettor.utils import get_crontab
...
def setup_periodic_tasks(sender: Celery, **kwargs: Any) -> None:
    ...
    # Every 30 minutes, send decide request counts to the main markettor instance
    sender.add_periodic_task(
        crontab(minute="*/30"),
    ...
    if settings.EE_AVAILABLE:
        ...
        )  # every day at a random minute past midnight. Randomize to avoid overloading license.markettor.com
        sender.add_periodic_task(
