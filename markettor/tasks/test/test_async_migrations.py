...
from markettor.async_migrations.examples.test_migration import Migration
from markettor.async_migrations.runner import (
    run_async_migration_next_op,
    run_async_migration_operations,
)
from markettor.async_migrations.test.util import create_async_migration
...
class TestAsyncMigrations(BaseTest):
    ...
    @patch("markettor.celery.app.control.inspect", side_effect=inspect_mock)
    @patch(
        "markettor.tasks.async_migrations.run_async_migration.delay",
