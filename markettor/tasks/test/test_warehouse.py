...
from markettor.tasks.warehouse import (
    capture_workspace_rows_synced_by_team,
    validate_data_warehouse_table_columns,
    capture_external_data_rows_synced,
)
from markettor.warehouse.models import ExternalDataSource, ExternalDataJob
...
class TestWarehouse(APIBaseTest):
    @patch("markettor.tasks.warehouse.get_ph_client")
    @patch(
        "markettor.tasks.warehouse.DEFAULT_DATE_TIME",
    ...
    @patch("markettor.tasks.warehouse.capture_workspace_rows_synced_by_team.delay")
