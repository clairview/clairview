...
from markettor.models.alert import AlertCheck
from markettor.models.instance_setting import set_instance_setting
from markettor.tasks.alerts.checks import _send_notifications_for_breaches, check_alert
from markettor.test.base import APIBaseTest, _create_event, flush_persons_and_events, ClickhouseDestroyTablesMixin
from markettor.api.test.dashboards import DashboardAPI
from markettor.schema import ChartDisplayType, EventsNode, TrendsQuery, TrendsFilter, AlertState
...
@patch("markettor.tasks.alerts.checks._send_notifications_for_errors")
@patch("markettor.tasks.alerts.checks._send_notifications_for_breaches")
class TestAlertChecks(APIBaseTest, ClickhouseDestroyTablesMixin):
    ...
    def test_send_error_while_calculating(
        ...
        with patch(
            "markettor.tasks.alerts.checks.calculate_for_query_based_insight"
    ...
    @patch("markettor.tasks.alerts.checks.EmailMessage")
    def test_send_emails(
        ...
        assert email.to[0]["recipient"] == "user1@markettor.com"
