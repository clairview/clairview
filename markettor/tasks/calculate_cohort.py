...
from markettor.api.monitoring import Feature
from markettor.models import Cohort
from markettor.models.cohort import get_and_update_pending_version
from markettor.models.cohort.util import clear_stale_cohortpeople
...
def insert_cohort_from_insight_filter(cohort_id: int, filter_data: dict[str, Any]) -> None:
    from markettor.api.cohort import (
