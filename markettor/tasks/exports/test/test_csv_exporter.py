...
from markettor.tasks.exports import csv_exporter
from markettor.tasks.exports.csv_exporter import (
...
class TestCSVExporter(APIBaseTest):
    ...
    def patched_request(self):
        with patch("markettor.tasks.exports.csv_exporter.requests.request") as patched_request:
            mock_response = Mock()
            mock_response.status_code = 200
            # API responses copied from https://github.com/MarketTor/markettor/runs/7221634689?check_suite_focus=true
    ...
    @patch("markettor.models.exported_asset.UUIDT")
    @patch("markettor.models.exported_asset.object_storage.write")
    ...
    @patch("markettor.tasks.exports.csv_exporter.logger")
    ...
    def test_failing_export_api_is_reported_query_size_exceeded(self, _mock_logger: MagicMock) -> None:
        with patch("markettor.tasks.exports.csv_exporter.make_api_call") as patched_make_api_call:
            exported_asset = self._create_asset()
    ...
    @patch("markettor.tasks.exports.csv_exporter.make_api_call")
