...
from markettor.models import ExportedAsset, Insight
...
from markettor.tasks.exports import image_exporter
from markettor.test.base import APIBaseTest

TEST_PREFIX = "Test-Exports"


@patch("markettor.tasks.exports.image_exporter._screenshot_asset")
@patch(
    "markettor.tasks.exports.image_exporter.open",
