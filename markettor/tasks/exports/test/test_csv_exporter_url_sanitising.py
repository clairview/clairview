...
from markettor.utils import PotentialSecurityProblemException, absolute_uri


class TestCSVExporterURLSanitization(APIBaseTest):
    def test_sanitize_url_when_provided_path(self) -> None:
        with self.settings(SITE_URL="https://something.markettor.com"):
            sanitised = absolute_uri(None or "/some/location")
            assert sanitised == "https://something.markettor.com/some/location"
    ...
    error_test_cases = [
        ...
        (
            ...
            "https://something.markettor.com:8000",
            "https://localhost:8123/some/location",
        ),
        (
            "changing domain",
