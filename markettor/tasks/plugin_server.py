...
from markettor.event_usage import report_team_action
from markettor.tasks.email import send_hog_function_disabled, send_fatal_plugin_error
...
def hog_function_state_transition(hog_function_id: str, state: int) -> None:
    ...
    logger.info("hog_function_state_transition: Flushing markettoranalytics")
    markettoranalytics.flush()
