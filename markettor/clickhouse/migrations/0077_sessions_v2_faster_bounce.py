...
from markettor.models.raw_sessions.migrations import (
...
from markettor.models.raw_sessions.sql import DROP_RAW_SESSION_MATERIALIZED_VIEW_SQL, RAW_SESSIONS_TABLE_MV_SQL
