...
from markettor.test.base import BaseTest, ClickhouseDestroyTablesMixin, _create_event
from markettor.client import sync_execute
from markettor.models.utils import UUIDT

module = importlib.import_module("markettor.clickhouse.migrations.0064_materialize_elements_chain")

add_columns_to_required_tables = module.add_columns_to_required_tables

from markettor.models.element.element import Element, chain_to_elements
