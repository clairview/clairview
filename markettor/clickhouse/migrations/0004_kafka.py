...
# removed from the MarketTor app and the Plugin server. See
# https://github.com/MarketTor/markettor/issues/9207 for detail.
#
...
# depending on which versions of MarketTor you have run.
operations = [
