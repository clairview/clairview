...
from markettor.clickhouse.client.connection import Workload, get_pool
from markettor.clickhouse.client.escape import substitute_params
from markettor.clickhouse.query_tagging import get_query_tag_value, get_query_tags
from markettor.errors import wrap_query_error
from markettor.settings import TEST
from markettor.utils import generate_short_id, patchable
...
def sync_execute(
    ...
    *,
    ...
    if get_query_tag_value("id") == "markettor.tasks.tasks.process_query_task":
