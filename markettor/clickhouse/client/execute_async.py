...
from markettor import celery, redis
...
from markettor.tasks.tasks import process_query_task
...
def execute_process_query(
    ...
    from markettor.api.services.query import process_query_dict, ExecutionMode
