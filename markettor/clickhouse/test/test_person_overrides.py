...
from markettor.kafka_client.topics import KAFKA_PERSON_OVERRIDE
from markettor.models.person_overrides.sql import (
...
def test_can_insert_person_overrides():
    ...
    # fix](https://github.com/MarketTor/markettor/pull/13878), so here we create
