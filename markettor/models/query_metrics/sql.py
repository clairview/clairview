...
from markettor.clickhouse.kafka_engine import KAFKA_COLUMNS_WITH_PARTITION, kafka_engine
from markettor.clickhouse.table_engines import MergeTreeEngine
...
# Invoke via `python manage.py shell <  markettor/models/query_metrics/sql.py`
