...
class Annotation(models.Model):
    ...
    dashboard_item = models.ForeignKey("markettor.Insight", on_delete=models.SET_NULL, null=True, blank=True)
    dashboard = models.ForeignKey("markettor.Dashboard", on_delete=models.SET_NULL, null=True, blank=True)
    team = models.ForeignKey("markettor.Team", on_delete=models.CASCADE)
    organization = models.ForeignKey("markettor.Organization", on_delete=models.CASCADE, null=True)
