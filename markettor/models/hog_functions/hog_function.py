...
from markettor.helpers.encrypted_fields import EncryptedJSONStringField
...
from markettor.plugins.plugin_server_api import (
...
def action_saved(sender, instance: Action, created, **kwargs):
    ...
    from markettor.tasks.hog_functions import refresh_affected_hog_functions
