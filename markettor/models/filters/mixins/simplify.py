...
from markettor.models.property import GroupTypeIndex, PropertyGroup
from markettor.schema import PropertyOperator

if TYPE_CHECKING:  # Avoid circular import
    from markettor.models import Property, Team
...
class SimplifyFilterMixin:
    ...
    def simplify(self: T, team: "Team", **kwargs) -> T:
        ...
        from markettor.models.property.util import clear_excess_levels
    ...
    def _simplify_entity(
        ...
        **kwargs,
        ...
        from markettor.models.entity import Entity, ExclusionEntity
    ...
    def _simplify_property(self, team: "Team", property: "Property", **kwargs) -> "PropertyGroup":
        if property.type == "cohort":
            ...
            from markettor.models.cohort.util import simplified_cohort_filter_properties
