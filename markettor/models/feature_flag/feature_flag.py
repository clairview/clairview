...
class FeatureFlag(models.Model):
    ...
    def get_cohort_ids(
        ...
        from markettor.models.cohort.util import get_dependent_cohorts, sort_cohorts_topologically
...
def set_feature_flags_for_team_in_cache(
    ...
    from markettor.api.feature_flag import MinimalFeatureFlagSerializer
