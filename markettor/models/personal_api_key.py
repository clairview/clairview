...
PERSONAL_API_KEY_MODES_TO_TRY: tuple[tuple[ModeType, Optional[int]], ...] = (
    ...
    ("pbkdf2", 260000),  # This is the iteration count used by MarketTor since the beginning of time.
    ("pbkdf2", 390000),  # This is the iteration count used briefly on some API keys.
)

LEGACY_PERSONAL_API_KEY_SALT = "markettor_personal_api_key"
...
class PersonalAPIKey(models.Model):
    ...
    user = models.ForeignKey("markettor.User", on_delete=models.CASCADE, related_name="personal_api_keys")
