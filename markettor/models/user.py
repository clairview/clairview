...
from markettor.settings import INSTANCE_TAG, SITE_URL
...
class User(AbstractUser, UUIDClassicModel):
    ...
    current_team = models.ForeignKey("markettor.Team", models.SET_NULL, null=True, related_name="teams_currently+")
