...
from markettor.models.property import Property, PropertyIdentifier
from markettor.models.property.property import OperatorType
...
def get_action_tables_and_properties(action: Action) -> TCounter[PropertyIdentifier]:
    from markettor.models.property.util import extract_tables_and_properties
