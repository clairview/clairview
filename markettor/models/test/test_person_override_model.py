...
from markettor.models import Person, PersonOverride, PersonOverrideMapping, Team
...
def _merge_people(
    ...
    Note that we don't actually handle the merge on the markettor_person table,
    ...
    # The following INSERTs and UPDATEs will lock markettor_personoverridemapping
    ...
    cursor.execute(
        """
            WITH insert_id AS (
                INSERT INTO markettor_personoverridemapping(
                    team_id,
                    uuid
                )
                VALUES (
            ...
            SELECT id
            FROM markettor_personoverridemapping
    ...
    cursor.execute(
        """
            INSERT INTO markettor_personoverride(
                team_id,
                old_person_id,
                override_person_id,
                oldest_event,
