...
from markettor.jwt import MarkettorJwtAudience, decode_jwt, encode_jwt
from markettor.models.utils import UUIDT
from markettor.settings import DEBUG
...
class ExportedAsset(models.Model):
    ...
    dashboard = models.ForeignKey("markettor.Dashboard", on_delete=models.CASCADE, null=True)
    insight = models.ForeignKey("markettor.Insight", on_delete=models.CASCADE, null=True)
