from markettor.clickhouse.base_sql import COPY_ROWS_BETWEEN_TEAMS_BASE_SQL
from markettor.clickhouse.indexes import index_by_kafka_timestamp
from markettor.clickhouse.kafka_engine import KAFKA_COLUMNS, KAFKA_COLUMNS_WITH_PARTITION, STORAGE_POLICY, kafka_engine
from markettor.clickhouse.table_engines import CollapsingMergeTree, ReplacingMergeTree
