...
CONSTANCE_DATABASE_PREFIX = "constance:markettor:"
...
CONSTANCE_CONFIG = {
    ...
    "ASYNC_MIGRATIONS_IGNORE_MARKETTOR_VERSION": (
        ...
        "(Advanced) Whether to ignore async migrations markettor version restrictions",
        bool,
    ),
    ...
    "SENTRY_AUTH_TOKEN": (
        ...
        "Used to enable Sentry error tracking in MarketTor",
        str,
    ),
    "SENTRY_ORGANIZATION": (
    ...
    "REDIRECT_APP_TO_US": (
        ...
        "Temporary option to redirect all app traffic from app.markettor.com to us.markettor.com.",
        bool,
    ),
}
