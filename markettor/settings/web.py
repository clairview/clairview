...
from markettor.settings.base_variables import BASE_DIR, DEBUG, TEST
from markettor.settings.utils import get_from_env, get_list, str_to_bool
from markettor.utils_cors import CORS_ALLOWED_TRACING_HEADERS
...
AXES_LOCKOUT_CALLABLE = "markettor.api.authentication.axes_locked_out"
...
# until they fix an issue with their feature flags causing instability in markettor.
...
INSTALLED_APPS = [
    ...
    "markettor.apps.MarketTorConfig",
    "rest_framework",
    "loginas",
    "corsheaders",
    "social_django",
...
MIDDLEWARE = [
    "markettor.middleware.PrometheusBeforeMiddlewareWithTeamIds",
    "markettor.gzip_middleware.ScopedGZipMiddleware",
    "markettor.middleware.per_request_logging_context_middleware",
    "django_structlog.middlewares.RequestMiddleware",
    "django_structlog.middlewares.CeleryMiddleware",
    "django.middleware.security.SecurityMiddleware",
    "markettor.middleware.CaptureMiddleware",
    ...
    "markettor.health.healthcheck_middleware",
    "markettor.middleware.ShortCircuitMiddleware",
    "markettor.middleware.AllowIPMiddleware",
    "django.contrib.sessions.middleware.SessionMiddleware",
    "markettor.middleware.SessionAgeMiddleware",
    "corsheaders.middleware.CorsMiddleware",
    "django.middleware.common.CommonMiddleware",
    "markettor.middleware.CsrfOrKeyViewMiddleware",
    "markettor.middleware.QueryTimeCountingMiddleware",
    "django.contrib.auth.middleware.AuthenticationMiddleware",
    "markettor.middleware.user_logging_context_middleware",
    "django_otp.middleware.OTPMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "markettor.middleware.AutoLogoutImpersonateMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "markettor.middleware.CsvNeverCacheMiddleware",
    "whitenoise.middleware.WhiteNoiseMiddleware",
    "axes.middleware.AxesMiddleware",
    "markettor.middleware.AutoProjectMiddleware",
    "markettor.middleware.CHQueries",
    "markettor.middleware.PrometheusAfterMiddlewareWithTeamIds",
    "markettor.middleware.MarketTorTokenCookieMiddleware",
]
...
ROOT_URLCONF = "markettor.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": ["frontend/dist", "markettor/templates", "markettor/year_in_markettor"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "markettor.wsgi.application"


# Social Auth

SOCIAL_AUTH_JSONFIELD_ENABLED = True
SOCIAL_AUTH_USER_MODEL = "markettor.User"
...
SOCIAL_AUTH_PIPELINE = (
    ...
    "markettor.api.signup.social_create_user",
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {"NAME": "markettor.auth.ZxcvbnValidator"},
]
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, "markettor/year_in_markettor/images"),
]
STATICFILES_STORAGE = "whitenoise.storage.ManifestStaticFilesStorage"

AUTH_USER_MODEL = "markettor.User"
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ["markettor.auth.SessionAuthentication"],
    "DEFAULT_PAGINATION_CLASS": "rest_framework.pagination.LimitOffsetPagination",
    "DEFAULT_PERMISSION_CLASSES": ["rest_framework.permissions.IsAuthenticated"],
    "DEFAULT_RENDERER_CLASSES": ["markettor.renderers.SafeJSONRenderer"],
    "PAGE_SIZE": 100,
    ...
    "DEFAULT_THROTTLE_CLASSES": [
        "markettor.rate_limit.BurstRateThrottle",
        "markettor.rate_limit.SustainedRateThrottle",
    ],
...
SPECTACULAR_SETTINGS = {
    "AUTHENTICATION_WHITELIST": ["markettor.auth.PersonalAPIKeyAuthentication"],
    "PREPROCESSING_HOOKS": ["markettor.api.documentation.preprocess_exclude_path_format"],
    "POSTPROCESSING_HOOKS": [
        "drf_spectacular.hooks.postprocess_schema_enums",
        "markettor.api.documentation.custom_postprocessing_hook",
    ],
    "ENUM_NAME_OVERRIDES": {
        "DashboardRestrictionLevel": "markettor.models.dashboard.Dashboard.RestrictionLevel",
        "OrganizationMembershipLevel": "markettor.models.organization.OrganizationMembership.Level",
        "SurveyType": "markettor.models.feedback.survey.Survey.SurveyType",
    },
}

EXCEPTIONS_HOG = {"EXCEPTION_REPORTING": "markettor.exceptions.exception_reporting"}
...
CSRF_COOKIE_NAME = "markettor_csrftoken"
CSRF_COOKIE_AGE = get_from_env("CSRF_COOKIE_AGE", SESSION_COOKIE_AGE, type_cast=int)


# see markettor.gzip_middleware.ScopedGZipMiddleware
...
# temporary flag to control new UUID version setting in markettor-js
