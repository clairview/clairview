...
from markettor.settings.base_variables import DEBUG, STATIC_COLLECTION, TEST
    ...
    if not TRUST_ALL_PROXIES and not TRUSTED_PROXIES:
        logger.warning(
            """
                ...
                https://markettor.com/docs/configuring-markettor/running-behind-proxy for details.
            """
        )
