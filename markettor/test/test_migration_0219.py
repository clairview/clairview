...
from markettor.test.base import TestMigrations
...
class TagsTestCase(TestMigrations):
    ...
    def setUpBeforeMigration(self, apps):
        Dashboard = apps.get_model("markettor", "Dashboard")
        Insight = apps.get_model("markettor", "Insight")
    ...
    def test_tags_migrated(self):
        Tag = self.apps.get_model("markettor", "Tag")  # type: ignore
        TaggedItem = self.apps.get_model("markettor", "TaggedItem")  # type: ignore
        Dashboard = self.apps.get_model("markettor", "Dashboard")  # type: ignore
        Insight = self.apps.get_model("markettor", "Insight")  # type: ignore
