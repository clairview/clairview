...
from markettor.email import EmailMessage, _send_email
from markettor.models import MessagingRecord, Organization, Person, Team, User
...
class TestEmail(BaseTest):
    ...
    def setUp(self):
        ...
        self.user2 = User.objects.create(email="test2@markettor.com")
        self.user_red_herring = User.objects.create(email="test+redherring@markettor.com")
        ...
        MessagingRecord.objects.get_or_create(
            raw_email="test+redherring@markettor.com",
    ...
    def test_cant_send_same_campaign_twice(self) -> None:
        with override_instance_config("EMAIL_HOST", "localhost"):
            ...
            record, _ = MessagingRecord.objects.get_or_create(raw_email="test0@markettor.com", campaign_key="campaign_1")
            ...
            with self.settings(CELERY_TASK_ALWAYS_EAGER=True):
                _send_email(
                    ...
                    to=[
                        {
                            "raw_email": "test0@markettor.com",
                            "recipient": "Test MarketTor <test0@markettor.com>",
                        }
                    ],
                    subject="Test email",
                    headers={},
    ...
    def test_applies_default_utm_tags(self) -> None:
        with override_instance_config("EMAIL_HOST", "localhost"):
            ...
            assert (
                f"https://markettor.com/questions?utm_source=markettor&amp;utm_medium=email&amp;utm_campaign={template}"
