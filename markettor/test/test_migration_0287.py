from markettor.test.base import NonAtomicTestMigrations
...
class CreatingSessionRecordingModelMigrationTestCase(NonAtomicTestMigrations):
    ...
    def setUpBeforeMigration(self, apps):
        Organization = apps.get_model("markettor", "Organization")
        Team = apps.get_model("markettor", "Team")
        SessionRecordingPlaylist = apps.get_model("markettor", "SessionRecordingPlaylist")
        SessionRecordingPlaylistItem = apps.get_model("markettor", "SessionRecordingPlaylistItem")
    ...
    def test_migrate_to_create_session_recordings(self):
        SessionRecording = self.apps.get_model("markettor", "SessionRecording")  # type: ignore
        SessionRecordingPlaylist = self.apps.get_model("markettor", "SessionRecordingPlaylist")  # type: ignore
        SessionRecordingPlaylistItem = self.apps.get_model("markettor", "SessionRecordingPlaylistItem")  # type: ignore
    ...
    def tearDown(self):
        Organization = self.apps.get_model("markettor", "Organization")  # type: ignore
        Team = self.apps.get_model("markettor", "Team")  # type: ignore
        SessionRecording = self.apps.get_model("markettor", "SessionRecording")  # type: ignore
        SessionRecordingPlaylistItem = self.apps.get_model("markettor", "SessionRecordingPlaylistItem")  # type: ignore
        SessionRecordingPlaylist = self.apps.get_model("markettor", "SessionRecordingPlaylist")  # type: ignore
