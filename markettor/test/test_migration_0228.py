...
class FixingDashboardTilesTestCase(TestMigrations):
    ...
    def setUpBeforeMigration(self, apps):
        ...
        DashboardTile = apps.get_model("markettor", "DashboardTile")
    ...
    def test_migrate_to_create_tiles(self):
        ...
        """
        DashboardTile = self.apps.get_model("markettor", "DashboardTile")  # type: ignore
    ...
    def tearDown(self):
        ...
        Insight = self.apps.get_model("markettor", "Dashboard")  # type: ignore
