...
from markettor.constants import PropertyOperatorType, TREND_FILTER_TYPE_ACTIONS, TREND_FILTER_TYPE_EVENTS
from markettor.torql import ast
from markettor.torql.parser import parse_expr
from markettor.torql.property import (
    action_to_expr,
    has_aggregation,
    property_to_expr,
    selector_to_expr,
...
from markettor.models.property_definition import PropertyType
from markettor.schema import TorQLPropertyFilter, RetentionEntity, EmptyPropertyFilter
from markettor.test.base import BaseTest, _create_event
from markettor.warehouse.models import DataWarehouseTable, DataWarehouseJoin, DataWarehouseCredential
...
class TestProperty(BaseTest):
    ...
    def test_entity_to_expr_actions_type_with_id(self):
        ...
        with patch("markettor.models.Action.objects.get", return_value=action_mock):
