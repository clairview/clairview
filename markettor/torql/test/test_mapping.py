from markettor.torql.ast import FloatType, IntegerType
from markettor.test.base import BaseTest
from typing import Optional
from markettor.torql.functions.mapping import (
    compare_types,
    find_torql_function,
...
class TestMappings(BaseTest):
    ...
    def _get_torql_markettor_function(self, name: str) -> TorQLFunctionMeta:
        return self._return_present_function(find_torql_markettor_function(name))
    ...
    def test_find_case_sensitive_function(self):
        ...
        self.assertEqual(self._get_torql_markettor_function("sparkline").clickhouse_name, "sparkline")
        self.assertEqual(find_torql_markettor_function("SPARKLINE"), None)
    ...
    def test_find_non_existent_function(self):
        ...
        self.assertEqual(find_torql_markettor_function("functionThatDoesntExist"), None)
