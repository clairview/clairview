...
from markettor.torql.constants import (
    MAX_SELECT_RETURNED_ROWS,
    TorQLGlobalSettings,
)
from markettor.torql.functions import (
...
from markettor.torql.database.models import Table, FunctionCallTable, SavedQuery
from markettor.torql.database.database import create_torql_database
from markettor.torql.database.s3_table import S3Table
from markettor.torql.errors import ImpossibleASTError, InternalTorQLError, QueryError, ResolutionError
...
from markettor.torql.functions.mapping import ALL_EXPOSED_FUNCTION_NAMES, validate_function_args, TORQL_COMPARISON_MAPPING
from markettor.torql.modifiers import create_default_modifiers_for_team, set_default_in_cohort_via
from markettor.torql.resolver import resolve_types
from markettor.torql.resolver_utils import lookup_field_by_name
from markettor.torql.transforms.in_cohort import resolve_in_cohorts, resolve_in_cohorts_conjoined
from markettor.torql.transforms.lazy_tables import resolve_lazy_tables
from markettor.torql.transforms.property_types import build_property_swapper, PropertySwapper
from markettor.torql.visitor import Visitor, clone_expr
from markettor.models.property import PropertyName, TableColumn
...
class _Printer(Visitor):
    ...
    def visit_compare_operation(self, node: ast.CompareOperation):
        ...
        # :HACK: until the new type system is out: https://github.com/MarketTor/markettor/pull/17267
    ...
    def visit_call(self, node: ast.Call):
        ...
        elif func_meta := find_torql_markettor_function(node.name):
            validate_function_args(node.args, func_meta.min_args, func_meta.max_args, node.name)
            args = [self.visit(arg) for arg in node.args]
