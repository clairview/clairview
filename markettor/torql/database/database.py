...
from markettor.torql.database.schema.channel_type import create_initial_channel_type, create_initial_domain_type
from markettor.torql.database.schema.cohort_people import CohortPeople, RawCohortPeople
from markettor.torql.database.schema.events import EventsTable
from markettor.torql.database.schema.groups import GroupsTable, RawGroupsTable
from markettor.torql.database.schema.heatmaps import HeatmapsTable
from markettor.torql.database.schema.log_entries import (
    LogEntriesTable,
    ReplayConsoleLogsLogEntriesTable,
    BatchExportLogEntriesTable,
)
from markettor.torql.database.schema.numbers import NumbersTable
from markettor.torql.database.schema.person_distinct_id_overrides import (
    PersonDistinctIdOverridesTable,
    RawPersonDistinctIdOverridesTable,
    join_with_person_distinct_id_overrides_table,
)
from markettor.torql.database.schema.person_distinct_ids import (
    PersonDistinctIdsTable,
    RawPersonDistinctIdsTable,
)
from markettor.torql.database.schema.persons import (
    PersonsTable,
    RawPersonsTable,
    join_with_persons_table,
)
from markettor.torql.database.schema.session_replay_events import (
    RawSessionReplayEventsTable,
    SessionReplayEventsTable,
    join_replay_table_to_sessions_table_v2,
)
from markettor.torql.database.schema.sessions_v1 import RawSessionsTableV1, SessionsTableV1
from markettor.torql.database.schema.sessions_v2 import (
    SessionsTableV2,
    RawSessionsTableV2,
    join_events_table_to_sessions_table_v2,
)
from markettor.torql.database.schema.static_cohort_people import StaticCohortPeople
...
from markettor.warehouse.models.external_data_job import ExternalDataJob
from markettor.warehouse.models.external_data_schema import ExternalDataSchema
from markettor.warehouse.models.external_data_source import ExternalDataSource
from markettor.warehouse.models.table import (
    DataWarehouseTable,
...
class Database(BaseModel):
    ...
    def get_markettor_tables(self) -> list[str]:
...
DatabaseSchemaTable: TypeAlias = DatabaseSchemaMarketTorTable | DatabaseSchemaDataWarehouseTable | DatabaseSchemaViewTable
...
def serialize_database(
    ...
    # MarketTor Tables
    markettor_tables = context.database.get_markettor_tables()
    for table_key in markettor_tables:
        ...
        fields = serialize_fields(field_input, context, table_key, table_type="markettor")
        fields_dict = {field.name: field for field in fields}
        tables[table_key] = DatabaseSchemaMarketTorTable(fields=fields_dict, id=table_key, name=table_key)
...
def serialize_fields(
    ...
    table_type: Literal["markettor"] | Literal["external"] = "markettor",
) -> list[DatabaseSchemaField]:
    from markettor.torql.database.models import SavedQuery
    from markettor.torql.resolver import resolve_types_from_table
    ...
    for field_key, field in field_input.items():
        ...
        if field_key == "team_id" and table_type == "markettor":
            pass
