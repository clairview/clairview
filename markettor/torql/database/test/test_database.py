...
from markettor.torql.database.models import FieldTraverser, LazyJoin, StringDatabaseField, ExpressionField, Table
...
from markettor.schema import DatabaseSchemaDataWarehouseTable, TorQLQueryModifiers, PersonsOnEventsMode
from markettor.test.base import BaseTest, QueryMatchingTest, FuzzyInt
from markettor.warehouse.models import DataWarehouseTable, DataWarehouseCredential, DataWarehouseSavedQuery
from markettor.torql.query import execute_torql_query
from markettor.torql.test.utils import pretty_print_in_tests
...
from markettor.warehouse.models.join import DataWarehouseJoin
...
class TestDatabase(BaseTest, QueryMatchingTest):
    ...
    def test_serialize_database_markettor_table(self):
        ...
        tables = database.get_markettor_tables()
    ...
    @patch("markettor.torql.query.sync_execute", return_value=([], []))
    @pytest.mark.usefixtures("unittest_snapshot")
