...
from markettor.torql.ast import CompareOperationOp, ArithmeticOperationOp
from markettor.torql.context import TorQLContext
from markettor.torql.database.models import DatabaseField, LazyJoinToAdd, LazyTableToAdd
from markettor.torql.errors import NotImplementedError

from markettor.torql.visitor import clone_expr, CloningVisitor, Visitor, TraversingVisitor
...
class IsSimpleTimestampFieldExpressionVisitor(Visitor[bool]):
    ...
    def visit_alias(self, node: ast.Alias) -> bool:
        ...
        from markettor.torql.database.schema.sessions_v1 import SessionsTableV1
        from markettor.torql.database.schema.sessions_v2 import SessionsTableV2

        from markettor.torql.database.schema.session_replay_events import RawSessionReplayEventsTable
