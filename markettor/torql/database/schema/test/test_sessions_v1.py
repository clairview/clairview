...
from markettor.schema import TorQLQueryModifiers, BounceRatePageViewMode, SessionTableVersion
...
class TestSessionsV1(ClickhouseTestMixin, APIBaseTest):
    def __execute(self, query):
        modifiers = TorQLQueryModifiers(sessionTableVersion=SessionTableVersion.V1)
