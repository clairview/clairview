...
from markettor.torql.database.models import ExpressionField
...
def create_channel_type_expr(
    ...
    # This logic is referenced in our docs https://markettor.com/docs/data/channel-type, be sure to update both if you
    # update either.
    return parse_expr(
        """
multiIf(
