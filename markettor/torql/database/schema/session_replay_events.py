from markettor.torql.ast import SelectQuery, JoinExpr
...
from markettor.torql.database.schema.log_entries import ReplayConsoleLogsLogEntriesTable
...
from markettor.torql.database.schema.sessions_v1 import SessionsTableV1, select_from_sessions_table_v1
from markettor.torql.database.schema.sessions_v2 import select_from_sessions_table_v2, session_id_to_session_id_v7_expr

from markettor.torql.errors import ResolutionError


def join_replay_table_to_sessions_table_v1(
    join_to_add: LazyJoinToAdd, context: TorQLContext, node: SelectQuery
) -> JoinExpr:
...
SESSION_REPLAY_EVENTS_COMMON_FIELDS: dict[str, FieldOrTable] = {
    ...
    # this is so that TorQL properties e.g. on test account filters can find the correct column
