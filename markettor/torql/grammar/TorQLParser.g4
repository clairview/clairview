parser grammar TorQLParser;

options {
    tokenVocab = TorQLLexer;
}
...
// SELECT statement
select: (selectUnionStmt | selectStmt | torqlxTagElement) EOF;
...
//    | EXTRACT LPAREN interval FROM columnExpr RPAREN                                      # ColumnExprExtract   // Interferes with a function call
    ...
    | torqlxTagElement                                                                    # ColumnExprTagElement
...
torqlxTagElement
    : LT identifier torqlxTagAttribute* SLASH GT                                        # TorqlxTagElementClosed
    | LT identifier torqlxTagAttribute* GT (torqlxTagElement | (LBRACE columnExpr RBRACE))? LT SLASH identifier GT     # TorqlxTagElementNested
    ;
torqlxTagAttribute
    :   identifier '=' string
...
// This is slightly different in TorQL compared to ClickHouse SQL
// TorQL allows unlimited ("*") nestedIdentifier-s "properties.b.a.a.w.a.s".
