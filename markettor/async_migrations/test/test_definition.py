...
class TestAsyncMigrationDefinition(BaseTest):
    def test_get_async_migration_definition(self):
        from markettor.async_migrations.examples.example import (
            example_fn,
            example_rollback_fn,
        )
        ...
        self.assertEqual(example_migration.markettor_min_version, "1.29.0")
        self.assertEqual(example_migration.markettor_max_version, "1.30.0")
