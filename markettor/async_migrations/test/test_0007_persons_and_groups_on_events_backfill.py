...
from markettor.async_migrations.runner import start_async_migration
from markettor.async_migrations.setup import (
    get_async_migration_definition,
    setup_async_migrations,
)
from markettor.async_migrations.test.util import AsyncMigrationBaseTest
...
from markettor.test.base import ClickhouseTestMixin, run_clickhouse_statement_in_parallel
...
def run_migration():
    ...
    return start_async_migration(MIGRATION_NAME, ignore_markettor_version=True)
