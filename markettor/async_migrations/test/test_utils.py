...
from markettor.async_migrations.definition import AsyncMigrationOperationSQL
from markettor.async_migrations.test.util import (
...
from markettor.models.async_migration import AsyncMigrationError, MigrationStatus
...
class TestUtils(AsyncMigrationBaseTest):
    @patch("markettor.client.sync_execute")
    ...
    @patch("markettor.async_migrations.runner.attempt_migration_rollback")
    ...
    @patch("markettor.tasks.async_migrations.run_async_migration.delay")
    ...
    @patch("markettor.celery.app.control.revoke")
