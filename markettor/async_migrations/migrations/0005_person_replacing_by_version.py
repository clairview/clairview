...
from markettor.async_migrations.utils import execute_op_clickhouse, run_optimize_table
from markettor.clickhouse.kafka_engine import STORAGE_POLICY
from markettor.clickhouse.table_engines import ReplacingMergeTree
from markettor.client import sync_execute
from markettor.constants import AnalyticsDBMS
from markettor.models.async_migration import AsyncMigration
from markettor.models.person.person import Person
from markettor.models.person.sql import PERSONS_TABLE_MV_SQL
...
REDIS_HIGHWATERMARK_KEY = "markettor.async_migrations.0005.highwatermark"
...
class Migration(AsyncMigrationDefinition):
    ...
    markettor_min_version = "1.38.0"
    markettor_max_version = "1.41.99"
