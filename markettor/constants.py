...
FROZEN_MARKETTOR_VERSION = Version("1.43.0")  # Frozen at the last self-hosted version, just for backwards compat now
INTERNAL_BOT_EMAIL_SUFFIX = "@markettorbot.user"
...
class EventDefinitionType(StrEnum):
    ...
    EVENT = "event"
    EVENT_MARKETTOR = "event_markettor"
...
PERMITTED_FORUM_DOMAINS = ["localhost", "markettor.com"]
