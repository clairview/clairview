...
from markettor.health import is_clickhouse_connected, is_kafka_connected
from markettor.models import Organization, User
from markettor.models.integration import SlackIntegration
...
def security_txt(request):
    SECURITY_TXT_CONTENT = """
        Contact: mailto:engineering@markettor.com
        Hiring: https://markettor.com/careers
