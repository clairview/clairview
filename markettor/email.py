...
from markettor.models.messaging import MessagingRecord
...
class EmailMessage:
    def __init__(
        ...
        if "utm_tags" not in template_context:
            template_context.update({"utm_tags": f"utm_source=markettor&utm_medium=email&utm_campaign={template_name}"})
