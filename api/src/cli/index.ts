...
export async function createCli(): Promise<Command> {
	...
	program.name('clairview').usage('[command] [options]');
	program.version(version, '-v, --version');

	program.command('start').description('Start the Clairview API').action(startServer);
	program.command('init').description('Create a new Clairview Project').action(init);
