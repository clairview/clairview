...
import { EXTENSION_PKG_KEY, ExtensionManifest } from '@clairview/extensions';
import { download, type DownloadOptions } from '@clairview/extensions-registry';
import DriverLocal from '@clairview/storage-driver-local';
