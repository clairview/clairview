...
import { InvalidProviderConfigError, TokenExpiredError } from '@clairview/errors';
import type { Accountability } from '@clairview/types';
import { parseJSON, toBoolean } from '@clairview/utils';
...
export default abstract class SocketController {
	...
	private catchInvalidMessages(ws: WebSocket) {
		 ...
		 * https://github.com/clairview/clairview/security/advisories/GHSA-hmgw-9jrg-hf2m
