import { ErrorCode, createError, type ClairviewError } from '@clairview/errors';
import type { Bus } from '@clairview/memory';
...
export class WebhooksService extends ItemsService<Webhook> {
	messenger: Bus;
	errorDeprecation: ClairviewError;

	constructor(options: AbstractServiceOptions) {
		super('clairview_webhooks', options);
