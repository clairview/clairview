...
import { ForbiddenError, InvalidCredentialsError } from '@clairview/errors';
import type { Item, PrimaryKey } from '@clairview/types';
...
export class SharesService extends ItemsService {
	constructor(options: AbstractServiceOptions) {
		super('clairview_shares', options);
	}
	...
	async login(
		...
		await this.knex('clairview_shares')
