...
import { ForbiddenError, InvalidPayloadError, UnprocessableContentError } from '@clairview/errors';
import type { ContentVersion, Filter, Item, PrimaryKey, Query } from '@clairview/types';
import Joi from 'joi';
...
export class VersionsService extends ItemsService {
	constructor(options: AbstractServiceOptions) {
		super('clairview_versions', options);
	}
