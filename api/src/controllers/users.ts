...
import type { PrimaryKey, RegisterUserInput } from '@clairview/types';
...
router.use(useCollection('clairview_users'));
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	const meta = await metaService.getMetaForQuery('clairview_users', req.sanitizedQuery);
