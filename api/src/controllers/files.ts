...
import { ErrorCode, InvalidPayloadError, isClairviewError } from '@clairview/errors';
import formatTitle from '@clairview/format-title';
import type { BusboyFileStream, PrimaryKey } from '@clairview/types';
...
router.use(useCollection('clairview_files'));
...
export const multipartHandler: RequestHandler = (req, res, next) => {
	 ...
	 * the row in clairview_files async during the upload of the actual file.
	 */
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	const meta = await metaService.getMetaForQuery('clairview_files', req.sanitizedQuery);
