...
import { InvalidQueryError, RangeNotSatisfiableError } from '@clairview/errors';
import type { Range } from '@clairview/storage';
...
router.get(
	...
	asyncHandler(async (req, res, next) => {
		const payloadService = new PayloadService('clairview_settings', { schema: req.schema });
