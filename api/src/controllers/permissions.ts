import { ErrorCode, ForbiddenError, isClairviewError } from '@clairview/errors';
...
router.use(useCollection('clairview_permissions'));
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	// temporary fix for missing permissions https://github.com/clairview/clairview/issues/18654
	...
	const meta = await metaService.getMetaForQuery('clairview_permissions', temporaryQuery);
