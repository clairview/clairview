...
// To avoid typos
const TABLE_WEBHOOKS = 'clairview_webhooks';
const TABLE_FLOWS = 'clairview_flows';
const TABLE_OPERATIONS = 'clairview_operations';
