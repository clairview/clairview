...
<template>
	<v-list nav>
		...
		<v-list-item href="https://github.com/clairview/clairview/releases" class="version">
			<v-list-item-icon><v-icon name="clairview" /></v-list-item-icon>
			<v-list-item-content>
				<v-text-overflow class="version" :text="`Clairview ${info.version}`" />
			</v-list-item-content>
		</v-list-item>
	</v-list>
</template>
