...
describe('Alterations', () => {
	describe('files', () => {
		it('autoGenerateJunctionRelation has changed', () => {
			...
			expect(fieldDetailStore.relations.m2o?.related_collection).toEqual('clairview_files');
			expect(fieldDetailStore.relations.m2o?.field).toEqual('clairview_files_id');
