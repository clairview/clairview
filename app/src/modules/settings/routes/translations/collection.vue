...
import { useCollection, useLayout } from '@clairview/composables';
...
const { info: currentCollection } = useCollection('clairview_translations');
...
<template>
	...
	>
		...
		>
			...
			<template #actions>
				<search-input v-model="search" v-model:filter="filter" collection="clairview_translations" />
