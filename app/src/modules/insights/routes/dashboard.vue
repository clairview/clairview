...
import { applyOptionsData } from '@clairview/utils';
...
const { updateAllowed } = useItemPermissions('clairview_panels', props.primaryKey, false);
...
<template>
	...
	<private-view v-else :title="currentDashboard.name">
		...
		<template #sidebar>
			...
			<comments-sidebar-detail :key="primaryKey" collection="clairview_dashboards" :primary-key="primaryKey" />
