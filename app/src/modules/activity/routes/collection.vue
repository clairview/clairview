...
import { Filter } from '@clairview/types';
...
const { layout, layoutOptions, layoutQuery, filter, search } = usePreset(ref('clairview_activity'));
...
<template>
	...
	>
		...
		>
			...
			<template #actions>
				<search-input v-model="search" v-model:filter="filter" collection="clairview_activity" />
			</template>
