...
import type { User } from '@clairview/types';
...
const { info: collectionInfo } = useCollection('clairview_users');
	...
	<private-view :title="title">
		...
		<template #sidebar>
			...
			<revisions-drawer-detail
				...
				@revert="revert"
			/>
			<comments-sidebar-detail v-if="isNew === false" collection="clairview_users" :primary-key="primaryKey" />
		</template>
	</private-view>
</template>
