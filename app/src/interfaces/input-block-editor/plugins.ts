...
/**
 * This file is a modified version of the attaches and image tool from editorjs to work with the Clairview file manager.
 *
 * We include an uploader to directly use Clairview file manager, along with a modified version of the attaches and image tools.
 */
