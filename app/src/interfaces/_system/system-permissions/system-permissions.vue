...
import { PERMISSION_ACTIONS } from '@clairview/constants';
import { appAccessMinimalPermissions, isSystemCollection } from '@clairview/system-data';
import { type Alterations, Filter, Permission, PermissionsAction } from '@clairview/types';
	...
	async function fetchPermissions() {
		...
		try {
			...
			if (itemId.value !== '+') {
				...
				const response = await api.get(getEndpoint('clairview_permissions'), {
					params: {
						fields: '*',
						filter,
						page: 0,
