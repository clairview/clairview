...
import { CLAIRVIEW_LOGO } from './constants';
...
async function init() {
	console.log(CLAIRVIEW_LOGO);

	console.info(
		`Hey! Interested in helping build this open-source data management platform?\nIf so, join our growing team of contributors at: https://clairview.chat`,
	);

	console.info(`%c🐰 Starting Clairview...`, 'color:Green');
