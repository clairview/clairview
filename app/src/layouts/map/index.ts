...
import { useCollection, useItems, useSync } from '@clairview/composables';
import { defineLayout } from '@clairview/extensions';
import { Field, Filter, GeometryOptions } from '@clairview/types';
import { getFieldsFromTemplate, mergeFilters } from '@clairview/utils';
...
export default defineLayout<LayoutOptions, LayoutQuery>({
	...
	setup(props, { emit }) {
		...
		function updateSource() {
			clairviewSource.value = merge({}, clairviewSource.value, {
