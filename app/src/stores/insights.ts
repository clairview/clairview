...
import type { Panel } from '@clairview/extensions';
import { isSystemCollection } from '@clairview/system-data';
import type { Item } from '@clairview/types';
import { applyOptionsData, getSimpleHash, toArray } from '@clairview/utils';
...
export const useInsightsStore = defineStore('insightsStore', () => {
	...
	async function hydrate() {
		...
		if (hasPermission('clairview_dashboards', 'read') && hasPermission('clairview_panels', 'read')) {
			try {
