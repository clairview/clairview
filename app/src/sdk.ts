...
import type { AuthenticationClient, ClairviewClient, RestClient } from '@clairview/sdk';
...
export type SdkClient = ClairviewClient<any> & AuthenticationClient<any> & RestClient<any>;
...
export const sdk: SdkClient = createClairview(getPublicURL(), { globals: { fetch: baseClient.native } })
