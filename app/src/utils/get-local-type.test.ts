...
test('Returns FILE for m2o relations to clairview_files', () => {
	const fieldsStore = useFieldsStore();
...
test('Returns O2M', () => {
	...
	expect(getLocalTypeForField('clairview_files', 'test_field')).toBe('o2m');
});
...
test('Returns TRANSLATIONS for special M2M relations', () => {
	...
	expect(getLocalTypeForField('clairview_files', 'test_field')).toBe('translations');
});
...
test('Returns FILES for M2M relations to clairview_files', () => {
	const fieldsStore = useFieldsStore();
	...
	(relationsStore.getRelationsForField as Mock).mockReturnValue([
		{
			collection: 'collection_a_clairview_files',
			field: 'collection_a_id',
			related_collection: 'collection_a',
			meta: {
				many_collection: 'collection_a_clairview_files',
				many_field: 'collection_a_id',
				one_collection: 'collection_a',
				one_field: 'relation',
				one_collection_field: null,
				one_allowed_collections: null,
				junction_field: 'clairview_files_id',
				sort_field: null,
				one_deselect_action: 'nullify',
			},
		},
		{
			collection: 'collection_a_clairview_files',
			field: 'clairview_files_id',
			related_collection: 'clairview_files',
			meta: {
				many_collection: 'collection_a_clairview_files',
				many_field: 'clairview_files_id',
				one_collection: 'clairview_files',
				one_field: null,
				one_collection_field: null,
				one_allowed_collections: null,
