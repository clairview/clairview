...
export interface DummyMarketTor {
...
const vmMarkettorExtensionCaptureCalledCounter = new Counter({
    name: 'vm_markettor_extension_capture_called_total',
    help: 'Count of times vm markettor extension capture was called',
    labelNames: ['plugin_id'],
})

export function createMarkettor(hub: Hub, pluginConfig: PluginConfig): DummyMarketTor {
