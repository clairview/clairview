...
/**
 * Creates a client to authenticate with Clairview.
 *
 * @param mode AuthenticationMode
 * @param config The optional configuration.
 *
 * @returns A Clairview authentication client.
 */
export const authentication = (mode: AuthenticationMode = 'cookie', config: Partial<AuthenticationConfig> = {}) => {
	return <Schema>(client: ClairviewClient<Schema>): AuthenticationClient<Schema> => {
