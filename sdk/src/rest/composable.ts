...
/**
 * Creates a client to communicate with the Clairview REST API.
 *
 * @returns A Clairview REST client.
 */
export const rest = (config: Partial<RestConfig> = {}) => {
	return <Schema>(client: ClairviewClient<Schema>): RestClient<Schema> => {
