...
export type UpdatePolicyOutput<
	...
	Item extends object = ClairviewPolicy<Schema>,
...
export const updatePolicies =
	<Schema, const TQuery extends Query<Schema, ClairviewPolicy<Schema>>>(
		keys: ClairviewPolicy<Schema>['id'][],
		item: Partial<ClairviewPolicy<Schema>>,
		query?: TQuery,
...
export const updatePoliciesBatch =
	<Schema, const TQuery extends Query<Schema, ClairviewPolicy<Schema>>>(
		items: NestedPartial<ClairviewPolicy<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdatePolicyOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/policies`,
