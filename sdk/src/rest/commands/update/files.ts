...
export const updateFiles =
	<Schema, const TQuery extends Query<Schema, ClairviewFile<Schema>>>(
		keys: ClairviewFile<Schema>['id'][],
		item: Partial<ClairviewFile<Schema>>,
		query?: TQuery,
...
export const updateFilesBatch =
	<Schema, const TQuery extends Query<Schema, ClairviewFile<Schema>>>(
		items: NestedPartial<ClairviewFile<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdateFileOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/files`,
...
export const updateFile =
	<Schema, const TQuery extends Query<Schema, ClairviewFile<Schema>>>(
		key: ClairviewFile<Schema>['id'],
		item: Partial<ClairviewFile<Schema>> | FormData,
		query?: TQuery,
	): RestCommand<UpdateFileOutput<Schema, TQuery>, Schema> =>
	() => {
