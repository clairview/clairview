...
export type UpdatePermissionOutput<
	...
	Item extends object = ClairviewPermission<Schema>,
...
export const updatePermissions =
	<Schema, const TQuery extends Query<Schema, ClairviewPermission<Schema>>>(
		keys: ClairviewPermission<Schema>['id'][],
		item: Partial<ClairviewPermission<Schema>>,
		query?: TQuery,
...
export const updatePermissionsBatch =
	<Schema, const TQuery extends Query<Schema, ClairviewPermission<Schema>>>(
		items: NestedPartial<ClairviewPermission<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdatePermissionOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/permissions`,
...
export const updatePermission =
	<Schema, const TQuery extends Query<Schema, ClairviewPermission<Schema>>>(
		key: ClairviewPermission<Schema>['id'],
		item: Partial<ClairviewPermission<Schema>>,
		query?: TQuery,
	): RestCommand<UpdatePermissionOutput<Schema, TQuery>, Schema> =>
	() => {
