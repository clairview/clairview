...
export type UpdateFolderOutput<
	...
	Item extends object = ClairviewFolder<Schema>,
...
export const updateFolders =
	<Schema, const TQuery extends Query<Schema, ClairviewFolder<Schema>>>(
		keys: ClairviewFolder<Schema>['id'][],
		item: Partial<ClairviewFolder<Schema>>,
		query?: TQuery,
...
export const updateFoldersBatch =
	<Schema, const TQuery extends Query<Schema, ClairviewFolder<Schema>>>(
		items: NestedPartial<ClairviewFolder<Schema>>[],
		query?: TQuery,
	): RestCommand<UpdateFolderOutput<Schema, TQuery>[], Schema> =>
	() => ({
		path: `/folders`,
