import type { ClairviewRevision } from '../../../schema/revision.js';
...
export type ReadRevisionOutput<
	...
	Item extends object = ClairviewRevision<Schema>,
...
export const readRevisions =
	<Schema, const TQuery extends Query<Schema, ClairviewRevision<Schema>>>(
		query?: TQuery,
...
export const readRevision =
	<Schema, const TQuery extends Query<Schema, ClairviewRevision<Schema>>>(
		key: ClairviewRevision<Schema>['id'],
		query?: TQuery,
	): RestCommand<ReadRevisionOutput<Schema, TQuery>, Schema> =>
	() => {
