import type { ClairviewActivity } from '../../../schema/activity.js';
...
export type ReadActivityOutput<
	...
	Item extends object = ClairviewActivity<Schema>,
...
export const readActivities =
	<Schema, const TQuery extends Query<Schema, ClairviewActivity<Schema>>>(
		query?: TQuery,
...
export const readActivity =
	<Schema, const TQuery extends Query<Schema, ClairviewActivity<Schema>>>(
		key: ClairviewActivity<Schema>['id'],
		query?: TQuery,
	): RestCommand<ReadActivityOutput<Schema, TQuery>, Schema> =>
	() => {
