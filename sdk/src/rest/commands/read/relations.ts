...
export type ReadRelationOutput<Schema> = ApplyQueryFields<Schema, ClairviewRelation<Schema>, '*'>;
...
export const readRelationByCollection =
	<Schema>(collection: ClairviewRelation<Schema>['collection']): RestCommand<ReadRelationOutput<Schema>[], Schema> =>
	() => ({
