...
/**
 * Creates a client to communicate with Clairview GraphQL.
 *
 * @returns A Clairview GraphQL client.
 */
export const graphql = (config: Partial<GraphqlConfig> = {}) => {
	return <Schema>(client: ClairviewClient<Schema>): GraphqlClient<Schema> => {
