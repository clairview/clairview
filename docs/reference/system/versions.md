---
description: REST and GraphQL API documentation on the Versions collection in Clairview.
readTime: 5 min read
...
List all Content Versions that exist in Clairview.
...
```js
import { createClairview, rest, readContentVersions } from '@clairview/sdk';
...
```graphql
type Query {
	versions_by_id(id: ID!): clairview_versions
}
```
...
```js
import { createClairview, rest, readContentVersion } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_versions_item(data: create_clairview_versions_input!): clairview_versions
}
```
...
```js
import { createClairview, rest, createContentVersion } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_versions_items(data: [create_clairview_versions_input!]!): [clairview_versions]
}
```
...
```js
import { createClairview, rest, createContentVersions } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_versions_item(id: ID!, data: update_clairview_versions_input!): clairview_versions
}
```
...
```js
import { createClairview, rest, updateContentVersion } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_versions_items(ids: [ID!]!, data: update_clairview_versions_input!): [clairview_versions]
}
```
...
```js
import { createClairview, rest, updateContentVersions } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteContentVersion } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteContentVersions } from '@clairview/sdk';
...
```js
import { createClairview, rest, saveToContentVersion } from '@clairview/sdk';
...
```js
import { createClairview, rest, saveContentVersion } from '@clairview/sdk';
...
```js
import { createClairview, rest, compareContentVersion } from '@clairview/sdk';
...
```js
import { createClairview, rest, promoteContentVersion } from '@clairview/sdk';
