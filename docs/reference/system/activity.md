---
description: REST and GraphQL API documentation on the Activity collection in Clairview.
readTime: 4 min read
...
> All events within Clairview are tracked and stored in the activities collection. This gives you full accountability
...
```js
import { createClairview, rest, readActivities } from '@clairview/sdk';
...
```graphql
type Query {
	activity_by_id(id: ID!): clairview_activity
}
```
...
```js
import { createClairview, rest, readActivity } from '@clairview/sdk';
