---
description: REST and GraphQL API documentation on using Shares in Clairview
readTime: 5 min read
...
List all shares that exist in Clairview.
...
```js
import { createClairview, rest, readShares } from '@clairview/sdk';
...
```graphql
type Query {
	shares_by_id(id: ID!): clairview_shares
}
```
...
```js
import { createClairview, rest, readShare } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_shares_item(data: create_clairview_shares_input!): clairview_shares
}
```
...
```js
import { createClairview, rest, createShare } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_shares_items(data: [create_clairview_shares_input!]!): [clairview_shares]
}
```
...
```js
import { createClairview, rest, createShares } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_shares_item(id: ID!, data: update_clairview_shares_input): clairview_shares
}
```
...
```js
import { createClairview, rest, updateShare } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_shares_items(ids: [ID!]!, data: update_clairview_shares_input): [clairview_shares]
}
```
...
```js
import { createClairview, rest, updateShares } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteShare } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteShares } from '@clairview/sdk';
...
```js
import { createClairview, rest, authenticateShare } from '@clairview/sdk';
...
```js
import { createClairview, rest, inviteShare } from '@clairview/sdk';
...
```js
import { createClairview, rest, readShareInfo } from '@clairview/sdk';
