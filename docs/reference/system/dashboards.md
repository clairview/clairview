---
description: REST and GraphQL API documentation on the Dashboards collection in Clairview.
readTime: 5 min read
...
```graphql
type Query {
	dashboards: [clairview_dashboards]
}
```
...
```js
import { createClairview, rest, readDashboards } from '@clairview/sdk';
...
```graphql
type Query {
	dashboards_by_id(id: ID!): clairview_dashboards
}
```
...
```js
import { createClairview, rest, readDashboard } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_dashboards_item(data: create_clairview_dashboards_input!): clairview_dashboards
}
```
...
```js
import { createClairview, rest, createDashboard } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_dashboards_items(data: [create_clairview_dashboards_input!]!): [clairview_dashboards]
}
```
...
```js
import { createClairview, rest, createDashboards } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_dashboards_item(id: ID!, data: update_clairview_dashboards_input): clairview_dashboards
}
```
...
```js
import { createClairview, rest, updateDashboard } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_dashboards_items(ids: [ID!]!, data: update_clairview_dashboards_input): [clairview_dashboards]
}
```
...
```js
import { createClairview, rest, updateDashboards } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteDashboard } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteDashboards } from '@clairview/sdk';
