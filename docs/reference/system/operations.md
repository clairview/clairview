---
description: REST and GraphQL API documentation on the Operations collection in Clairview.
readTime: 5 min read
...
> Operations are the building blocks of Data Flows within Clairview.
...
```graphql
type Query {
	operations: [clairview_operations]
}
```
...
```js
import { createClairview, rest, readOperations } from '@clairview/sdk';
...
```graphql
type Query {
	operations_by_id(id: ID!): clairview_operations
}
```
...
```js
import { createClairview, rest, readOperation } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_operations_item(data: create_clairview_operations_input!): clairview_operations
}
```
...
```js
import { createClairview, rest, createOperation } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_operations_items(data: [create_clairview_operations_input!]!): [clairview_operations]
}
```
...
```js
import { createClairview, rest, createOperations } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_operations_item(id: ID!, data: update_clairview_operations_input): clairview_operations
}
```
...
```js
import { createClairview, rest, updateOperation } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_operations_items(ids: [ID!]!, data: update_clairview_operations_input): [clairview_operations]
}
```
...
```js
import { createClairview, rest, updateOperations } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteOperation } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteOperations } from '@clairview/sdk';
...
```js
import { createClairview, rest, triggerOperation } from '@clairview/sdk';
