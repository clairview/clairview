---
description: REST and GraphQL API documentation on the "Collections" collection in Clairview.
readTime: 5 min read
...
Clairview metadata, primarily used in the Data Studio.
...
```graphql
type Query {
	collections: [clairview_collections]
}
```
...
```js
import { createClairview, rest, readCollections } from '@clairview/sdk';
...
```graphql
type Query {
	collections_by_name(name: String!): clairview_collections
}
```
...
```js
import { createClairview, rest, readCollection } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_collections_item(data: clairview_collections): clairview_collections
}
```
...
```js
import { createClairview, rest, createCollection } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_collections_item(collection: String!, data: update_clairview_collections_input!): clairview_collections
}
```
...
```js
import { createClairview, rest, updateCollection } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteCollection } from '@clairview/sdk';
