---
description: REST and GraphQL API documentation on the Flows collection in Clairview.
readTime: 5 min read
...
> Flows enable custom, event-driven data processing and task automation within Clairview.
...
```js
import { createClairview, rest, readFlows } from '@clairview/sdk';
...
```graphql
type Query {
	flows_by_id(id: ID!): clairview_flows
}
```
...
```js
import { createClairview, rest, readFlow } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_flows_item(data: create_clairview_flows_input!): clairview_flows
}
```
...
```js
import { createClairview, rest, createFlow } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_flows_items(data: [create_clairview_flows_input!]!): [clairview_flows]
}
```
...
```js
import { createClairview, rest, createFlows } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_flows_item(id: ID!, data: update_clairview_flows_input): clairview_flows
}
```
...
```js
import { createClairview, rest, updateFlow } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_flows_items(ids: [ID!]!, data: update_clairview_flows_input): [clairview_flows]
}
```
...
```js
import { createClairview, rest, updateFlows } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteFlow } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteFlows } from '@clairview/sdk';
...
```js
import { createClairview, rest, triggerFlow } from '@clairview/sdk';
