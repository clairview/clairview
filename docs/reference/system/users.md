---
description: REST and GraphQL API documentation on the Users collection in Clairview.
readTime: 9 min read
...
> Clairview Users are the individual accounts that let you authenticate into the API and App. Each user can belong to a
...
`language` **string**\
Language the Data Studio is rendered in. See [our Crowdin page](https://locales.clairview.io) for all available languages
and translations.
...
```js
import { createClairview, rest, readUsers } from '@clairview/sdk';
...
```graphql
type Query {
	users_by_id(id: ID!): clairview_users
}
```
...
```js
import { createClairview, rest, readUser } from '@clairview/sdk';
...
```js
import { createClairview, rest, readMe } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_users_me(data: update_clairview_users_input!): clairview_users
}
```
...
```js
import { createClairview, rest, updateMe } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_users_item(data: create_clairview_users_input!): clairview_users
}
```
...
```js
import { createClairview, rest, createUser } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_users_items(data: [create_clairview_users_input!]!): [clairview_users]
}
```
...
```js
import { createClairview, rest, createUsers } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_users_item(id: ID!, data: update_clairview_users_input!): clairview_users
}
```
...
```js
import { createClairview, rest, updateUser } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_users_items(ids: [ID!]!, data: update_clairview_users_input!): [clairview_users]
}
```
...
```js
import { createClairview, rest, updateUsers } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteUser } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteUsers } from '@clairview/sdk';
...
```js
import { createClairview, rest, verifyUserEmail } from '@clairview/sdk';
...
```js
import { createClairview, rest, inviteUser } from '@clairview/sdk';
...
```js
import { createClairview, rest, acceptUserInvite } from '@clairview/sdk';
...
```js
import { createClairview, rest, generateTwoFactorSecret } from '@clairview/sdk';
...
```js
import { createClairview, rest, enableTwoFactor } from '@clairview/sdk';
...
```js
import { createClairview, rest, disableTwoFactor } from '@clairview/sdk';
