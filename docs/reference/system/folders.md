---
description: REST and GraphQL API documentation on the Folders collection in Clairview.
readTime: 4 min read
...
List all folders that exist in Clairview.
...
```js
import { createClairview, rest, readFolders } from '@clairview/sdk';
...
```graphql
type Query {
	folders_by_id(id: ID!): clairview_folders
}
```
...
```js
import { createClairview, rest, readFolder } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_folders_item(data: create_clairview_folders_input): clairview_folders
}
```
...
```js
import { createClairview, rest, createFolder } from '@clairview/sdk';
...
```graphql
type Mutation {
	create_folders_items(data: [create_clairview_folders_input]): [clairview_folders]
}
```
...
```js
import { createClairview, rest, createFolders } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_folders_item(id: ID!, data: update_clairview_folders_input): clairview_folders
}
```
...
```js
import { createClairview, rest, updateFolder } from '@clairview/sdk';
...
```graphql
type Mutation {
	update_folders_items(ids: [ID!]!, data: update_clairview_folders_input): [clairview_folders]
}
```
...
```js
import { createClairview, rest, updateFolders } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteFolder } from '@clairview/sdk';
...
```js
import { createClairview, rest, deleteFolders } from '@clairview/sdk';
