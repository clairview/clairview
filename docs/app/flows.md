---
description:
  Flows enable custom, event-driven data processing and task automation within Clairview. Each flow is composed of one
...
![What's a Flow?](https://cdn.clairview.io/docs/v9/configuration/flows/flows/flows-20220603A/whats-a-flow-20220603A.webp)
...
- **Get data** from Clairview or another outside service.
- **Process data** a.k.a. transform it, validate it, or whatever.
- **Send data** to Clairview or another outside service.
...
<video autoplay playsinline muted loop controls title="Create a Flow">
	<source src="https://cdn.clairview.io/docs/v9/configuration/flows/flows/flows-20220603A/create-a-flow-20220603A.mp4" type="video/mp4" />
</video>
...
6. Choose a **Name**, an [operation](/app/flows/operations) type, and configure as desired.\
   Clairview will convert the name into a unique operation key, used on the [data chain](#the-data-chain).\
...
<source src="https://cdn.clairview.io/docs/v9/" type="video/mp4" />
</video>
-->
...
<video autoplay playsinline muted loop controls title="">
	<source src="https://cdn.clairview.io/docs/v9/configuration/flows/flows/" type="video/mp4" />
</video>
-->
...
<video autoplay playsinline muted loop controls title="">
	<source src="https://cdn.clairview.io/docs/v9/configuration/flows/flows/flows-20220603A/logs-20220603A.mp4" type="video/mp4" />
</video>
