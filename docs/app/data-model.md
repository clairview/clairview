...
> The Clairview data studio enables no-code configuration and management for any SQL database, with no arbitrary
...
Remember, you will have full access to manage your database using SQL. Clairview will mirror any changes. You can also
...
In order to understand how Clairview handles data models, you will need an understanding of what relational data models
...
and schemas then feel free to jump to [Data Models in Clairview](#data-models-in-clairview).

### Databases

Clairview is an SQL database wrapper. A database is a set of data stored in a computer, in a structured way, making it
organized, accessible, and scalable. The specific way you structure your data within a database is called your data
model.

![A Database Schema](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/database-schema-20220805A.webp)
...
![Data in an Excel Spreadsheet](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/spreadsheet-20220805A.webp)
...
![A data table](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/datatable-20220805A.webp)
...
![A Data Table: rows and columns](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/rows-and-columns.webp)
...
![A Column](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/columns-20220805A.webp)
...
![Cell Values](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/datatable-cell-value-20220805A.webp)
...
![Rows](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/row-20220805A.webp)
...
![Primary Key](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/primary-keys-20220805A.webp)
...
![Foreign Keys](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/foreign-keys-20220805A.webp)
...
To learn more about how these relationships work conceptually, as well as how they are handled within Clairview, see our
guide on [relationships](/app/data-model/relationships).

### Database Schemas

![Data Table to schema](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/datatable-to-schema-20220805A.webp)
...
![A Complex Schema](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/complex-schema.webp)
...
![Duplicate Data](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/duplicate-data-20220829A.webp)
...
![Database, Backend, Frontend](https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/database-backend-frontend-20220805A.webp)
...
## Data Models in Clairview

<video title="Settings > Data Model" autoplay playsinline muted loop controls>
	<source src="https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/data-model-overview-20220805A.mp4" type="video/mp4" />
</video>

All relational data model concepts listed above apply in Clairview. You get complete, un-opinionated, relational data
model design and configuration. The difference is that Clairview handles all SQL, builds the API, and provides a Data
...
Clairview replaces traditional relational database jargon with more user-friendly terms and concepts. Please keep in mind
that while traditional relational database jargon strictly encompasses database concepts, some of the new Clairview terms
encompass these relational database concepts _plus display and interaction logic_. The following sections will introduce
Clairview terms and map them to classic relational database concepts.
...
how this data is displayed and interacted with. In Clairview, fields encompass column configurations, as well as custom
configuration over how the data is displayed and interacted with in the Data Studio. Clairview also has
...
<video title="Collections" autoplay playsinline muted loop controls>
	<source src="https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/items-20220805A.mp4" type="video/mp4" />
</video>
...
Clairview abstracts type differences between SQL vendors with a
...
<video title="Keys and IDs" autoplay playsinline muted loop controls>
	<source src="https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/keys-and-ids-20220805A.mp4" type="video/mp4" />
</video>

Primary keys are called IDs in Clairview fairly frequently. When you
[create a collection](/app/data-model/collections#create-a-collection), you must add an `id` field. Clairview supports
...
<video title="Relations" autoplay playsinline muted loop controls>
	<source src="https://cdn.clairview.io/docs/v9/configuration/data-model/data-model-20220805/relationships-20220805A.mp4" type="video/mp4" />
</video>

Clairview supports all standard [types of relationships](#types-of-relationships), as well as a few more of its own
