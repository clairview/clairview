---
description:
  Operations are the individual actions in a flow. They enable you to do things like manage data within Clairview,
...
![Condition](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/condition-20220603A.webp)
...
![Create Data](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/create-data-20220603A.webp)
...
**Emit Events** toggles the event's _visibility_ throughout Clairview. For example, if toggled on, this operation will
...
![Delete Data](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/delete-data-20220603A.webp)
...
**Emit Events** toggles the event's _visibility_ throughout Clairview. For example, if togged on, this operation will
trigger relevant event hooks in other flows or custom extensions. If toggled off, the operation will not trigger other
...
![Read Data](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/read-data-20220603A.webp)
...
![Update Data](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/update-data-20220603A.webp)
...
![Log to Console](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/log-to-console-20220603A.webp)
...
![Send Email](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/send-email-20220603A.webp)
...
![Send Notification](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/send-notification-20220603A.webp)

This operation pushes notifications to Clairview Users. If the operation executes successfully, a list containing the IDs
...
![Webhook / Request URL](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/webhook-20220603A.webp)
...
![Sleep](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/sleep-20220603A.webp)
...
![Transform Payload](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/transform-payload-20220603A.webp)
...
![Trigger Flow](https://cdn.clairview.io/docs/v9/configuration/flows/operations/operations-20220603A/trigger-flow-20220603A.webp)
