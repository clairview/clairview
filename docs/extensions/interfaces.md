---
description: A guide on how to build custom Interfaces in Clairview.
readTime: 4 min read
---
...
is imported by the Clairview host.
...
The interface component is the part of your extension that will be rendered by the Clairview App whenever your interface
...
component, it should be emitted to the Clairview App by using the `input` emit.
...
Other than this simple API to communicate with the Clairview App, the interface component is a blank canvas, allowing you
