...
loading your operation, this object is imported by the Clairview App host.
...
your operation, this object is imported by the Clairview API host.
...
The extension id needs to be identical for both entrypoints in order for Clairview to recognize them as part of the same
extension.
