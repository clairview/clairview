---
description: A guide on how to build custom Display Extensions in Clairview.
readTime: 4 min read
---
...
The display component is the part of your extension that will be rendered by the Clairview App whenever your display
...
Other than this simple API to communicate with the Clairview App, the display component is a blank canvas, allowing you
