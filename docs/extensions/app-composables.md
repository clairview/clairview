...
There are several composables available as part of the Clairview Extensions SDK that make working with Clairview easier.
...
`useStores` serves as the primary way for App extensions to interact with data and features within a Clairview instance.

Within `useStores` are stores like the `usePermissionsStore`, `useCollectionsStore` and `useFieldsStore` among others.

```html
<script setup>
import { useStores } from '@clairview/extensions-sdk';
...
[see the implementation](https://github.com/clairview/clairview/blob/main/app/src/stores/fields.ts) in our codebase.
...
[see the implementation](https://github.com/clairview/clairview/blob/main/app/src/stores/permissions.ts) in our codebase.
...
- retrieve all collections or visible collections within a Clairview instance
...
[see the implementation](https://github.com/clairview/clairview/blob/main/app/src/stores/collections.ts) in our codebase.
...
[codebase](https://github.com/clairview/clairview/blob/main/app/src/composables/use-system.ts).
...
```html
<script setup>
import { useCollection } from '@clairview/extensions-sdk';
...
[see the implementation](https://github.com/clairview/clairview/blob/main/packages/composables/src/use-collection.ts) in
our codebase.
...
```html
<script setup>
import { useItems } from '@clairview/extensions-sdk';
...
[see the implementation](https://github.com/clairview/clairview/blob/main/packages/composables/src/use-items.ts) in our
codebase.
...
composables within Clairview, check out our
[GitHub repository](https://github.com/clairview/clairview/blob/main/app/src/composables/use-system.ts).
