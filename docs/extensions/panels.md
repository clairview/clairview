---
description: A guide on how to build custom Panels in Clairview.
readTime: 3 min read
---
...
The panel component is the part of your extension that will be rendered by the Clairview App whenever your panel should
