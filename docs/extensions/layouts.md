---
description: A guide on how to build custom Layouts in Clairview.
readTime: 4 min read
---
...
The layout component is the part of your extension that will be rendered by the Clairview App whenever your layout should
...
Other than this simple API to communicate with the Clairview App and the system to share state between components, the
layout component is a blank canvas, allowing you to create anything you need.

The `@clairview/extensions-sdk` package provides some useful composables to help with creating layouts:
