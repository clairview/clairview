...
![In a table, a new field called 'Test Junction' is shown. The values are '5 items' and '2 items'.](https://marketing.clairview.app/assets/c1965f6c-dfa3-461a-bda9-e3767f9d40be)
...
`clairview-display-sum-count`). For this guide, select JavaScript.
...
export default {
	id: 'clairview-display-count-sum',
...
![A new display option is shown - Related Values.](https://marketing.clairview.app/assets/128e9282-a988-4e8f-9775-ec6cfe208525)
...
the performance of Clairview.

Here is a preview of how this appears in Clairview:

![New display options showing a select field for column, a checkbox for calculate sum, and text fields for prefix and suffix.](https://marketing.clairview.app/assets/1ac7ce81-f5ae-43a7-a1a1-18590fdfa404)
...
with `clairview-extension`. In this case, you may choose to use `clairview-extension-display-sum-count`.
...
single row in the table and will impact the performance of Clairview.
