...
![A panel shows a form called Add Customer. It has a name, surname, and phone number text input.](https://marketing.clairview.app/assets/5385ebc9-e3d9-4f75-9ec8-86bd54589d56.png)
...
`clairview-panel-internal-form`). For this guide, select JavaScript.
...
<img src="https://marketing.clairview.app/assets/840bb61a-46ff-4474-a026-da5191f1272b.png" alt="Form with collections and fields selection." style="padding: 0 8px 8px 10px">
...
```js
import { useApi, useCollection, useStores } from '@clairview/extensions-sdk';
...
![A popup reads 'Saved - User Added!' with a link to the user and a but purple Done button.](https://marketing.clairview.app/assets/182dfa12-e236-41f2-97cf-ec6a983f0d7c.png)
...
with `clairview-extension`. In this case, you may choose to use `clairview-extension-panel-internal-form`.
...
<img src="https://marketing.clairview.app/assets/082d5150-fde8-4268-b79a-df444e6efe20.png" alt="Form showing a collection is selected, 3 items are included, and a response is formed as a string with two dynamic variables." style="padding: 0 0 0 10px">
