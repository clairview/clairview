...
![A table of data is shown with a value reading '22 years 10 months'](https://marketing.clairview.app/assets/7d58a582-ace9-47fe-848e-437fa29fe868)
...
`clairview-display-age`). For this guide, select JavaScript.
...
![A new display option is shown - Datetime.](https://marketing.clairview.app/assets/3cd68dc3-95ee-4eef-a3c6-17ddaca7aa09)
...
with `clairview-extension`. In this case, you may choose to use `clairview-extension-display-age`.
...
![Display age settings showing a checkbox to display months](https://marketing.clairview.app/assets/78da9218-2c6e-4356-860c-9fe713081c45)
