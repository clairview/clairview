...
![A Twilio SMS operation in a Flow](https://marketing.clairview.app/assets/c93610f0-e8a5-462c-ad53-96f1968eff7c.png)
...
<img src="https://marketing.clairview.app/assets/83e9035f-b442-407d-8fc2-3a21071f8a47.png" alt="Twilio SMS - Send SMS using the Twilio API. A chat icon is displayed in the box." style="padding: 2px 6px;">
...
<img alt="A form shows all of the defined fields above" src="https://marketing.clairview.app/assets/6e7f4099-8c2b-416f-8bc2-50ba0f55c47b.png" style="padding: 8px 12px;">
...
<img src="https://marketing.clairview.app/assets/0deacbbe-11d6-47a2-9705-a02757e3cf57.png" alt="The flow overview card shows a phone number and message." style="max-width: 400px;"/>
...
The handler needs to include the fields from the `app.js` options and the environment variables from Clairview. Replace
...
with `clairview-extension`. In this case, you may choose to use `clairview-extension-operation-twilio-sms`.
...
In the Clairview Data Studio, open the Flows section in Settings. Create a new flow with an event trigger. Select the
...
<img alt="The full form is filled with values." src="https://marketing.clairview.app/assets/80f25a8c-206d-46b3-862f-54c8bb54f7e7.png" style="padding: 8px;">
