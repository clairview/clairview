...
content creation process. This is common when using Clairview as a
...
![A Workflow](https://cdn.clairview.io/docs/v9/configuration/users-roles-permissions/workflows-20220909/workflows-20220909B.webp)
...
![A Workflow](https://cdn.clairview.io/docs/v9/configuration/users-roles-permissions/workflows-20220909/workflows-20220909A.webp)
...
- An understanding of [permissions](/user-guide/user-management/users-roles-permissions) and
  [filters](/reference/filter-rules) in Clairview.
