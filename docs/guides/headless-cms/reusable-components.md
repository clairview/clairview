---
description: This guide shows you how to build re-usable page components using Clairview Many-to-Any (M2A) relationships.
...
A common use case when using Clairview as a Headless CMS is creating individual blocks that can be re-used on many
different pages.
...
You’ll need to have either a Clairview Cloud project configured and running or a self-hosted instance of Clairview up and
running.
...
Before creating Collections inside Clairview, it’s helpful to map out your data model (schema).

Consider this sample page below.

![Website wireframe that shows three different sections. A hero block with a headline and image, a group of content cards, and a block of rich text.](https://cdn.clairview.io/docs/v9/headless-cms/how-to-packet-20220222A/sample-page.webp)
...
![Simple wireframe of a hero section on a sample website.](https://cdn.clairview.io/docs/v9/headless-cms/how-to-packet-20220222A/block-hero.webp)
...
![Simple wireframe of a group of content cards on a sample website.](https://cdn.clairview.io/docs/v9/headless-cms/how-to-packet-20220222A/block-cardgroup.webp)
...
![Simple wireframe of a block of rich text on a sample website.](https://cdn.clairview.io/docs/v9/headless-cms/how-to-packet-20220222A/block-richtext.webp)
...
Now let's create a Collection for each inside Clairview.
...
5. Create a new Builder (M2A) field inside the `pages` data model.
   ...
   d. Save the field. Clairview will create a new, hidden
...
6. [Create a new item](/user-guide/content-module/content/items#create-an-item) in the `pages` collection
   ...
   <source src="https://cdn.clairview.io/docs/v9/headless-cms/how-to-packet-20220222A/reusable-page-components-adding-content.mp4"> type="video/mp4" />
   </video>
...
const pages = await clairview.request(
	readItems('pages', {
		filter: {
			slug: { _eq: slug },
		},
...
We have [integration guides](https://clairview.io/guides/) for many popular front-end frameworks. But there are far too
...
Clairview returns for Many To Any (M2A) relationships.

- Complete your page builder data model inside Clairview.
- Add some content.
- Test your API calls.
...
![In the data model settings, a folder is highlighted. It is named blocks. There is a caption that reads "Data Model Folders help you keep collections well-organized and easy to find."](https://cdn.clairview.io/docs/v9/headless-cms/how-to-packet-20220222A/reusable-page-components-folders.webp)
...
![In the data model settings for the hero collection a section is highlighted. It reads "Collection naming translations" with a single item called "Hero".](https://cdn.clairview.io/docs/v9/headless-cms/how-to-packet-20220222A/reusable-page-components-translations.webp)
