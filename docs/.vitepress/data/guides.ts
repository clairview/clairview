...
export const sections = {
	...
	frameworks: {
		...
		summary: 'Combine Clairview with your favorite framework to create dynamic and efficient web applications.',
		cols: 2,
		blocks: [
			{
				title: 'Next.js',
			...
			},
			{
				title: 'From the Blog',
				items: [
					{ display: 'Get Started with SvelteKit', path: '/blog/getting-started-clairview-sveltekit' },
					{ display: 'Get Started with Astro', path: '/blog/getting-started-clairview-astro' },
					{ display: 'Get Started with Remix', path: '/blog/getting-started-with-clairview-and-remix' },
					{ display: 'Get Started with Eleventy', path: '/blog/getting-started-clairview-and-eleventy-11ty-3' },
					{ display: 'Get Started with SolidStart', path: '/blog/getting-started-solidstart' },
					{ display: 'Get Started with Gatsby', path: '/blog/getting-started-with-clairview-and-gatsby' },
				],
			},
		],
	},
	'use-cases': {
		...
		summary: 'Use Clairview features to build various use cases in one project.',
		cols: 1,
		blocks: [
			{
				title: 'Headless CMS',
				...
				items: [
					{
						...
						path: '/blog/clairview-seo-tips-tricks',
					},
				],
			},
		],
	...
	extensions: {
		...
		summary: 'Learn how to extend Clairview with various custom extension types.',
		cols: 2,
		blocks: [
			{
				title: 'Displays',
	...
	administration: {
		...
		summary: 'Learn key skills needed to successfully administer Clairview in a real-world context.',
		cols: 1,
		blocks: [
			{
				title: 'Migrations',
