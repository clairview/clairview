...
export async function seed(knex) {
	...
	await knex('clairview_roles').where('id', 'd70c0943-5b55-4c5d-a613-f539a27a57f5').del();

	await knex('clairview_roles').insert([
		{
	...
	await knex('clairview_users').where('id', '3d075128-c073-4f5d-891c-ed2eb2790a1c').del();

	await knex('clairview_users').insert([
		{
