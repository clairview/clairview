...
import { AutocompleteCompletionItem, HogLanguage, TorQLAutocomplete, NodeKind } from '~/queries/schema'
...
export const torQLAutocompleteProvider = (type: HogLanguage): languages.CompletionItemProvider => ({
    triggerCharacters: [' ', ',', '.', '{'],
    provideCompletionItems: async (model, position) => {
        ...
        const response = await performQuery<TorQLAutocomplete>(query)
