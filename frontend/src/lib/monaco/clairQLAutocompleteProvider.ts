...
import { AutocompleteCompletionItem, HogLanguage, ClairQLAutocomplete, NodeKind } from '~/queries/schema'
...
export const clairQLAutocompleteProvider = (type: HogLanguage): languages.CompletionItemProvider => ({
    triggerCharacters: [' ', ',', '.', '{'],
    provideCompletionItems: async (model, position) => {
        ...
        const query: ClairQLAutocomplete = {
        ...
        const response = await performQuery<ClairQLAutocomplete>(query)
