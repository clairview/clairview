...
import EXAMPLE_DATA_TABLE_NODE_CLAIRQL_QUERY from '../../../../mocks/fixtures/api/projects/team_id/insights/dataTableClairQL.json'
...
const examples = [
    ...
    EXAMPLE_STICKINESS,
    EXAMPLE_LIFECYCLE,
    EXAMPLE_DATA_TABLE_NODE_CLAIRQL_QUERY,
