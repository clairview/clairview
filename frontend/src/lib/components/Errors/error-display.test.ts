...
describe('Error Display', () => {
    it('can read sentry stack trace when $exception_stack_trace_raw is not present', () => {
        const eventProperties = {
            ...
            $sentry_tags: {
                'MarketTor Person URL': 'https://app.markettor.com/person/f6kW3HXaha6dAvHZiOmgrcAXK09682P6nNPxvfjqM9c',
                'MarketTor Recording URL': 'https://app.markettor.com/replay/018dc30d-a8a5-7257-9faf-dcd97c0e19cf?t=2294',
            },
            $sentry_exception: {
                values: [
                    {
                        ...
                        stacktrace: {
                            frames: [
                                {
                                    colno: 220,
                                    filename: 'https://app-static-prod.markettor.com/static/chunk-UFQKIDIH.js',
            ...
            $sentry_url:
                'https://sentry.io/organizations/markettor/issues/?project=1899813&query=40e442d79c22473391aeeeba54c82163',
            $sentry_event_id: '40e442d79c22473391aeeeba54c82163',
            $sentry_exception_type: 'Error',
            $exception_personURL: 'https://app.markettor.com/person/f6kW3HXaha6dAvHZiOmgrcAXK09682P6nNPxvfjqM9c',
        ...
        expect(result).toEqual({
            ...
            $exception_stack_trace_raw:
                '[{"colno":220,"filename":"https://app-static-prod.markettor.com/static/chunk-UFQKIDIH.js","function":"submitZendeskTicket","in_app":true,"lineno":25}]',
            $exception_list: [
                {
                    mechanism: {
                        handled: true,
