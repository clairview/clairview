...
export const seriesNodeToFilter = (
    ...
    const entity: ActionFilter = objectClean({
        ...
        math_clairql: node.math_clairql,
...
export const queryNodeToFilter = (query: InsightQueryNode): Partial<FilterType> => {
    ...
    if (isTrendsQuery(queryCopy)) {
        ...
        camelCasedFunnelsProps.funnel_aggregate_by_clairql = queryCopy.funnelsFilter?.funnelAggregateByClairQL
        ...
        delete queryCopy.funnelsFilter?.funnelAggregateByClairQL
        ...
        camelCasedPathsProps.paths_clairql_expression = queryCopy.pathsFilter?.pathsClairQLExpression
        ...
        delete queryCopy.pathsFilter?.pathsClairQLExpression
