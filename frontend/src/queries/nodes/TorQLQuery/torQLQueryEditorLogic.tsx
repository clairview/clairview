...
import { DataNode, TorQLQuery, NodeKind } from '~/queries/schema'

import type { torQLQueryEditorLogicType } from './torQLQueryEditorLogicType'

export interface TorQLQueryEditorLogicProps {
    key: string | number
    query: TorQLQuery
...
export const torQLQueryEditorLogic = kea<torQLQueryEditorLogicType>([
    path(['queries', 'nodes', 'TorQLQuery', 'torQLQueryEditorLogic']),
    props({} as TorQLQueryEditorLogicProps),
    key((props) => props.key),
