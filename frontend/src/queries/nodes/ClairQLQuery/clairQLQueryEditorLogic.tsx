...
import { DataNode, ClairQLQuery, NodeKind } from '~/queries/schema'

import type { clairQLQueryEditorLogicType } from './clairQLQueryEditorLogicType'

export interface ClairQLQueryEditorLogicProps {
    key: string | number
    query: ClairQLQuery
...
export const clairQLQueryEditorLogic = kea<clairQLQueryEditorLogicType>([
    path(['queries', 'nodes', 'ClairQLQuery', 'clairQLQueryEditorLogic']),
    props({} as ClairQLQueryEditorLogicProps),
    key((props) => props.key),
