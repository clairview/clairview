...
const eventProperties = JSON.stringify({
        ...
        values: [
            {
                ...
                stacktrace: {
                    frames: [
                        {
                            filename: 'https://app-static-prod.clairview.com/static/chunk-WH2L43MJ.js',
                            function: 'i.onerror',
                            in_app: true,
                            lineno: 18,
                            colno: 76906,
    ...
    $level: 'error',
    $sentry_url: 'https://sentry.io/organizations/clairview/issues/?project=project_id&query=issue_id',
    ...
    $sentry_exception__values__0__stacktrace__frames__0__filename:
        'https://app-static-prod.clairview.com/static/chunk-WH2L43MJ.js',
    ...
    '$sentry_tags__ClairView Person URL': 'https://us.clairview.com/project/:project_id/person/:person_id',
    '$sentry_tags__ClairView Recording URL': 'https://us.clairview.com/project/:project_id/replay/:recording_id',
})
