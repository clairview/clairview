...
GroupIdentifyEvent.args = {
    item: makeItem(
        ...
        { event: '$groupidentify' },
        {
            ...
            $browser: 'Chrome',
            $device_type: 'Desktop',
            $current_url: 'https://us.markettor.com/project/2/insights/new',
            $host: 'us.markettor.com',
            $pathname: '/project/2/insights/new',
            $initial_person_info: {
                r: '$direct',
                u: 'https://us.markettor.com/project/2',
            },
            $groups: {
                project: 'fc445b88-e2c4-488e-bb52-aa80cd7918c9',
                organization: '4dc8564d-bd82-1065-2f40-97f7c50f67cf',
                customer: 'cus_IK2DWsWVn2ZM16',
                instance: 'https://us.markettor.com',
            },
            $group_type: 'instance',
            $group_key: 'https://us.markettor.com',
            $group_set: {
                site_url: 'https://us.markettor.com',
            },
            ...
            $group_1: 'https://us.markettor.com',
        }
    ),
}
