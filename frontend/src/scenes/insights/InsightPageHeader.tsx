...
import { isDataTableNode, isDataVisualizationNode, isEventsQuery, isClairQLQuery } from '~/queries/utils'
import {
    ExporterFormat,
    InsightLogicProps,
    InsightShortId,
...
export function InsightPageHeader({ insightLogicProps }: { insightLogicProps: InsightLogicProps }): JSX.Element {
    ...
    // insightDataLogic
    const { query, queryChanged, showQueryEditor, showDebugPanel, clairQL, exportContext } = useValues(
    ...
    const showCohortButton =
        isDataTableNode(query) || isDataVisualizationNode(query) || isClairQLQuery(query) || isEventsQuery(query)
