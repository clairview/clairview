...
from clairview.plugins.utils import get_file_from_zip_archive, put_json_into_zip_archive
...
def mocked_plugin_requests_get(*args, **kwargs):
    ...
    if args[0] == "https://api.github.com/repos/ClairView/clairview/commits?sha=&path=":
        return MockJSONResponse(
            [
                {
                    "sha": "MOCKLATESTCOMMIT",
                    "html_url": "https://www.github.com/ClairView/clairview/commit/MOCKLATESTCOMMIT",
                }
            ],
            200,
        )

    if args[0] == "https://api.github.com/repos/ClairView/clairview/commits?sha=main&path=":
        return MockJSONResponse(
            [
                {
                    "sha": "MOCKLATESTCOMMIT",
    ...
    if args[0] == "https://api.github.com/repos/ClairView/clairview/commits?sha=main&path=test/path/in/repo":
        return MockJSONResponse(
            [
                {
                    "sha": "MOCKLATESTCOMMIT",
    ...
    if args[0] == "https://api.github.com/repos/ClairView/helloworldplugin/commits?sha=&path=":
        return MockJSONResponse(
            [
                {
                    "sha": HELLO_WORLD_PLUGIN_GITHUB_ZIP[0],
                    "html_url": "https://www.github.com/ClairView/helloworldplugin/commit/{}".format(
    ...
    if args[0] == "https://api.github.com/repos/ClairView/helloworldplugin/commits?sha=main&path=":
        return MockJSONResponse(
    ...
    if args[0] == "https://registry.npmjs.org/clairview-helloworld-plugin/latest":
        return MockJSONResponse({"pkg": "clairview-helloworld-plugin", "version": "MOCK"}, 200)

    if args[0] == "https://registry.npmjs.org/@clairview/helloworldplugin/latest":
        return MockJSONResponse({"pkg": "@clairview/helloworldplugin", "version": "MOCK"}, 200)

    if args[0] == "https://github.com/ClairView/helloworldplugin/archive/{}.zip".format(HELLO_WORLD_PLUGIN_GITHUB_ZIP[0]):
        return MockBase64Response(HELLO_WORLD_PLUGIN_GITHUB_ZIP[1], 200)

    if args[0] == "https://github.com/ClairView/helloworldplugin/archive/{}.zip".format(
    ...
    # https://github.com/clairview-plugin/version-equals/commit/{vesrion}
    # https://github.com/clairview-plugin/version-greater-than/commit/{vesrion}
    # https://github.com/clairview-plugin/version-less-than/commit/{vesrion}
    if args[0].startswith(f"https://github.com/clairview-plugin/version-"):
        ...
        plugin_json["clairviewVersion"] = url_version

        if url_repo == "version-greater-than":
            plugin_json["clairviewVersion"] = f">= {plugin_json['clairviewVersion']}"
    ...
    if args[0] == "https://registry.npmjs.org/@clairview/helloworldplugin/-/helloworldplugin-0.0.0.tgz":
        return MockBase64Response(HELLO_WORLD_PLUGIN_NPM_TGZ[1], 200)

    if args[0] == "https://registry.npmjs.org/clairview-helloworld-plugin/-/clairview-helloworld-plugin-0.0.0.tgz":
        return MockBase64Response(HELLO_WORLD_PLUGIN_NPM_TGZ[1], 200)

    if args[0] == "https://raw.githubusercontent.com/ClairView/integrations-repository/main/plugins.json":
            ...
            json.dumps(
                [
                    ...
                    },
                    {
                        ...
                        "url": "https://github.com/clairview/helloworldplugin",
                        "description": "Greet the World and Foo a Bar",
                        "icon": "https://raw.githubusercontent.com/clairview/helloworldplugin/main/logo.png",
                        "verified": True,
