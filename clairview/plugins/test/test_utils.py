...
from clairview.plugins.utils import (
...
class TestPluginsUtils(BaseTest):
    def test_parse_github_urls(self, mock_get):
        parsed_url = parse_url("https://github.com/ClairView/clairview")
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        self.assertEqual(parsed_url.get("tag", None), None)
        self.assertEqual(parsed_url.get("path", None), None)
        self.assertEqual(mock_get.call_count, 0)
        mock_get.reset_mock()

        parsed_url = parse_url("https://github.com/ClairView/clairview", get_latest_if_none=True)
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        ...
        mock_get.assert_called_with(
            "https://api.github.com/repos/ClairView/clairview/commits?sha=&path=",
            headers={},
        )
        mock_get.reset_mock()

        parsed_url = parse_url("https://github.com/ClairView/clairview/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e")
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        ...
        parsed_url = parse_url(
            "https://github.com/ClairView/clairview/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e",
        ...
        parsed_url = parse_url(
            "https://github.com/ClairView/clairview/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e/test/path/in/repo",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        ...
        parsed_url = parse_url("https://github.com/ClairView/clairview/tree/main", get_latest_if_none=True)
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        self.assertEqual(parsed_url["tag"], "MOCKLATESTCOMMIT")
        ...
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://api.github.com/repos/ClairView/clairview/commits?sha=main&path=",
            headers={},
        )
        mock_get.reset_mock()

        parsed_url = parse_url(
            "https://github.com/ClairView/clairview/tree/main/test/path/in/repo",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        ...
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://api.github.com/repos/ClairView/clairview/commits?sha=main&path=test/path/in/repo",
            headers={},
        )
        mock_get.reset_mock()

        parsed_url = parse_url("https://www.github.com/ClairView/clairview/commit/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e")
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        self.assertEqual(parsed_url["tag"], "82c9218ee40f561b7f37a22d6b6a0ca82887ee3e")
        ...
        parsed_url = parse_url(
            "https://www.github.com/ClairView/clairview/commit/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        ...
        parsed_url = parse_url(
            "https://github.com/ClairView/clairview/releases/tag/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        ...
        parsed_url = parse_url(
            "https://www.github.com/ClairView/clairview/archive/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e.zip"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        ...
        parsed_url = parse_url(
            "https://github.com/ClairView/clairview/archive/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e.tar.gz"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        ...
        # private tokens
        parsed_url = parse_url("https://github.com/ClairView/clairview?private_token=TOKEN")
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
        self.assertEqual(parsed_url.get("tag", None), None)
        ...
        parsed_url = parse_url(
            "https://github.com/ClairView/clairview?private_token=TOKEN",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        ...
        parsed_url = parse_url(
            "https://github.com/ClairView/clairview/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e?private_token=TOKEN"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "ClairView")
        self.assertEqual(parsed_url["repo"], "clairview")
    ...
    def test_parse_npm_urls(self, mock_get):
        parsed_url = parse_url("https://www.npmjs.com/package/clairview-helloworld-plugin")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "clairview-helloworld-plugin")
        self.assertEqual(parsed_url.get("tag", None), None)
        self.assertEqual(mock_get.call_count, 0)

        parsed_url = parse_url("https://www.npmjs.com/package/@clairview/helloworldplugin")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "@clairview/helloworldplugin")
        self.assertEqual(parsed_url.get("tag", None), None)
        self.assertEqual(mock_get.call_count, 0)

        parsed_url = parse_url(
            "https://www.npmjs.com/package/clairview-helloworld-plugin",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "clairview-helloworld-plugin")
        ...
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with("https://registry.npmjs.org/clairview-helloworld-plugin/latest", headers={})

        parsed_url = parse_url(
            "https://www.npmjs.com/package/@clairview/helloworldplugin",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "@clairview/helloworldplugin")
        self.assertEqual(parsed_url["tag"], "MOCK")
        self.assertEqual(mock_get.call_count, 2)
        mock_get.assert_called_with("https://registry.npmjs.org/@clairview/helloworldplugin/latest", headers={})

        parsed_url = parse_url("https://www.npmjs.com/package/clairview-helloworld-plugin/v/0.0.0")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "clairview-helloworld-plugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        self.assertEqual(mock_get.call_count, 2)

        parsed_url = parse_url("https://www.npmjs.com/package/@clairview/helloworldplugin/v/0.0.0")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "@clairview/helloworldplugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        self.assertEqual(mock_get.call_count, 2)
        ...
        parsed_url = parse_url(
            "https://www.npmjs.com/package/clairview-helloworld-plugin/v/0.0.0",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "clairview-helloworld-plugin")
        ...
        # private tokens
        parsed_url = parse_url(
            "https://www.npmjs.com/package/clairview-helloworld-plugin?private_token=TOKEN",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "clairview-helloworld-plugin")
        ...
        self.assertEqual(mock_get.call_count, 3)
        mock_get.assert_called_with(
            "https://registry.npmjs.org/clairview-helloworld-plugin/latest",
            headers={"Authorization": "Bearer TOKEN"},
        )

        parsed_url = parse_url("https://www.npmjs.com/package/clairview-helloworld-plugin/v/0.0.0?private_token=TOKEN")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "clairview-helloworld-plugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        self.assertEqual(parsed_url["private_token"], "TOKEN")
        ...
        parsed_url = parse_url("https://www.npmjs.com/package/@clairview/helloworldplugin/v/0.0.0?private_token=TOKEN")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "@clairview/helloworldplugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        self.assertEqual(parsed_url["private_token"], "TOKEN")
    ...
    def test_download_plugin_archive_github(self, mock_get):
        plugin_github_zip_1 = download_plugin_archive(
            "https://www.github.com/ClairView/helloworldplugin/commit/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e",
            HELLO_WORLD_PLUGIN_GITHUB_ZIP[0],
        )
        self.assertEqual(plugin_github_zip_1, base64.b64decode(HELLO_WORLD_PLUGIN_GITHUB_ZIP[1]))
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://github.com/ClairView/helloworldplugin/archive/d5aa1d2b8a534f37cd93be48b214f490ef9ee904.zip",
            headers={},
        )

        plugin_github_zip_2 = download_plugin_archive(
            "https://www.github.com/ClairView/helloworldplugin/commit/{}".format(HELLO_WORLD_PLUGIN_GITHUB_ZIP[0])
        )
        ...
        plugin_github_zip_3 = download_plugin_archive(
            "https://www.github.com/ClairView/helloworldplugin/commit/{}?private_token=TOKEN".format(
                HELLO_WORLD_PLUGIN_GITHUB_ZIP[0]
            )
        )
        ...
        plugin_github_zip_6 = download_plugin_archive(
            "https://www.github.com/ClairView/helloworldplugin/tree/main/app",
        ...
        mock_get.assert_called_with(
            "https://github.com/ClairView/helloworldplugin/archive/f5a9ea85adaafe7c99014b7e8e0982c447631d54.zip",
            headers={},
        )
        self.assertEqual(
    ...
    def test_download_plugin_archive_npm(self, mock_get):
        plugin_npm_tgz = download_plugin_archive("https://www.npmjs.com/package/clairview-helloworld-plugin/v/0.0.0")
        self.assertEqual(plugin_npm_tgz, base64.b64decode(HELLO_WORLD_PLUGIN_NPM_TGZ[1]))
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://registry.npmjs.org/clairview-helloworld-plugin/-/clairview-helloworld-plugin-0.0.0.tgz",
            headers={},
        )

        plugin_npm_tgz = download_plugin_archive(
            "https://www.npmjs.com/package/@clairview/helloworldplugin/v/0.0.0?private_token=TOKEN"
        )
        self.assertEqual(plugin_npm_tgz, base64.b64decode(HELLO_WORLD_PLUGIN_NPM_TGZ[1]))
        self.assertEqual(mock_get.call_count, 2)
        mock_get.assert_called_with(
            "https://registry.npmjs.org/@clairview/helloworldplugin/-/helloworldplugin-0.0.0.tgz",
            headers={"Authorization": "Bearer TOKEN"},
        )
        ...
        with self.settings(NPM_TOKEN="MY_NPM_TOKEN"):
            ...
            plugin_npm_tgz = download_plugin_archive("https://www.npmjs.com/package/@clairview/helloworldplugin/v/0.0.0")
            self.assertEqual(plugin_npm_tgz, base64.b64decode(HELLO_WORLD_PLUGIN_NPM_TGZ[1]))
            self.assertEqual(mock_get.call_count, 4)
            mock_get.assert_called_with(
                "https://registry.npmjs.org/@clairview/helloworldplugin/-/helloworldplugin-0.0.0.tgz",
    ...
    def test_get_file_from_archive(self, mock_get):
        ...
        self.assertEqual(plugin_json_zip["url"], "https://github.com/ClairView/helloworldplugin")
        ...
        self.assertEqual(plugin_json_tgz["url"], "https://github.com/ClairView/helloworldplugin")
    ...
    def test_put_json_into_zip_archive(self, mock_get):
        ...
        plugin_json["clairviewVersion"] = "0.0.0"
        ...
        self.assertEqual(new_plugin_json["clairviewVersion"], "0.0.0")
        ...
        self.assertEqual(new_plugin_json_2["clairviewVersion"], "0.0.0")
