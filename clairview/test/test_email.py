...
from clairview.email import EmailMessage, _send_email
from clairview.models import MessagingRecord, Organization, Person, Team, User
...
class TestEmail(BaseTest):
    ...
    def setUp(self):
        ...
        self.user2 = User.objects.create(email="test2@clairview.com")
        self.user_red_herring = User.objects.create(email="test+redherring@clairview.com")
        ...
        MessagingRecord.objects.get_or_create(
            raw_email="test+redherring@clairview.com",
    ...
    def test_cant_send_same_campaign_twice(self) -> None:
        with override_instance_config("EMAIL_HOST", "localhost"):
            ...
            record, _ = MessagingRecord.objects.get_or_create(raw_email="test0@clairview.com", campaign_key="campaign_1")
            ...
            with self.settings(CELERY_TASK_ALWAYS_EAGER=True):
                _send_email(
                    ...
                    to=[
                        {
                            "raw_email": "test0@clairview.com",
                            "recipient": "Test ClairView <test0@clairview.com>",
                        }
                    ],
                    subject="Test email",
                    headers={},
    ...
    def test_applies_default_utm_tags(self) -> None:
        with override_instance_config("EMAIL_HOST", "localhost"):
            ...
            assert (
                f"https://clairview.com/questions?utm_source=clairview&amp;utm_medium=email&amp;utm_campaign={template}"
