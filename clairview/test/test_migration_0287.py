from clairview.test.base import NonAtomicTestMigrations
...
class CreatingSessionRecordingModelMigrationTestCase(NonAtomicTestMigrations):
    ...
    def setUpBeforeMigration(self, apps):
        Organization = apps.get_model("clairview", "Organization")
        Team = apps.get_model("clairview", "Team")
        SessionRecordingPlaylist = apps.get_model("clairview", "SessionRecordingPlaylist")
        SessionRecordingPlaylistItem = apps.get_model("clairview", "SessionRecordingPlaylistItem")
    ...
    def test_migrate_to_create_session_recordings(self):
        SessionRecording = self.apps.get_model("clairview", "SessionRecording")  # type: ignore
        SessionRecordingPlaylist = self.apps.get_model("clairview", "SessionRecordingPlaylist")  # type: ignore
        SessionRecordingPlaylistItem = self.apps.get_model("clairview", "SessionRecordingPlaylistItem")  # type: ignore
    ...
    def tearDown(self):
        Organization = self.apps.get_model("clairview", "Organization")  # type: ignore
        Team = self.apps.get_model("clairview", "Team")  # type: ignore
        SessionRecording = self.apps.get_model("clairview", "SessionRecording")  # type: ignore
        SessionRecordingPlaylistItem = self.apps.get_model("clairview", "SessionRecordingPlaylistItem")  # type: ignore
        SessionRecordingPlaylist = self.apps.get_model("clairview", "SessionRecordingPlaylist")  # type: ignore
