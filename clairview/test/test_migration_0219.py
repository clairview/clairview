...
from clairview.test.base import TestMigrations
...
class TagsTestCase(TestMigrations):
    ...
    def setUpBeforeMigration(self, apps):
        Dashboard = apps.get_model("clairview", "Dashboard")
        Insight = apps.get_model("clairview", "Insight")
    ...
    def test_tags_migrated(self):
        Tag = self.apps.get_model("clairview", "Tag")  # type: ignore
        TaggedItem = self.apps.get_model("clairview", "TaggedItem")  # type: ignore
        Dashboard = self.apps.get_model("clairview", "Dashboard")  # type: ignore
        Insight = self.apps.get_model("clairview", "Insight")  # type: ignore
