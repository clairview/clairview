...
from clairview.models.activity_logging.activity_log import ActivityLog
from clairview.models.organization import Organization
from clairview.models.plugin import Plugin, PluginConfig, PluginStorage
...
class MarkInactiveExportsAsFinished(TestCase):
    ...
    with the addition of a squashed migration from clairview 0001 to 0284, as the
    ...
    def test_migration(self):
        ...
        migration = importlib.import_module("clairview.migrations.0273_mark_inactive_exports_as_finished")
