...
CONSTANCE_DATABASE_PREFIX = "constance:clairview:"
...
CONSTANCE_CONFIG = {
    ...
    "SENTRY_AUTH_TOKEN": (
        ...
        "Used to enable Sentry error tracking in ClairView",
        str,
    ),
    "SENTRY_ORGANIZATION": (
    ...
    "REDIRECT_APP_TO_US": (
        ...
        "Temporary option to redirect all app traffic from app.clairview.com to us.clairview.com.",
        bool,
    ),
}
