...
from clairview.settings.base_variables import DEBUG, STATIC_COLLECTION, TEST
    ...
    if not TRUST_ALL_PROXIES and not TRUSTED_PROXIES:
        logger.warning(
            """
                ...
                https://clairview.com/docs/configuring-clairview/running-behind-proxy for details.
            """
        )
