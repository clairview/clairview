...
from clairview.demo.matrix.models import Effect, SimPerson, SimSessionIntent, EVENT_AUTOCAPTURE
...
if TYPE_CHECKING:
    from clairview.demo.products.hedgebox.matrix import HedgeboxCluster
