...
from clairview.health import is_clickhouse_connected, is_kafka_connected
from clairview.models import Organization, User
from clairview.models.integration import SlackIntegration
...
def security_txt(request):
    SECURITY_TXT_CONTENT = """
        Contact: mailto:engineering@clairview.com
        Hiring: https://clairview.com/careers
