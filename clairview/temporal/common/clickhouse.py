...
from clairview.temporal.common.asyncpa import AsyncRecordBatchReader
...
class ClickHouseClient:
    ...
    @classmethod
    def from_clairview_settings(cls, session, settings, **kwargs):
        """Initialize a ClickHouseClient from ClairView settings."""
        return cls(
            session=session,
