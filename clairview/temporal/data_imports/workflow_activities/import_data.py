...
from clairview.temporal.common.heartbeat import Heartbeater
from clairview.temporal.data_imports.pipelines.helpers import aremove_reset_pipeline, aupdate_job_count

from clairview.temporal.data_imports.pipelines.pipeline import DataImportPipeline, PipelineInputs
from clairview.warehouse.models import (
    ExternalDataJob,
    ExternalDataSource,
    get_external_data_job,
)
from clairview.temporal.common.logger import bind_temporal_worker_logger
from structlog.typing import FilteringBoundLogger
from clairview.warehouse.models.external_data_schema import ExternalDataSchema, aget_schema_by_id
from clairview.warehouse.models.ssh_tunnel import SSHTunnel
...
async def import_data_activity(inputs: ImportDataActivityInputs):
    async with Heartbeater(factor=30):  # Every 10 secs
        ...
        if model.pipeline.source_type == ExternalDataSource.Type.STRIPE:
            from clairview.temporal.data_imports.pipelines.stripe import stripe_source
            ...
            from clairview.temporal.data_imports.pipelines.hubspot.auth import hubspot_refresh_access_token
            from clairview.temporal.data_imports.pipelines.hubspot import hubspot
            ...
            from clairview.temporal.data_imports.pipelines.sql_database import sql_source_for_type
            ...
            from clairview.temporal.data_imports.pipelines.sql_database import snowflake_source
            ...
            from clairview.temporal.data_imports.pipelines.salesforce.auth import salesforce_refresh_access_token
            from clairview.temporal.data_imports.pipelines.salesforce import salesforce_source
            from clairview.models.integration import aget_integration_by_id
            ...
            from clairview.temporal.data_imports.pipelines.zendesk import zendesk_source
            ...
            from clairview.temporal.data_imports.pipelines.vitally import vitally_source
            ...
            # from clairview.temporal.data_imports.pipelines.bigquery import bigquery_source
            from clairview.temporal.data_imports.pipelines.sql_database import bigquery_source
