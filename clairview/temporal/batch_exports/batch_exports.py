...
from clairview.batch_exports.models import BatchExportBackfill, BatchExportRun
...
from clairview.temporal.common.client import connect
...
async def finish_batch_export_run(inputs: FinishBatchExportRunInputs) -> None:
    ...
    if batch_export_run.status == BatchExportRun.Status.FAILED_RETRYABLE:
        ...
        from clairview.tasks.email import send_batch_export_run_failure
