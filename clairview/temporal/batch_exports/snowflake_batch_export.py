...
from clairview.temporal.batch_exports.utils import (
    JsonType,
...
from clairview.temporal.common.utils import (
...
class SnowflakeClient:
    ...
    async def acreate_table(self, table_name: str, fields: list[SnowflakeField]) -> None:
        ...
        await self.execute_async_query(
            ...
            COMMENT = 'ClairView generated events table'
            """,
        )
...
class SnowflakeBatchExportWorkflow(ClairViewWorkflow):
