...
from clairview.temporal.data_imports.external_data_job import ExternalDataJobWorkflow
from clairview.temporal.utils import ExternalDataWorkflowInputs
from clairview.warehouse.models.external_table_definitions import external_tables
...
from clairview.warehouse.models.external_data_job import get_latest_run_if_exists
...
async def test_zendesk_brands(team, zendesk_brands):
    await _run(
        ...
        job_inputs={
            ...
            "zendesk_email_address": "test@clairview.com",
        },
...
async def test_make_sure_deletions_occur(team, stripe_balance_transaction):
    ...
    with mock.patch("clairview.warehouse.models.external_data_job.get_s3_client") as mock_s3_client:
...
async def test_billing_limits(team, stripe_customer):
    ...
    with mock.patch(
        "clairview.temporal.data_imports.workflow_activities.check_billing_limits.list_limited_team_attributes",
