...
from clairview.clickhouse.client.connection import Workload, get_pool
from clairview.clickhouse.client.escape import substitute_params
from clairview.clickhouse.query_tagging import get_query_tag_value, get_query_tags
from clairview.errors import wrap_query_error
from clairview.settings import TEST
from clairview.utils import generate_short_id, patchable
...
def sync_execute(
    ...
    *,
    ...
    if get_query_tag_value("id") == "clairview.tasks.tasks.process_query_task":
