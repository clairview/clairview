...
from clairview.test.base import BaseTest, ClickhouseDestroyTablesMixin, _create_event
from clairview.client import sync_execute
from clairview.models.utils import UUIDT

module = importlib.import_module("clairview.clickhouse.migrations.0064_materialize_elements_chain")

add_columns_to_required_tables = module.add_columns_to_required_tables

from clairview.models.element.element import Element, chain_to_elements
