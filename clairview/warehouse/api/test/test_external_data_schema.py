...
class TestExternalDataSchema(APIBaseTest):
    ...
    async def test_incremental_fields_postgres(self):
        ...
        await postgres_connection.execute(
            "CREATE TABLE IF NOT EXISTS {schema}.clairview_test (id integer)".format(
                schema=self.postgres_config["schema"]
            )
        )
        await postgres_connection.execute(
            "INSERT INTO {schema}.clairview_test (id) VALUES (1)".format(schema=self.postgres_config["schema"])
        )
    ...
    def test_update_schema_change_sync_type(self):
        ...
        with mock.patch(
            "clairview.warehouse.api.external_data_schema.trigger_external_data_workflow"
    ...
    def test_update_schema_change_should_sync_off(self):
        ...
        with (
            mock.patch(
                "clairview.warehouse.api.external_data_schema.external_data_workflow_exists"
            ) as mock_external_data_workflow_exists,
            mock.patch(
                "clairview.warehouse.api.external_data_schema.pause_external_data_schedule"
    ...
    def test_update_schema_change_should_sync_on_with_existing_schedule(self):
        ...
        with (
            ...
            mock.patch(
                "clairview.warehouse.api.external_data_schema.unpause_external_data_schedule"
    ...
    def test_update_schema_change_should_sync_on_without_existing_schedule(self):
        ...
        with (
            ...
            mock.patch(
                "clairview.warehouse.api.external_data_schema.sync_external_data_job_workflow"
