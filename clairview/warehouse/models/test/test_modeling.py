...
from clairview.warehouse.models.modeling import (
...
class TestModelPath(BaseTest):
    def test_create_from_clairview_root_nodes_query(self):
        """Test creation of a model path from a query that reads from ClairView root tables."""
        query = """\
          select
            events.event,
            persons.properties
