...
from clairview.models.utils import CreatedMetaFields, DeletedMetaFields, UUIDModel, UpdatedMetaFields, sane_repr
import uuid
import psycopg2
import pymysql
...
from clairview.warehouse.types import IncrementalFieldType
...
class ExternalDataSchema(CreatedMetaFields, UpdatedMetaFields, UUIDModel, DeletedMetaFields):
    ...
    source = models.ForeignKey("clairview.ExternalDataSource", related_name="schemas", on_delete=models.CASCADE)
...
def get_mssql_schemas(
    ...
    def get_schemas(postgres_host: str, postgres_port: int):
        # Importing pymssql requires mssql drivers to be installed locally - see clairview/warehouse/README.md
        import pymssql
