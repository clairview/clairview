...
from clairview.models.utils import CreatedMetaFields, UUIDModel, UpdatedMetaFields, sane_repr
from clairview.settings import TEST
from clairview.warehouse.s3 import get_s3_client
...
class ExternalDataJob(CreatedMetaFields, UpdatedMetaFields, UUIDModel):
    ...
    pipeline = models.ForeignKey("clairview.ExternalDataSource", related_name="jobs", on_delete=models.CASCADE)
    schema = models.ForeignKey("clairview.ExternalDataSchema", on_delete=models.CASCADE, null=True, blank=True)
...
def get_external_data_job(job_id: UUID) -> ExternalDataJob:
    from clairview.warehouse.models import ExternalDataSchema
