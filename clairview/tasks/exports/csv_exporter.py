...
from clairview.models.exported_asset import ExportedAsset, save_content
...
from ...clairql.constants import CSV_EXPORT_LIMIT, CSV_EXPORT_BREAKDOWN_LIMIT_INITIAL, CSV_EXPORT_BREAKDOWN_LIMIT_LOW
from ...clairql.query import LimitContext
...
def get_from_clairql_query(exported_asset: ExportedAsset, limit: int, resource: dict) -> Generator[Any, None, None]:
...
def _export_to_dict(exported_asset: ExportedAsset, limit: int) -> Any:
    ...
    if resource.get("source"):
        returned_rows = get_from_clairql_query(exported_asset, limit, resource)
    else:
