...
from clairview.tasks.exports import csv_exporter
from clairview.tasks.exports.csv_exporter import (
    UnexpectedEmptyJsonResponse,
    add_query_params,
    _convert_response_to_csv_data,
)
from clairview.clairql.constants import CSV_EXPORT_BREAKDOWN_LIMIT_INITIAL
from clairview.test.base import APIBaseTest, _create_event, flush_persons_and_events, _create_person
...
class TestCSVExporter(APIBaseTest):
    ...
    def patched_request(self):
        with patch("clairview.tasks.exports.csv_exporter.requests.request") as patched_request:
            mock_response = Mock()
            mock_response.status_code = 200
            # API responses copied from https://github.com/ClairView/clairview/runs/7221634689?check_suite_focus=true
    ...
    @patch("clairview.models.exported_asset.UUIDT")
    ...
    @patch("clairview.models.exported_asset.UUIDT")
    @patch("clairview.models.exported_asset.object_storage.write")
    ...
    @patch("clairview.tasks.exports.csv_exporter.logger")
    ...
    def test_failing_export_api_is_reported_query_size_exceeded(self, _mock_logger: MagicMock) -> None:
        with patch("clairview.tasks.exports.csv_exporter.make_api_call") as patched_make_api_call:
            exported_asset = self._create_asset()
    ...
    def test_limiting_query_as_expected(self) -> None:
        with self.settings(SITE_URL="https://app.clairview.com"):
    ...
    @patch("clairview.tasks.exports.csv_exporter.make_api_call")
    ...
    @patch("clairview.clairql.constants.MAX_SELECT_RETURNED_ROWS", 10)
    @patch("clairview.clairql.constants.DEFAULT_RETURNED_ROWS", 5)
    @patch("clairview.models.exported_asset.UUIDT")
    def test_csv_exporter_clairql_query(
    ...
    def test_csv_exporter_empty_result(self, mocked_uuidt: Any) -> None:
        ...
        with patch("clairview.tasks.exports.csv_exporter.get_from_clairql_query") as mocked_get_from_clairql_query:
            mocked_get_from_clairql_query.return_value = iter([])
