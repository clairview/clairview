...
from clairview.torql.constants import CSV_EXPORT_BREAKDOWN_LIMIT_INITIAL
...
class TestCSVExporter(APIBaseTest):
    ...
    @patch("clairview.torql.constants.MAX_SELECT_RETURNED_ROWS", 10)
    @patch("clairview.torql.constants.DEFAULT_RETURNED_ROWS", 5)
    @patch("clairview.models.exported_asset.UUIDT")
    ...
    def test_csv_exporter_empty_result(self, mocked_uuidt: Any) -> None:
        ...
        with patch("clairview.tasks.exports.csv_exporter.get_from_torql_query") as mocked_get_from_torql_query:
