...
from clairview.models import ExportedAsset, Insight
...
from clairview.tasks.exports import image_exporter
from clairview.test.base import APIBaseTest

TEST_PREFIX = "Test-Exports"


@patch("clairview.tasks.exports.image_exporter._screenshot_asset")
@patch(
    "clairview.tasks.exports.image_exporter.open",
