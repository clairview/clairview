...
from clairview.caching.warming import schedule_warming_for_teams_task
from clairview.celery import app
from clairview.tasks.alerts.checks import (
    check_alerts_task,
    checks_cleanup_task,
    alerts_backlog_task,
)
from clairview.tasks.integrations import refresh_integrations
from clairview.tasks.tasks import (
    calculate_cohort,
...
from clairview.utils import get_crontab
...
def setup_periodic_tasks(sender: Celery, **kwargs: Any) -> None:
    ...
    # Every 30 minutes, send decide request counts to the main clairview instance
    sender.add_periodic_task(
        crontab(minute="*/30"),
    ...
    if settings.EE_AVAILABLE:
        ...
        )  # every day at a random minute past midnight. Randomize to avoid overloading license.clairview.com
        sender.add_periodic_task(
