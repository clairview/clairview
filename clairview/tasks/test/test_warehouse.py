...
from clairview.tasks.warehouse import (
    capture_workspace_rows_synced_by_team,
    validate_data_warehouse_table_columns,
    capture_external_data_rows_synced,
)
from clairview.warehouse.models import ExternalDataSource, ExternalDataJob
...
class TestWarehouse(APIBaseTest):
    ...
    @patch(
        "clairview.tasks.warehouse.DEFAULT_DATE_TIME",
    ...
    def test_validate_data_warehouse_table_columns(self, mock_get_ph_client: MagicMock) -> None:
        ...
        table = DataWarehouseTable.objects.create(
            ...
            format="Parquet",
            team=self.team,
            columns={"some_columns": {"clairql": "StringDatabaseField", "clickhouse": "Nullable(String)"}},
        )
    ...
    @patch("clairview.tasks.warehouse.capture_workspace_rows_synced_by_team.delay")
