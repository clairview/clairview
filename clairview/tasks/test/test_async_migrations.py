...
from clairview.async_migrations.examples.test_migration import Migration
from clairview.async_migrations.runner import (
    run_async_migration_next_op,
    run_async_migration_operations,
)
from clairview.async_migrations.test.util import create_async_migration
...
class TestAsyncMigrations(BaseTest):
    ...
    @patch("clairview.celery.app.control.inspect", side_effect=inspect_mock)
    @patch(
        "clairview.tasks.async_migrations.run_async_migration.delay",
