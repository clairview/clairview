...
from clairview.models.alert import AlertCheck
from clairview.models.instance_setting import set_instance_setting
from clairview.tasks.alerts.checks import _send_notifications_for_breaches, check_alert
from clairview.test.base import APIBaseTest, _create_event, flush_persons_and_events, ClickhouseDestroyTablesMixin
from clairview.api.test.dashboards import DashboardAPI
from clairview.schema import ChartDisplayType, EventsNode, TrendsQuery, TrendsFilter, AlertState
...
@patch("clairview.tasks.alerts.checks._send_notifications_for_errors")
@patch("clairview.tasks.alerts.checks._send_notifications_for_breaches")
class TestAlertChecks(APIBaseTest, ClickhouseDestroyTablesMixin):
    ...
    def test_send_error_while_calculating(
        ...
        with patch(
            "clairview.tasks.alerts.checks.calculate_for_query_based_insight"
    ...
    @patch("clairview.tasks.alerts.checks.EmailMessage")
    def test_send_emails(
        ...
        assert email.to[0]["recipient"] == "user1@clairview.com"
