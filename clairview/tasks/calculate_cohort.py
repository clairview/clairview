...
from clairview.api.monitoring import Feature
from clairview.models import Cohort
from clairview.models.cohort import get_and_update_pending_version
from clairview.models.cohort.util import clear_stale_cohortpeople
...
def insert_cohort_from_insight_filter(cohort_id: int, filter_data: dict[str, Any]) -> None:
    from clairview.api.cohort import (
