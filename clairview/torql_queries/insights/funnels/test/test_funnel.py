...
from clairview.api.instance_settings import get_instance_setting
from clairview.clickhouse.client.execute import sync_execute
from clairview.constants import INSIGHT_FUNNELS, FunnelOrderType, FunnelVizType
...
from clairview.torql_queries.actors_query_runner import ActorsQueryRunner
from clairview.torql_queries.insights.funnels import Funnel
...
from clairview.torql_queries.insights.funnels.test.breakdown_cases import (
    assert_funnel_results_equal,
    funnel_breakdown_group_test_factory,
    funnel_breakdown_test_factory,
)
from clairview.torql_queries.insights.funnels.test.conversion_time_cases import (
...
from clairview.models import Action, Element
...
from clairview.queries.funnels import ClickhouseFunnelActors
...
@patch("clairviewanalytics.feature_enabled", new=Mock(return_value=False))
    ...
    class TestGetFunnel(ClickhouseTestMixin, APIBaseTest):
        ...
        def test_funnel_person_prop(self):
            ...
            person_factory(
                distinct_ids=["with_property"],
                team_id=self.team.pk,
                properties={"email": "hello@clairview.com"},
            )
        ...
        def test_torql_aggregation(self):
            ...
            person_factory(
                distinct_ids=["user"],
                team_id=self.team.pk,
                properties={"email": "lembitu@clairview.com", "common_prop": "yes"},
            )
            ...
            person_factory(
                distinct_ids=["second"],
                team_id=self.team.pk,
                properties={"email": "toomas@clairview.com", "common_prop": "yes"},
            )
