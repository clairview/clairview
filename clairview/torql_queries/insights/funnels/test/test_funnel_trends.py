...
from clairview.constants import INSIGHT_FUNNELS, TRENDS_LINEAR, FunnelOrderType
...
from clairview.queries.funnels.funnel_trends_persons import ClickhouseFunnelTrendsActors
