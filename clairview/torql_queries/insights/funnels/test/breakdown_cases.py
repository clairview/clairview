...
from clairview.constants import INSIGHT_FUNNELS, FunnelOrderType
...
from clairview.queries.breakdown_props import ALL_USERS_COHORT_ID
from clairview.schema import BaseMathType, FunnelsQuery
...
def funnel_breakdown_test_factory(
    ...
    class TestFunnelBreakdown(APIBaseTest):
        ...
        def test_basic_funnel_default_funnel_days_breakdown_event(self):
                ...
                "user_1": [
                    {
                        ...
                        "timestamp": datetime(2020, 1, 2, 14),
                        "properties": {"$current_url": "https://clairview.com/docs/x"},
                    },
                    {
                        "event": "paid",
            ...
            # See https://github.com/ClairView/clairview/pull/5496
                    ...
                    events_by_person["user_1"].append(
                        {
                            "event": "user signed up",
                            "timestamp": datetime(2020, 1, 2, 14),
                            "properties": {"$current_url": f"https://clairview.com/blog/{current_url_letter}"},
                        }
                    )
                        ...
                        "properties": [
                            {
                                ...
                                "operator": "icontains",
                                "type": "event",
                                "value": "https://clairview.com/docs",
                            }
                        ],
                    },
            ...
            self._assert_funnel_breakdown_result_is_correct(
                ...
                [
                    FunnelStepResult(
                        name="user signed up",
                        count=1,
                        breakdown=["https://clairview.com/docs/x"],
                    ),
                    FunnelStepResult(
                        name="paid",
                        count=1,
