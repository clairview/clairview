...
from clairview.constants import PAGEVIEW_EVENT, SCREEN_EVENT, TORQL
...
from clairview.torql_queries.insights.funnels.funnels_query_runner import FunnelsQueryRunner
from clairview.torql_queries.insights.funnels.utils import funnel_window_interval_unit_to_sql
...
class PathsQueryRunner(QueryRunner):
    ...
    def funnel_join(self) -> ast.JoinExpr:
        ...
        from clairview.torql_queries.insights.insight_actors_query_runner import InsightActorsQueryRunner
