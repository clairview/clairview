...
from clairview.torql_queries.web_analytics.web_overview import WebOverviewQueryRunner
...
class TestWebOverviewQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def _run_web_overview_query(
        ...
        modifiers = TorQLQueryModifiers(sessionTableVersion=session_table_version)
