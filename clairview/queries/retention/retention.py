...
from clairview.constants import RETENTION_FIRST_TIME, RetentionQueryType
...
from clairview.queries.retention.actors_query import (
...
from clairview.queries.retention.sql import RETENTION_BREAKDOWN_SQL
from clairview.queries.retention.types import BreakdownValues, CohortKey
...
class Retention:
    ...
    def _get_retention_by_breakdown_values(
        ...
        result = insight_sync_execute(
            ...
            {**actor_query_params, **filter.clairql_context.values},
