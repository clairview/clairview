...
from clairview.queries.actor_base_query import ActorBaseQuery
...
from clairview.queries.retention.sql import RETENTION_BREAKDOWN_ACTOR_SQL
from clairview.queries.retention.types import BreakdownValues
...
class RetentionActorsByPeriod(ActorBaseQuery):
    ...
    def actors(self):
        ...
        results = insight_sync_execute(
            actor_query,
            {**actor_query_params, **self._filter.clairql_context.values},
...
def build_actor_activity_query(
    ...
    from clairview.queries.retention import (
