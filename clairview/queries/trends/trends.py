...
from clairview.clickhouse.query_tagging import get_query_tags, tag_queries
...
from clairview.queries.base import handle_compare
from clairview.queries.insight import insight_sync_execute
from clairview.queries.trends.breakdown import TrendsBreakdown
from clairview.queries.trends.formula import TrendsFormula
from clairview.queries.trends.lifecycle import Lifecycle
from clairview.queries.trends.total_volume import TrendsTotalVolume
...
class Trends(TrendsTotalVolume, Lifecycle, TrendsFormula):
    ...
    def _run_query(self, filter: Filter, team: Team, entity: Entity) -> list[dict[str, Any]]:
        ...
        with push_scope() as scope:
            ...
            query_params = {**params, **adjusted_filter.clairql_context.values}
