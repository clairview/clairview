...
from clairview.constants import TRENDS_CUMULATIVE, TRENDS_PIE, TRENDS_BOLD_NUMBER
from clairview.models import Cohort, Person
...
class TestFormula(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_breakdown_with_different_breakdown_values_per_series(self):
        ...
        self.assertEqual(response[3]["label"], "$$_clairview_breakdown_null_$$")
