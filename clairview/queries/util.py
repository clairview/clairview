...
from clairview.models.event import DEFAULT_EARLIEST_TIME_DELTA
...
def correct_result_for_sampling(
    ...
    # - The value is not a number (should not happen, but being defensive, especially against ClairQL aggregation)
