...
from clairview.models.property import PropertyGroup, PropertyName
...
class EventQuery(metaclass=ABCMeta):
    ...
    def _determine_should_join_persons(self) -> None:
        ...
        # Can be simplified significantly after https://github.com/ClairView/clairview/issues/5854
