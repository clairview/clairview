...
from clairview.constants import PropertyOperatorType, TREND_FILTER_TYPE_ACTIONS, TREND_FILTER_TYPE_EVENTS
from clairview.torql import ast
from clairview.torql.parser import parse_expr
from clairview.torql.property import (
    action_to_expr,
    has_aggregation,
    property_to_expr,
    selector_to_expr,
...
from clairview.models.property_definition import PropertyType
from clairview.schema import TorQLPropertyFilter, RetentionEntity, EmptyPropertyFilter
from clairview.test.base import BaseTest, _create_event
from clairview.warehouse.models import DataWarehouseTable, DataWarehouseJoin, DataWarehouseCredential
...
class TestProperty(BaseTest):
    ...
    def test_property_to_expr_torql(self):
        self.assertEqual(self._property_to_expr({"type": "torql", "key": "1"}), ast.Constant(value=1))
        self.assertEqual(
            self._property_to_expr(Property(type="torql", key="1")),
            ast.Constant(value=1),
        )
        self.assertEqual(
            self._property_to_expr(TorQLPropertyFilter(type="torql", key="1")),
            ast.Constant(value=1),
        )
    ...
    def test_entity_to_expr_actions_type_with_id(self):
        ...
        with patch("clairview.models.Action.objects.get", return_value=action_mock):
    ...
    def test_data_warehouse_person_property(self):
        ...
        DataWarehouseTable.objects.create(
            ...
            columns={
                "string_prop": {"torql": "StringDatabaseField", "clickhouse": "Nullable(String)"},
                "int_prop": {"torql": "IntegerDatabaseField", "clickhouse": "Nullable(Int64)"},
                "bool_prop": {"torql": "BooleanDatabaseField", "clickhouse": "Nullable(Bool)"},
            },
