...
from clairview.torql.ast import ConstantType, FieldTraverserType
...
from clairview.torql.database.schema.persons import PersonsTable
from clairview.torql.errors import ImpossibleASTError, QueryError, ResolutionError
from clairview.torql.functions import find_torql_clairview_function
from clairview.torql.functions.action import matches_action
from clairview.torql.functions.cohort import cohort_query_node
from clairview.torql.functions.mapping import TORQL_CLICKHOUSE_FUNCTIONS, compare_types, validate_function_args
from clairview.torql.functions.recording_button import recording_button
from clairview.torql.functions.sparkline import sparkline
from clairview.torql.torqlx import TORQLX_COMPONENTS, convert_to_hx
from clairview.torql.parser import parse_select
from clairview.torql.resolver_utils import expand_torqlx_query, lookup_cte_by_name, lookup_field_by_name
from clairview.torql.visitor import CloningVisitor, TraversingVisitor, clone_expr
...
class Resolver(CloningVisitor):
    ...
    def visit_call(self, node: ast.Call):
        ...
        if func_meta := find_torql_clairview_function(node.name):
