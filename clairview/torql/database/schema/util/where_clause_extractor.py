...
from clairview.torql.ast import CompareOperationOp, ArithmeticOperationOp
from clairview.torql.context import TorQLContext
from clairview.torql.database.models import DatabaseField, LazyJoinToAdd, LazyTableToAdd
from clairview.torql.errors import NotImplementedError

from clairview.torql.visitor import clone_expr, CloningVisitor, Visitor, TraversingVisitor
...
class WhereClauseExtractor(CloningVisitor):
    ...
    def __init__(self, context: TorQLContext):
        super().__init__()
...
def is_simple_timestamp_field_expression(expr: ast.Expr, context: TorQLContext, tombstone_string: str) -> bool:
...
class IsSimpleTimestampFieldExpressionVisitor(Visitor[bool]):
    ...
    def __init__(self, context: TorQLContext, tombstone_string: str):
        self.context = context
        self.tombstone_string = tombstone_string
    ...
    def visit_alias(self, node: ast.Alias) -> bool:
        ...
        from clairview.torql.database.schema.sessions_v1 import SessionsTableV1
        from clairview.torql.database.schema.sessions_v2 import SessionsTableV2

        from clairview.torql.database.schema.session_replay_events import RawSessionReplayEventsTable
...
def rewrite_timestamp_field(expr: ast.Expr, timestamp_field: ast.Expr, context: TorQLContext) -> ast.Expr:
...
class RewriteTimestampFieldVisitor(CloningVisitor):
    ...
    def __init__(self, context: TorQLContext, timestamp_field: ast.Expr, *args, **kwargs):
