...
from clairview.torql.errors import ResolutionError, NotImplementedError

if TYPE_CHECKING:
    from clairview.torql.context import TorQLContext
    from clairview.torql.ast import SelectQuery, LazyJoinType
    from clairview.torql.base import ConstantType
...
class DatabaseField(FieldOrTable):
    ...
    def get_constant_type(self) -> "ConstantType":
        from clairview.torql.ast import UnknownType
...
class IntegerDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from clairview.torql.ast import IntegerType
...
class FloatDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from clairview.torql.ast import FloatType
...
class StringDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from clairview.torql.ast import StringType
...
class DateDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from clairview.torql.ast import DateType
...
class DateTimeDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from clairview.torql.ast import DateTimeType
...
class BooleanDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from clairview.torql.ast import BooleanType
