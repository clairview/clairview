...
from clairview.torql.functions import find_torql_aggregation
...
from clairview.models.event import Selector
from clairview.models.element import Element
from clairview.models.property import PropertyGroup, ValueT
from clairview.models.property.util import build_selector_regex
...
from clairview.warehouse.models import DataWarehouseJoin
from clairview.utils import get_from_dict_or_attr
...
class AggregationFinder(TraversingVisitor):
    ...
    def visit_call(self, node: ast.Call):
        if find_torql_aggregation(node.name):
...
def _handle_bool_values(value: ValueT, expr: ast.Expr, property: Property, team: Team) -> ValueT | bool:
    ...
    if property.type == "person":
        ...
        if table_or_view:
            ...
            prop_type = prop_type_dict.get("torql")
