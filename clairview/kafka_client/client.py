...
from clairview.kafka_client import helper
from clairview.utils import SingletonDecorator
...
class _KafkaProducer:
    ...
    def on_send_success(self, record_metadata: RecordMetadata):
        statsd.incr("clairview_cloud_kafka_send_success", tags={"topic": record_metadata.topic})

    def on_send_failure(self, topic: str, exc: Exception):
        statsd.incr(
            "clairview_cloud_kafka_send_failure",
