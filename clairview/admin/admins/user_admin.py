...
from clairview.admin.inlines.totp_device_inline import TOTPDeviceInline
...
class UserAdmin(DjangoUserAdmin):
    ...
    def current_team_link(self, user: User):
        ...
        return format_html(
            '<a href="/admin/clairview/team/{}/change/">{}</a>',
            user.team.pk,
            user.team.name,
        )
    ...
    def current_organization_link(self, user: User):
        ...
        return format_html(
            '<a href="/admin/clairview/organization/{}/change/">{}</a>',
