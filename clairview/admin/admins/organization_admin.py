...
from clairview.admin.inlines.organization_member_inline import OrganizationMemberInline
from clairview.admin.inlines.project_inline import ProjectInline
from clairview.admin.inlines.team_inline import TeamInline
from clairview.admin.paginators.no_count_paginator import NoCountPaginator
...
class OrganizationAdmin(admin.ModelAdmin):
    ...
    def first_member(self, organization: Organization):
        ...
        return (
            format_html(f'<a href="/admin/clairview/user/{user.pk}/change/">{user.email}</a>')
            if user is not None
            else "None"
        )
