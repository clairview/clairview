...
from clairview.batch_exports.models import BatchExport, BatchExportDestination
from clairview.batch_exports.service import backfill_export, sync_batch_export
from clairview.models.plugin import PluginAttachment, PluginConfig
...
def map_plugin_config_to_destination(plugin_config: PluginConfig) -> tuple[str, dict]:
    ...
    if plugin.name == "S3 Export Plugin":
        ...
        config = {
            ...
            "table_name": plugin_config.config.get("tableName", "clairview_event"),
