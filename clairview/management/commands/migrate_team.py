...
from clairview.batch_exports.models import BATCH_EXPORT_INTERVALS
...
EXPORT_NAME = "ClairView HTTP Migration"
VALID_INTERVALS = {i[0] for i in BATCH_EXPORT_INTERVALS}
REGION_URLS = {
    "us": "https://app.clairview.com/batch",
    "eu": "https://eu.clairview.com/batch",
}


class Command(BaseCommand):
    help = "Creates an HTTP batch export for a team to migrate data to another ClairView instance, \
