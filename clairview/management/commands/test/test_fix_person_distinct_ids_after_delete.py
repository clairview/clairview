...
import clairview.management.commands.fix_person_distinct_ids_after_delete
from clairview.client import sync_execute
from clairview.management.commands.fix_person_distinct_ids_after_delete import run
from clairview.models.person.person import Person, PersonDistinctId
from clairview.models.person.sql import PERSON_DISTINCT_ID2_TABLE
from clairview.models.person.util import create_person, create_person_distinct_id
...
class TestFixPersonDistinctIdsAfterDelete(BaseTest, ClickhouseTestMixin):
    ...
    @mock.patch(
        f"{clairview.management.commands.fix_person_distinct_ids_after_delete.__name__}.create_person_distinct_id",
        wraps=clairview.management.commands.fix_person_distinct_ids_after_delete.create_person_distinct_id,
    )
