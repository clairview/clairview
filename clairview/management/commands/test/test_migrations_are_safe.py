from clairview.management.commands.test_migrations_are_safe import validate_migration_sql
...
--
CREATE TABLE "clairview_strawman" ("id" serial NOT NULL PRIMARY KEY, "name" varchar(400) NULL);
COMMIT;
BEGIN;
--
-- Create model StrawMan
...
-- Create model StrawMan
--
CREATE TABLE "clairview_strawman" ("id" bigserial NOT NULL PRIMARY KEY, "name" varchar(400) NULL);
COMMIT;
BEGIN;
--
-- Create model StrawMan
