...
from clairview.management.commands.create_batch_export_from_app import (
    map_plugin_config_to_destination,
)
from clairview.models import Plugin, PluginAttachment, PluginConfig
...
def snowflake_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/ClairView/snowflake-export-plugin"),
        plugin_type="custom",
...
def s3_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/ClairView/s3-export-plugin"),
        plugin_type="custom",
        organization=organization,
    )
    yield plugin
...
def bigquery_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/ClairView/bigquery-plugin"),
        plugin_type="custom",
        organization=organization,
    )
    yield plugin
...
def postgres_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/ClairView/postgres-plugin"),
        plugin_type="custom",
        organization=organization,
    )
    yield plugin
