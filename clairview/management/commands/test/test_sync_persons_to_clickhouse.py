...
import clairview.management.commands.sync_persons_to_clickhouse
from clairview.client import sync_execute
from clairview.management.commands.sync_persons_to_clickhouse import (
    run,
...
class TestSyncPersonsToClickHouse(BaseTest, ClickhouseTestMixin):
    ...
    @mock.patch(
        f"{clairview.management.commands.sync_persons_to_clickhouse.__name__}.raw_create_group_ch",
        wraps=clairview.management.commands.sync_persons_to_clickhouse.raw_create_group_ch,
    )
