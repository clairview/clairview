from clairview.caching.warming import priority_insights, schedule_warming_for_teams_task
from clairview.models import Insight, DashboardTile, InsightViewed, Dashboard
...
class TestScheduleWarmingForTeamsTask(APIBaseTest):
    ...
    @patch("clairview.caching.warming.largest_teams")
    @patch("clairview.caching.warming.priority_insights")
    @patch("clairview.caching.warming.warm_insight_cache_task.si")
