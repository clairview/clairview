...
from clairview.caching.insight_caching_state import (
    LazyLoader,
    TargetCacheAge,
...
@patch("clairview.caching.insight_caching_state.active_teams")
...
class TestLazyLoader(BaseTest):
    ...
    def test_recently_viewed_insights(self):
        ...
        user2 = User.objects.create(email="testuser@clairview.com")
