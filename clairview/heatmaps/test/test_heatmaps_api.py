...
from clairview.kafka_client.topics import KAFKA_CLICKHOUSE_SESSION_REPLAY_EVENTS
from clairview.models import Organization, Team
from clairview.models.event.util import format_clickhouse_timestamp
from clairview.test.base import APIBaseTest, ClickhouseTestMixin, QueryMatchingTest, snapshot_clickhouse_queries
    ...
    def _create_heatmap_event(
        ...
        p.produce(
            ...
            data={
                ...
                "type": type,
                "pointer_target_fixed": True,
                "current_url": current_url if current_url else "http://clairview.com",
            },
        )
