...
from clairview.metrics import LABEL_RESOURCE_TYPE
from clairview.session_recordings.models.metadata import (
    SessionRecordingEventSummary,
)
from clairview.utils import flatten
...
def preprocess_replay_events(
    ...
    1. Since clairview-js {version} we are grouping events on the frontend in a batch and passing their size in $snapshot_bytes
