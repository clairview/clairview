...
# DEPRECATED: ClairView model is no longer supported or used
class SessionRecordingEvent(models.Model):
    ...
    class Meta:
        indexes = [
            ...
            # The migration is in 0110, and see https://github.com/ClairView/clairview/issues/4969 for more info
