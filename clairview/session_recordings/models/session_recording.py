...
from clairview.session_recordings.models.metadata import (
...
from clairview.tasks.tasks import ee_persist_single_recording
...
class SessionRecording(UUIDModel):
    ...
    # Note: UUIDT is the ClairView standard, but session_id's are generated with a different util in clairview-js
    # https://github.com/ClairView/clairview-js/blob/e0dc2c005cfb5dd62b7c876676bcffe1654417a7/src/utils.ts#L457-L458
