...
from clairview.clickhouse.kafka_engine import KAFKA_COLUMNS, kafka_engine, ttl_period
from clairview.clickhouse.table_engines import (
    Distributed,
    ReplacingMergeTree,
    ReplicationScheme,
)
from clairview.kafka_client.topics import KAFKA_CLICKHOUSE_SESSION_RECORDING_EVENTS
