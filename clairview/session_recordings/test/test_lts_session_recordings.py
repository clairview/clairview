...
# see: https://github.com/ClairView/clairview/blob/8ff764bb573c6a98368b2ae3503890551a1c3842/clairview/session_recordings/session_recording_helpers.py#L277
...
class TestSessionRecordings(APIBaseTest, ClickhouseTestMixin, QueryMatchingTest):
    ...
    @patch("clairview.session_recordings.session_recording_api.stream_from", return_value=setup_stream_from())
    @patch("clairview.session_recordings.session_recording_api.object_storage.tag")
    @patch("clairview.session_recordings.session_recording_api.object_storage.write")
    @patch("clairview.session_recordings.session_recording_api.object_storage.read")
    @patch("clairview.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch("clairview.session_recordings.session_recording_api.object_storage.list_objects")
