...
from clairview.models import Organization, Person, SessionRecording
...
from clairview.session_recordings.test import setup_stream_from
...
class TestSessionRecordings(APIBaseTest, ClickhouseTestMixin, QueryMatchingTest):
    ...
    @patch("clairview.session_recordings.session_recording_api.SessionRecordingListFromFilters")
    ...
    @patch(
        "clairview.session_recordings.queries.session_replay_events.SessionReplayEvents.exists",
        return_value=True,
    )
    @patch("clairview.session_recordings.session_recording_api.object_storage.list_objects")
    ...
    @patch("clairview.session_recordings.session_recording_api.SessionRecording.get_or_build")
    @patch("clairview.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch("clairview.session_recordings.session_recording_api.stream_from", return_value=setup_stream_from())
    ...
    @patch("clairview.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch(
        "clairview.session_recordings.session_recording_api.stream_from",
    ...
    @patch("clairview.session_recordings.session_recording_api.SessionRecording.get_or_build")
    @patch("clairview.session_recordings.session_recording_api.object_storage.get_presigned_url")
    @patch("clairview.session_recordings.session_recording_api.stream_from")
    ...
    @patch("clairview.session_recordings.session_recording_api.SessionRecording.get_or_build")
    @patch("clairview.session_recordings.session_recording_api.get_realtime_snapshots")
    @patch("clairview.session_recordings.session_recording_api.stream_from")
    def test_can_get_session_recording_realtime(
        ...
        see: https://clairview.sentry.io/issues/4981128697/
        """
