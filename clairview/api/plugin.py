...
from clairview.api.utils import ClassicBehaviorBooleanFieldSerializer, action
from clairview.cdp.templates import HOG_FUNCTION_MIGRATORS
from clairview.models import Plugin, PluginAttachment, PluginConfig, User
...
from clairview.models.activity_logging.serializers import ActivityLogSerializer
from clairview.models.organization import Organization
from clairview.models.plugin import (
    PluginSourceFile,
    update_validated_data_from_url,
    validate_plugin_job_payload,
    transpile,
)
from clairview.models.utils import UUIDT, generate_random_token
from clairview.permissions import APIScopePermission
from clairview.plugins import can_configure_plugins, can_install_plugins, parse_url
from clairview.plugins.access import can_globally_manage_plugins, has_plugin_access_level
from clairview.plugins.plugin_server_api import populate_plugin_capabilities_on_workers
from clairview.queries.app_metrics.app_metrics import TeamPluginsDeliveryRateQuery
...
class PluginViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    def repository(self, request: request.Request, **kwargs):
        url = "https://raw.githubusercontent.com/ClairView/integrations-repository/main/plugins.json"
