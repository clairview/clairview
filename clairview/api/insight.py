...
from clairview.api.utils import action, format_paginated_url
from clairview.auth import SharingAccessTokenAuthentication
from clairview.caching.fetch_from_cache import InsightResult
from clairview.clickhouse.cancel import cancel_query_on_cluster
...
from clairview.kafka_client.topics import KAFKA_METRICS_TIME_TO_SEE_DATA
from clairview.models import DashboardTile, Filter, Insight, User
...
from clairview.models.alert import are_alerts_supported_for_insight
from clairview.models.dashboard import Dashboard
from clairview.models.filters import RetentionFilter
...
from clairview.models.insight import InsightViewed
...
from clairview.queries.funnels import (
    ClickhouseFunnelTimeToConvert,
    ClickhouseFunnelTrends,
)
from clairview.queries.funnels.utils import get_funnel_order_class
...
from clairview.settings import CAPTURE_TIME_TO_SEE_DATA, SITE_URL
...
When set, the specified dashboard's filters and date range override will be applied.""",
    ...
    def trend(self, request: request.Request, *args: Any, **kwargs: Any):
        ...
        if self.request.accepted_renderer.format == "csv":
            ...
            response["Content-Disposition"] = (
                'attachment; filename="{name} ({date_from} {date_to}) from ClairView.csv"'.format(
    ...
    def timing(self, request: request.Request, **kwargs):
        from clairview.kafka_client.client import KafkaProducer
        from clairview.models.event.util import format_clickhouse_timestamp
