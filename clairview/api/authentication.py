...
from clairview.api.email_verification import EmailVerifier, is_email_verification_disabled
from clairview.email import is_email_available
from clairview.event_usage import report_user_logged_in, report_user_password_reset
from clairview.models import OrganizationDomain, User
from clairview.rate_limit import UserPasswordResetThrottle
from clairview.tasks.email import send_password_reset
from clairview.utils import get_instance_available_sso_providers
        ...
        for key, value in self.context["request"].COOKIES.items():
            if key.startswith(REMEMBER_COOKIE_PREFIX) and value:
                try:
                    ...
                    # See https://github.com/ClairView/clairview/issues/19350
                    pass
        return True
