...
from clairview.async_migrations.status import async_migrations_ok
from clairview.cloud_utils import is_cloud
from clairview.git import get_git_commit_short
from clairview.permissions import SingleTenancyOrAdmin
...
class InstanceStatusViewSet(viewsets.ViewSet):
    ...
    def list(self, request: Request) -> Response:
        ...
        metrics.append(
            {"key": "clairview_git_sha", "metric": "ClairView Git SHA", "value": get_git_commit_short() or "unknown"}
        )
    ...
    def navigation(self, request: Request) -> Response:
        ...
        from clairview.clickhouse.system_status import dead_letter_queue_ratio_ok_cached
    ...
    def queries(self, request: Request) -> Response:
        ...
        from clairview.clickhouse.system_status import (
