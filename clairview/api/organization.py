...
from clairview.api.shared import ProjectBasicSerializer, TeamBasicSerializer
from clairview.cloud_utils import is_cloud
from clairview.constants import INTERNAL_BOT_EMAIL_SUFFIX, AvailableFeature
from clairview.event_usage import report_organization_deleted
from clairview.models import Organization, User
...
from clairview.models.team.util import delete_bulky_postgres_data
from clairview.models.uploaded_media import UploadedMedia
...
class PremiumMultiorganizationPermissions(permissions.BasePermission):
    ...
    message = "You must upgrade your ClairView plan to be able to create and manage multiple organizations."
