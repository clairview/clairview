...
from clairview.constants import TREND_FILTER_TYPE_EVENTS
from clairview.event_usage import report_user_action
from clairview.models import Action
from clairview.models.action.action import ACTION_STEP_MATCHING_OPTIONS
...
class ActionViewSet(
    ...
    def migrate(self, request: request.Request, **kwargs):
        ...
        from clairview.management.commands.migrate_action_webhooks import convert_to_hog_function
