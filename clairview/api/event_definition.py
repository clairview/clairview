...
from clairview.api.utils import create_event_definitions_sql
from clairview.constants import AvailableFeature, EventDefinitionType
...
class EventDefinitionViewSet(
    ...
    def dangerously_get_queryset(self):
        ...
        params = {"team_id": self.team.project_id, "is_clairview_event": "$%", **search_kwargs}
