...
from clairview.api.documentation import (
...
from clairview.models.team import TIMEZONES
...
class GenericInsightsSerializer(serializers.Serializer):
    ...
    filter_test_accounts = serializers.BooleanField(
        help_text='Whether to filter out internal and test accounts. See "project settings" in your ClairView account for the filters.',
        default=False,
    )
