...
from clairview.api.shared import TeamBasicSerializer
...
from clairview.models import ProductIntent, Team, User
...
from clairview.models.personal_api_key import APIScopeObjectOrNotSupported
from clairview.models.project import Project
from clairview.models.signals import mute_selected_signals
from clairview.models.team.util import delete_batch_exports, delete_bulky_postgres_data
from clairview.models.utils import UUIDT
from clairview.permissions import (
    CREATE_METHODS,
    APIScopePermission,
...
from clairview.utils import get_ip_address, get_week_start_for_country_code


class PremiumMultiProjectPermissions(BasePermission):  # TODO: Rename to include "Env" in name
    """Require user to have all necessary premium features on their plan for create access to the endpoint."""

    message = "You must upgrade your ClairView plan to be able to create and manage multiple projects or environments."
