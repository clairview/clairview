...
from clairview.models import DashboardTile
...
from clairview.tasks.exports.image_exporter import export_image
...
class TestExports(APIBaseTest):
    ...
    @patch("clairview.api.exports.exporter")
    ...
    def test_swallow_missing_schema_and_allow_front_end_to_poll(self, mock_exporter_task) -> None:
        # regression test see https://github.com/ClairView/clairview/issues/11204
    ...
    @patch("clairview.tasks.exports.image_exporter._export_to_png")
    @patch("clairview.api.exports.exporter")
    ...
    def test_can_create_new_valid_export_insight(self, mock_exporter_task, mock_export_to_png) -> None:
        ...
        with patch("clairview.tasks.exports.image_exporter.process_query_dict") as mock_process_query_dict:
