...
from clairview.models import Element, ElementGroup, Organization
        ...
        "elements": [
            {
                ...
                "tag_name": "a",
                "attr_class": None,
                "href": "https://clairview.com/event-1",
                "attr_id": None,
                "nth_child": 0,
                "nth_of_type": 0,
                "attributes": {},
        ...
        "elements": [
            {
                ...
                "tag_name": "a",
                "attr_class": None,
                "href": "https://clairview.com/event-2",
                "attr_id": None,
                "nth_child": 0,
                "nth_of_type": 0,
                "attributes": {},
...
class TestElement(ClickhouseTestMixin, APIBaseTest, QueryMatchingTest):
    def test_element_automatic_order(self) -> None:
        elements = [
            Element(tag_name="a", href="https://clairview.com/about", text="click here"),
    ...
    def test_event_property_values(self) -> None:
        _create_event(
            ...
            distinct_id="test",
            event="$autocapture",
            elements=[Element(tag_name="a", href="https://clairview.com/about", text="click here")],
        )
    ...
    def test_element_stats_can_filter_by_clairql(self) -> None:
        self._setup_events()
    ...
    def test_element_stats_clamps_date_from_to_start_of_day(self) -> None:
        ...
        with freeze_time(event_start) as frozen_time:
            elements = [
                Element(
                    tag_name="a",
                    href="https://clairview.com/about",
                    text="click here",
                    order=0,
                ),
                Element(
