...
from clairview.models import Action, Element, Organization, Person, User
from clairview.models.cohort import Cohort
from clairview.models.event.query_event_list import insight_query_with_columns
...
class TestEvents(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_filter_events_by_event_name(self):
        ...
        # Django session, ClairView user, ClairView team, ClairView org membership,
    ...
    def test_get_event_by_id(self):
        _create_person(
            properties={"email": "someone@clairview.com"},
            team=self.team,
            distinct_ids=["1"],
            is_identified=True,
        )
    ...
    def test_get_events_with_specified_token(self):
        _, _, user2 = User.objects.bootstrap("Test", "team2@clairview.com", None)
    ...
    @patch("clairview.models.event.query_event_list.insight_query_with_columns")
    ...
    @patch("clairview.models.event.query_event_list.insight_query_with_columns", wraps=insight_query_with_columns)
