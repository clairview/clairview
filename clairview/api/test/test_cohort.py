...
from clairview.api.test.test_exports import TestExportMixin
from clairview.clickhouse.client.execute import sync_execute
from clairview.models import FeatureFlag, Person
...
from clairview.schema import PropertyOperator
from clairview.tasks.calculate_cohort import calculate_cohort_ch, calculate_cohort_from_list
from clairview.tasks.tasks import clickhouse_clear_removed_data
...
class TestCohort(TestExportMixin, ClickhouseTestMixin, APIBaseTest, QueryMatchingTest):
    ...
    @patch("clairview.api.cohort.report_user_action")
    @patch("clairview.tasks.calculate_cohort.calculate_cohort_ch.delay", side_effect=calculate_cohort_ch)
    @patch("clairview.models.cohort.util.sync_execute", side_effect=sync_execute)
    ...
    @patch("clairview.api.cohort.report_user_action")
    @patch("clairview.tasks.calculate_cohort.calculate_cohort_ch.delay")
    ...
    @patch("clairview.tasks.calculate_cohort.calculate_cohort_from_list.delay")
