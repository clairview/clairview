...
from clairview.models import Organization, OrganizationMembership, Team
        ...
        with self.is_cloud(False):
            ...
            self.assertEqual(
                response.json(),
                {
                    ...
                    "detail": "You must upgrade your ClairView plan to be able to create and manage multiple organizations.",
