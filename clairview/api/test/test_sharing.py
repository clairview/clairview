...
from clairview.api.sharing import shared_url_as_png
from clairview.models import ExportedAsset, ActivityLog
...
class TestSharing(APIBaseTest):
    ...
    @patch("clairview.api.exports.exporter.export_asset.delay")
    ...
    @patch("clairview.api.exports.exporter.export_asset.delay")
    @patch("clairview.models.exported_asset.object_storage.read_bytes")
    @patch("clairview.api.sharing.asset_for_token")
