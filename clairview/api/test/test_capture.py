...
from clairview.api import capture
from clairview.api.capture import (
...
from clairview.api.test.openapi_validation import validate_response
...
android_json = {
    ...
    "properties": {
        ...
        "$screen_width": 1080,
        "$app_version": "1.0",
        "$app_namespace": "com.clairview.android.sample",
        "$app_build": 1,
        "$app_name": "ClairView Android Sample",
...
TEST_SAMPLES_BUCKET = "clairview-test-replay-samples"
...
class TestCapture(BaseTest):
    ...
    def test_cached_is_randomly_partitioned(self):
        ...
        with patch("clairview.api.capture.LIMITER", new=limiter):
    ...
    @patch("clairview.api.capture.configure_scope")
    @patch("clairview.kafka_client.client._KafkaProducer.produce", MagicMock())
    ...
    @patch("clairview.models.utils.UUIDT", return_value="fake-uuid")
    @patch("clairview.kafka_client.client._KafkaProducer.produce")
    ...
    @patch("clairview.kafka_client.client.SessionRecordingKafkaProducer")
    ...
    @patch("clairview.api.capture.session_recording_kafka_producer")
    @patch("clairview.api.capture.KafkaProducer")
    @patch("clairview.kafka_client.client._KafkaProducer.produce")
