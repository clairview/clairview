...
from clairview.api.annotation import AnnotationSerializer
from clairview.api.routing import DefaultRouterPlusPlus
from clairview.models.annotation import Annotation
...
@override_settings(ROOT_URLCONF=__name__)  # Use `urlpatterns` from this file and not from `clairview.urls`
