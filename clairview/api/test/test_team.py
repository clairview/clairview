...
from clairview.api.test.batch_exports.conftest import start_test_worker
from clairview.constants import AvailableFeature
from clairview.models import ActivityLog, EarlyAccessFeature
from clairview.models.async_deletion.async_deletion import AsyncDeletion, DeletionType
...
from clairview.models.product_intent import ProductIntent
from clairview.models.team import Team
from clairview.temporal.common.client import sync_connect
from clairview.temporal.common.schedule import describe_schedule
...
def team_api_test_factory():
    class TestTeamAPI(APIBaseTest):
        ...
        @patch("clairview.api.project.get_geoip_properties")
        @patch("clairview.api.team.get_geoip_properties")
        ...
        @patch("clairview.api.project.delete_bulky_postgres_data")
        @patch("clairview.api.team.delete_bulky_postgres_data")
        ...
        def test_delete_bulky_postgres_data(self):
            ...
            from clairview.models.cohort import Cohort, CohortPeople
            from clairview.models.feature_flag.feature_flag import (
                FeatureFlag,
        ...
        def test_configure_exception_autocapture_event_dropping_only_allows_simple_config(self):
            ...
            assert (
                response.json()["detail"]
                == "Field autocapture_exceptions_errors_to_ignore must be less than 300 characters. Complex config should be provided in clairview-js initialization."
            )
        ...
        @patch("clairview.api.project.report_user_action")
        @patch("clairview.api.team.report_user_action")
        ...
        def test_can_add_product_intent(
            ...
            response = self.client.patch(
                ...
                headers={"Referer": "https://clairviewtest.com/my-url", "X-Clairview-Session-Id": "test_session_id"},
            )
            ...
            mock_report_user_action.assert_called_once_with(
                ...
                "user showed product intent",
                {
                    ...
                    "$current_url": "https://clairviewtest.com/my-url",
