...
class TestInstanceStatus(APIBaseTest):
    ...
    @patch("clairview.api.instance_status.is_postgres_alive")
    @patch("clairview.api.instance_status.is_redis_alive")
    @patch("clairview.api.instance_status.is_plugin_server_alive")
    # patched at the module level because it is locally imported in the target code
    @patch("clairview.clickhouse.system_status.dead_letter_queue_ratio_ok_cached")
    @patch("clairview.api.instance_status.async_migrations_ok")
