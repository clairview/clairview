...
from clairview.models import Cohort, Organization, Person, Team
...
class TestPerson(ClickhouseTestMixin, APIBaseTest):
    ...
    @mock.patch("clairview.api.person.capture_internal")
    ...
    @patch("clairview.api.person.PersonsThrottle.rate", new="6/minute")
