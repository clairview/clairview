...
from clairview.models import User, NotificationViewed
from clairview.test.base import APIBaseTest, QueryMatchingTest, FuzzyInt
...
class TestActivityLog(APIBaseTest, QueryMatchingTest):
    def setUp(self) -> None:
        ...
        self.other_user = User.objects.create_and_join(
            ...
            email="other_user@clairview.com",
            password="",
        )
        self.third_user = User.objects.create_and_join(
            organization=self.organization,
            email="third_user@clairview.com",
            password="",
        )
