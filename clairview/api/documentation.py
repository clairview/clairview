...
from clairview.models.property import OperatorType, PropertyType
...
class PersonalAPIKeyScheme(OpenApiAuthenticationExtension):
    target_class = "clairview.auth.PersonalAPIKeyAuthentication"
...
def custom_postprocessing_hook(result, generator, request, public):
    ...
    return {
        **result,
        "info": {"title": "ClairView API", "version": None, "description": ""},
        "paths": paths,
