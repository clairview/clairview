...
class TestAsyncMigrationDefinition(BaseTest):
    def test_get_async_migration_definition(self):
        from clairview.async_migrations.examples.example import (
            example_fn,
            example_rollback_fn,
        )
        ...
        self.assertEqual(example_migration.clairview_min_version, "1.29.0")
        self.assertEqual(example_migration.clairview_max_version, "1.30.0")
