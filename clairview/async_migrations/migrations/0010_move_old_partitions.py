...
class Migration(AsyncMigrationDefinition):
    ...
    clairview_min_version = "1.43.0"
    clairview_max_version = "1.49.99"
    ...
    def operations(self):
        ...
        operations = [
            AsyncMigrationOperationSQL(
                ...
                ON CLUSTER 'clairview'
                AS sharded_events
                ENGINE = ReplicatedReplacingMergeTree('/clickhouse/tables/{shard}/clairview.{backup_table_name}', '{replica}', _timestamp)
