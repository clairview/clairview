...
from clairview.settings import TEST
...
ASYNC_MIGRATIONS_MODULE_PATH = "clairview.async_migrations.migrations"
ASYNC_MIGRATIONS_EXAMPLE_MODULE_PATH = "clairview.async_migrations.examples"

all_migrations = import_submodules(ASYNC_MIGRATIONS_MODULE_PATH)
reload_migration_definitions()


def setup_async_migrations(ignore_clairview_version: bool = False):
    """
    ...
    3. Check if all migrations necessary for this ClairView version have completed (else don't start)
...
def setup_model(migration_name: str, migration: AsyncMigrationDefinition) -> AsyncMigration:
    ...
    sm.clairview_max_version = migration.clairview_max_version
    sm.clairview_min_version = migration.clairview_min_version
