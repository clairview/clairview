...
class BatchExportDestination(UUIDModel):
    """A model for the destination that a ClairView BatchExport will target.
    ...
    class Destination(models.TextChoices):
        """Enumeration of supported destinations for ClairView BatchExports."""
...
class BatchExportRun(UUIDModel):
    """A model of a single run of a ClairView BatchExport given a time interval.
...
class BatchExport(UUIDModel):
    """
    Defines the configuration of ClairView to export data to a destination,
