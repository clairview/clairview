...
from clairview.clairql.ast import CompareOperationOp, ArithmeticOperationOp
from clairview.clairql.context import ClairQLContext
from clairview.clairql.database.models import DatabaseField, LazyJoinToAdd, LazyTableToAdd
from clairview.clairql.errors import NotImplementedError

from clairview.clairql.visitor import clone_expr, CloningVisitor, Visitor, TraversingVisitor
...
class WhereClauseExtractor(CloningVisitor):
    ...
    def __init__(self, context: ClairQLContext):
        super().__init__()
...
def is_simple_timestamp_field_expression(expr: ast.Expr, context: ClairQLContext, tombstone_string: str) -> bool:
...
class IsSimpleTimestampFieldExpressionVisitor(Visitor[bool]):
    ...
    def __init__(self, context: ClairQLContext, tombstone_string: str):
        self.context = context
        self.tombstone_string = tombstone_string
    ...
    def visit_alias(self, node: ast.Alias) -> bool:
        ...
        from clairview.clairql.database.schema.sessions_v1 import SessionsTableV1
        from clairview.clairql.database.schema.sessions_v2 import SessionsTableV2

        from clairview.clairql.database.schema.session_replay_events import RawSessionReplayEventsTable
...
def rewrite_timestamp_field(expr: ast.Expr, timestamp_field: ast.Expr, context: ClairQLContext) -> ast.Expr:
...
class RewriteTimestampFieldVisitor(CloningVisitor):
    ...
    def __init__(self, context: ClairQLContext, timestamp_field: ast.Expr, *args, **kwargs):
