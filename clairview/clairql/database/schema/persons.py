...
from clairview.clairql.ast import SelectQuery, And, CompareOperation, CompareOperationOp, Field, JoinExpr
...
from clairview.clairql.database.argmax import argmax_select
...
from clairview.clairql.database.schema.util.where_clause_extractor import WhereClauseExtractor
from clairview.clairql.database.schema.persons_pdi import PersonsPDITable, persons_pdi_join
...
from clairview.schema import PersonsArgMaxVersion
...
def select_from_persons_table(
    ...
    *,
    ...
    if version == PersonsArgMaxVersion.V2:
        ...
        select.settings = ClairQLQuerySettings(optimize_aggregation_in_order=True)
