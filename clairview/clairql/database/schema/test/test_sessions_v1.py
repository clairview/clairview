...
from clairview.schema import ClairQLQueryModifiers, BounceRatePageViewMode, SessionTableVersion
...
class TestSessionsV1(ClickhouseTestMixin, APIBaseTest):
    def __execute(self, query):
        modifiers = ClairQLQueryModifiers(sessionTableVersion=SessionTableVersion.V1)
