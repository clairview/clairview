...
from clairview.clairql.escape_sql import escape_clickhouse_string
...
class MultipleInCohortResolver(TraversingVisitor):
    ...
    def _add_join(
        ...
        if must_add_join:
            ...
            # via placeholders once the ClairQL SELECT placeholders functionality is done
