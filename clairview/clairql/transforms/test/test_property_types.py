...
from clairview.models import PropertyDefinition, GroupTypeMapping
...
class TestPropertyTypes(BaseTest):
    ...
    def test_group_boolean_property_types(self):
        ...
        assert (
            ...
            in re.sub(r"%\(clairql_val_\d+\)s", "hogvar", printed)
        )
    ...
    def test_group_types_are_the_same_in_persons_inlined_subselect(self):
        ...
        query = re.sub(r"clairql_val_\d+", "clairql_val", query)
