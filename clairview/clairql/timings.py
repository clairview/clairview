...
class ClairQLTimings:
    ...
    def clone_for_subquery(self, series_index: int):
        return ClairQLTimings(f"{self._timing_pointer}/series_{series_index}")
