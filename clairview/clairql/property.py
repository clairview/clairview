...
from clairview.clairql.functions import find_clairql_aggregation
...
class AggregationFinder(TraversingVisitor):
    ...
    def visit_call(self, node: ast.Call):
        if find_clairql_aggregation(node.name):
...
def _handle_bool_values(value: ValueT, expr: ast.Expr, property: Property, team: Team) -> ValueT | bool:
    ...
    if property.type == "person":
        ...
        if table_or_view:
            ...
            prop_type = prop_type_dict.get("clairql")
