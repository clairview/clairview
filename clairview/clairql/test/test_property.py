...
from clairview.clairql.property import (
    action_to_expr,
    has_aggregation,
    property_to_expr,
    selector_to_expr,
...
from clairview.schema import ClairQLPropertyFilter, RetentionEntity, EmptyPropertyFilter
...
class TestProperty(BaseTest):
    ...
    def test_property_to_expr_clairql(self):
        self.assertEqual(self._property_to_expr({"type": "clairql", "key": "1"}), ast.Constant(value=1))
        self.assertEqual(
            self._property_to_expr(Property(type="clairql", key="1")),
            ast.Constant(value=1),
        )
        self.assertEqual(
            self._property_to_expr(ClairQLPropertyFilter(type="clairql", key="1")),
            ast.Constant(value=1),
        )
    ...
    def test_data_warehouse_person_property(self):
        ...
        DataWarehouseTable.objects.create(
            ...
            columns={
                "string_prop": {"clairql": "StringDatabaseField", "clickhouse": "Nullable(String)"},
                "int_prop": {"clairql": "IntegerDatabaseField", "clickhouse": "Nullable(Int64)"},
                "bool_prop": {"clairql": "BooleanDatabaseField", "clickhouse": "Nullable(Bool)"},
            },
