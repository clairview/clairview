...
from clairview.clairql.visitor import CloningVisitor
from clairview.models import Team
from clairview.schema import ClairQLFilters, SessionPropertyFilter
...
def replace_filters(node: T, filters: Optional[ClairQLFilters], team: Team) -> T:
    return ReplaceFilters(filters, team).visit(node)


class ReplaceFilters(CloningVisitor):
    def __init__(self, filters: Optional[ClairQLFilters], team: Team = None):
        super().__init__()
