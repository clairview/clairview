parser grammar ClairQLParser;

options {
    tokenVocab = ClairQLLexer;
}
...
// SELECT statement
select: (selectUnionStmt | selectStmt | clairqlxTagElement) EOF;
...
//    | EXTRACT LPAREN interval FROM columnExpr RPAREN                                      # ColumnExprExtract   // Interferes with a function call
    ...
    | clairqlxTagElement                                                                    # ColumnExprTagElement
...
clairqlxTagElement
    : LT identifier clairqlxTagAttribute* SLASH GT                                        # ClairqlxTagElementClosed
    | LT identifier clairqlxTagAttribute* GT (clairqlxTagElement | (LBRACE columnExpr RBRACE))? LT SLASH identifier GT     # ClairqlxTagElementNested
    ;
clairqlxTagAttribute
    :   identifier '=' string
...
// This is slightly different in ClairQL compared to ClickHouse SQL
// ClairQL allows unlimited ("*") nestedIdentifier-s "properties.b.a.a.w.a.s".
...
tableExpr
    ...
    | clairqlxTagElement                   # TableExprTag
