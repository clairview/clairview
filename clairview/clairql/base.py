...
from clairview.clairql.constants import ConstantDataType
...
class AST:
    ...
    def accept(self, visitor):
        ...
        # NOTE: Sync with ./test/test_visitor.py#test_clairql_visitor_naming_exceptions
        replacements = {"hog_qlxtag": "clairqlx_tag", "hog_qlxattribute": "clairqlx_attribute", "uuidtype": "uuid_type"}
