...
from clairview.cdp.templates.avo.template_avo import template as template_avo, TemplateAvoMigrator
    ...
    def test_function_works(self):
        self.run_function(
            ...
            globals={
                ...
                "person": {
                    "properties": {"email": "max@clairview.com", "name": "Max", "company": "ClairView"},
                },
            },
        )
        ...
        assert res == snapshot(
            (
                "https://api.avo.app/inspector/clairview/v1/track",
                {
                    "method": "POST",
                    "headers": {
                        "env": "dev",
        ...
        for filters, expected_result in [
            ...
            self.run_function(
                ...
                globals={
                    "event": {
                        "event": "sign up",
                        "properties": {"name": "Max", "company": "ClairView", "job": "Product Engineer"},
                    },
                },
            )
            ...
            "events": [
                {
                    ...
                    "type": "events",
                    "order": 0,
                    "properties": [{"key": "event not in ('sign up', 'page view')", "type": "clairql"}],
                },
            ]
        }
