...
fetch('https://api.avo.app/inspector/clairview/v1/track', {
    'method': 'POST',
    'headers': {
        'env': inputs.environment,
...
class TemplateAvoMigrator(HogFunctionTemplateMigrator):
    plugin_url = "https://github.com/ClairView/clairview-avo-plugin"
    ...
    def migrate(cls, obj):
        ...
        appName = obj.config.get("appName", "ClairView")
