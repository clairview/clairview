...
from clairview.cdp.templates.hubspot.template_hubspot import template as template_hubspot, TemplateHubspotMigrator
...
class TestTemplateHubspot(BaseHogFunctionTemplateTest):
    ...
    def test_function_works(self):
            ...
            (
                "https://api.hubapi.com/crm/v3/objects/contacts/batch/upsert",
                {
                    ...
                    "body": {
                        "inputs": [
                            {
                                "properties": {"company": "ClairView", "email": "example@clairview.com"},
                                "id": "example@clairview.com",
                                "idProperty": "email",
                            }
                        ]
                    },
        ...
        assert self.get_mock_print_calls() == [("Contact example@clairview.com updated successfully!",)]
