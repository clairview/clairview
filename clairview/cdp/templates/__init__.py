...
from .clairview.template_clairview import template as clairview, TemplateClairViewMigrator
...
HOG_FUNCTION_MIGRATORS = {
    ...
    TemplateClairViewMigrator.plugin_url: TemplateClairViewMigrator,
