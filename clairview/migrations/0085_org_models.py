...
def forwards_func(apps, schema_editor):
    User = apps.get_model("clairview", "User")
    Organization = apps.get_model("clairview", "Organization")
    OrganizationMembership = apps.get_model("clairview", "OrganizationMembership")
    Annotation = apps.get_model("clairview", "Annotation")
