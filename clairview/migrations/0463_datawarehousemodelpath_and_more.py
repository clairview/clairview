...
import clairview.warehouse.models.modeling


class Migration(migrations.Migration):
    dependencies = [
        ("clairview", "0462_change_replay_team_setting_defaults"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("path", clairview.warehouse.models.modeling.LabelTreeField()),
                (
                    "created_by",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="clairview.datawarehousesavedquery",
                    ),
                ),
                (
                    "table",
