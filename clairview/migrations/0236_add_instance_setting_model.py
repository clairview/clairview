...
def populate_instance_settings(apps, schema_editor):
    try:
        InstanceSetting = apps.get_model("clairview", "InstanceSetting")
        ...
        logger.info("constance_config table did not exist, skipping populating clairview_instance_setting table")
