...
def migrate_playlist_item_recording_relations(apps, _) -> None:
    Recording = apps.get_model("clairview", "SessionRecording")
    PlaylistItem = apps.get_model("clairview", "SessionRecordingPlaylistItem")
...
class Migration(migrations.Migration):
    dependencies = [
        ("clairview", "0286_index_insightcachingstate_lookup"),
    ]
