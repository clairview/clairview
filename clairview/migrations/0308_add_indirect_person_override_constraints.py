...
class Migration(migrations.Migration):
    dependencies = [
        ("clairview", "0307_pluginconfig_admin"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="clairview.personoverridemapping",
            ),
        ),
        ...
        migrations.RunSQL(
            """
            ALTER TABLE clairview_personoverride
            ...
            INITIALLY DEFERRED
            """,
            "ALTER TABLE clairview_personoverride DROP CONSTRAINT exclude_override_person_id_from_being_old_person_id",
        ),
        migrations.AddConstraint(
