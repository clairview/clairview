...
def mark_inactive_exports_as_finished(apps, _):
    ...
    ActivityLog = apps.get_model("clairview", "ActivityLog")
    PluginStorage = apps.get_model("clairview", "PluginStorage")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("clairview", "0272_alter_organization_plugins_access_level"),
    ]
