...
from clairview.clairql.parser import parse_expr, parse_order_expr
from clairview.clairql.property import has_aggregation
from clairview.clairql_queries.actor_strategies import ActorStrategy, PersonStrategy, GroupStrategy
...
class ActorsQueryRunner(QueryRunner):
    ...
    def calculate(self) -> ActorsQueryResponse:
        ...
        response = self.paginator.execute_clairql_query(
