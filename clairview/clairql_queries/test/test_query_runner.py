...
from clairview.clairql_queries.query_runner import ExecutionMode, QueryRunner
...
class TestQueryRunner(BaseTest):
    ...
    def test_modifier_passthrough(self):
        ...
        runner = ClairQLQueryRunner(
            query=ClairQLQuery(query="select properties.$browser from events"),
            team=self.team,
