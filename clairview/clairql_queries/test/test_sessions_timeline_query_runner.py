...
from clairview.clairql_queries.sessions_timeline_query_runner import SessionsTimelineQueryRunner
from clairview.schema import EventType, SessionsTimelineQuery, TimelineEntry
from clairview.session_recordings.queries.test.session_replay_sql import produce_replay_summary
from clairview.test.base import APIBaseTest, ClickhouseTestMixin, snapshot_clickhouse_queries
...
class TestSessionsTimelineQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    @snapshot_clickhouse_queries
    @patch("clairview.clairql_queries.sessions_timeline_query_runner.SessionsTimelineQueryRunner.EVENT_LIMIT", 2)
