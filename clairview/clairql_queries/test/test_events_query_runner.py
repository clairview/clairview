...
from clairview.clairql.ast import CompareOperationOp
from clairview.clairql_queries.events_query_runner import EventsQueryRunner
from clairview.models import Person, Team
...
class TestEventsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_is_not_set_boolean(self):
        # see https://github.com/ClairView/clairview/issues/18030
    ...
    def test_test_account_filters(self):
        ...
        self.assertEqual(right_expr.value, "%clairview.com%")
