    ...
    "values": [
        {
            ...
            "values": [
                ...
                {"type": "clairql", "key": "properties.name", "value": None},
            ],
        },
        {"type": "OR", "values": [{}]},
    ],
...
class TestFilterToQuery(BaseTest):
        ...
        filter = {
            "events": [
                ...
                },  # unique group
                {
                    "id": "$pageview",
                    "math": "clairql",
                    "math_clairql": "avg(toInt(properties.$session_id)) + 1000",
                },  # clairql
            ]
        }
        ...
        self.assertEqual(
            ...
            [
                ...
                EventsNode(
                    event="$pageview",
                    name="$pageview",
                    properties=[ClairQLPropertyFilter(key="dateDiff('minute', timestamp, now()) < 30")],
                ),
                EventsNode(
                    event="$pageview",
                    name="$pageview",
    ...
    def test_funnels_filter(self):
        filter = {
            ...
            "funnel_aggregate_by_clairql": "person_id",
            "exclusions": [
                {
                    "id": "$pageview",
                    "type": "events",
        ...
        self.assertEqual(
            ...
            FunnelsFilter(
                ...
                binCount=15,
                funnelAggregateByClairQL="person_id",
    ...
    def test_paths_filter(self):
        ...
        self.assertEqual(
            query.pathsFilter,
            PathsFilter(
                includeEventTypes=[PathType.FIELD_PAGEVIEW, PathType.CLAIRQL],
                pathsClairQLExpression="event",
