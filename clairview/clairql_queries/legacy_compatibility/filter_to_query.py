...
from clairview.clairql_queries.legacy_compatibility.clean_properties import clean_entity_properties, clean_global_properties
from clairview.models.entity.entity import Entity as LegacyEntity
    ...
    if _insight_type(filter) == "TRENDS":
        ...
        insight_filter = {
            "funnelsFilter": FunnelsFilter(
                ...
                funnelAggregateByClairQL=filter.get("funnel_aggregate_by_clairql"),
            ),
        }
        ...
        insight_filter = {
            "pathsFilter": PathsFilter(
                pathsClairQLExpression=filter.get("paths_clairql_expression"),
