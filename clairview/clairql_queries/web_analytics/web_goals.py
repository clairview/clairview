...
from clairview.clairql.property import property_to_expr, get_property_type, action_to_expr
...
class WebGoalsQueryRunner(WebAnalyticsQueryRunner):
    ...
    def to_query(self) -> ast.SelectQuery | ast.SelectUnionQuery:
        with self.timings.measure("date_expr"):
            start = self.query_date_range.date_from_as_clairql()
            end = self.query_date_range.date_to_as_clairql()
