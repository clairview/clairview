...
from clairview.clairql_queries.web_analytics.web_overview import WebOverviewQueryRunner
...
class TestWebOverviewQueryRunner(ClickhouseTestMixin, APIBaseTest):
            ...
            with freeze_time(timestamps[0][0]):
                person_result.append(
                    _create_person(
                        ...
                        properties={
                            "name": id,
                            **({"email": "test@clairview.com"} if id == "test" else {}),
                        },
                    )
                )
    ...
    def _run_web_overview_query(
        ...
        modifiers = ClairQLQueryModifiers(sessionTableVersion=session_table_version)
