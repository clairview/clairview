...
from clairview.clairql_queries.web_analytics.web_goals import WebGoalsQueryRunner
from clairview.models import Action, Person, Element
...
class TestWebGoalsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def _create_person(self):
        ...
        return _create_person(
            ...
            properties={
                "name": distinct_id,
                **({"email": "test@clairview.com"} if distinct_id == "test" else {}),
            },
        )
    ...
    def _visit_web_analytics(self, person: Person, session_id: Optional[str] = None):
        _create_event(
            ...
            properties={
                ...
                "$current_url": "https://us.clairview.com/project/2/web",
    ...
    def _create_actions(self):
        ...
        Action.objects.create(
            ...
            steps_json=[
                {
                    "event": "$pageview",
                    "url": "https://(app|eu|us)\\.clairview\\.com/project/\\d+/web.*",
                    "url_matching": "regex",
                }
            ],
        )
