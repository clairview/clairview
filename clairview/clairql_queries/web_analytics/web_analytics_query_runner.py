    ...
    def session_where(self, include_previous_period: Optional[bool] = None):
        properties = [
            parse_expr(
                ...
                placeholders={
                    "date_from": self.query_date_range.previous_period_date_from_as_clairql()
                    if include_previous_period
                    else self.query_date_range.date_from_as_clairql(),
        ...
        return property_to_expr(
            [
                parse_expr(
                    ...
                    placeholders={"date_from": self.query_date_range.date_from_as_clairql()},
                ),
                parse_expr(
                    "events.timestamp < {date_to}",
                    placeholders={"date_to": self.query_date_range.date_to_as_clairql()},
                ),
            ],
            self.team,
        )
