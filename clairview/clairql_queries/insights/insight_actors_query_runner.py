...
from clairview.clairql.constants import ClairQLGlobalSettings
from clairview.clairql.query import execute_clairql_query
from clairview.clairql_queries.insights.funnels.funnel_correlation_query_runner import FunnelCorrelationQueryRunner
from clairview.clairql_queries.insights.funnels.funnels_query_runner import FunnelsQueryRunner
from clairview.clairql_queries.insights.lifecycle_query_runner import LifecycleQueryRunner
from clairview.clairql_queries.insights.paths_query_runner import PathsQueryRunner
from clairview.clairql_queries.insights.retention_query_runner import RetentionQueryRunner
from clairview.clairql_queries.insights.stickiness_query_runner import StickinessQueryRunner
from clairview.clairql_queries.insights.trends.trends_query_runner import TrendsQueryRunner
from clairview.clairql_queries.query_runner import QueryRunner, get_query_runner
...
from clairview.types import InsightActorsQueryNode
...
class InsightActorsQueryRunner(QueryRunner):
    ...
    def calculate(self) -> ClairQLQueryResponse:
        ...
        if isinstance(self.source_runner, FunnelsQueryRunner):
            settings = ClairQLGlobalSettings(allow_experimental_analyzer=True)

        return execute_clairql_query(
