...
from clairview.clairql_queries.insights.funnels.base import FunnelBase
from clairview.clairql_queries.insights.funnels.funnel_query_context import FunnelQueryContext
from clairview.clairql_queries.insights.funnels.utils import get_funnel_order_class
from clairview.clairql_queries.insights.utils.utils import get_start_of_interval_clairql
...
from clairview.queries.util import correct_result_for_sampling, get_earliest_timestamp, get_interval_func_ch
...
class FunnelTrends(FunnelBase):
        ...
        fill_select: list[ast.Expr] = [
            ast.Alias(
                ...
                expr=ast.ArithmeticOperation(
                    left=get_start_of_interval_clairql(interval.value, team=team, source=date_from_as_clairql),
                ...
                ast.ArithmeticOperation(
                    left=ast.Call(
                        ...
                        args=[
                            ...
                            get_start_of_interval_clairql(interval.value, team=team, source=date_from_as_clairql),
                            get_start_of_interval_clairql(interval.value, team=team, source=date_to_as_clairql),
                        ],
                    ),
    ...
    def get_step_counts_without_aggregation_query(
        ...
        select: list[ast.Expr] = [
            ...
            ast.Alias(alias="entrance_period_start", expr=get_start_of_interval_clairql(interval.value, team=team)),
