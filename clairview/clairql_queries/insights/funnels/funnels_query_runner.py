...
from clairview.clairql_queries.insights.funnels.funnel_time_to_convert import FunnelTimeToConvert
from clairview.clairql_queries.insights.funnels.funnel_trends import FunnelTrends
from clairview.clairql_queries.insights.funnels.funnel_trends_udf import FunnelTrendsUDF
from clairview.clairql_queries.insights.funnels.utils import get_funnel_actor_class, get_funnel_order_class, use_udf
...
class FunnelsQueryRunner(QueryRunner):
    ...
    def calculate(self):
        ...
        # TODO: can we get this from execute_clairql_query as well?
        ...
        return FunnelsQueryResponse(
            isUdf=self._use_udf, results=results, timings=timings, clairql=clairql, modifiers=self.modifiers
        )
