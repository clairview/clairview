...
from clairview.clairql_queries.insights.utils.properties import Properties
...
class FunnelEventQuery:
    ...
    def _aggregation_target_expr(self) -> ast.Expr:
        ...
        elif funnelsFilter.funnelAggregateByClairQL and funnelsFilter.funnelAggregateByClairQL != "person_id":
            aggregation_target = parse_expr(funnelsFilter.funnelAggregateByClairQL)
