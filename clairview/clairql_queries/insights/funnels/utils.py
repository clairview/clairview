from clairview.constants import FUNNEL_WINDOW_INTERVAL_TYPES
...
from clairview.schema import FunnelConversionWindowTimeUnit, FunnelVizType, FunnelsFilter, StepOrderValue
...
def get_funnel_order_class(funnelsFilter: FunnelsFilter, use_udf=False):
    from clairview.clairql_queries.insights.funnels import (
        Funnel,
        FunnelUDF,
        FunnelStrict,
        FunnelUnordered,
