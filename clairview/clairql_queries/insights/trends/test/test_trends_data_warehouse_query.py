...
from clairview.warehouse.models import DataWarehouseTable, DataWarehouseCredential
...
TEST_BUCKET = "test_storage_bucket-clairview.clairql.datawarehouse.trendquery" + XDIST_SUFFIX
...
class TestTrendsDataWarehouseQuery(ClickhouseTestMixin, BaseTest):
    ...
    def test_trends_breakdown_on_view(self):
        from clairview.warehouse.models import DataWarehouseSavedQuery
