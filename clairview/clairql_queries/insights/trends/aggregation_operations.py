...
from clairview.constants import NON_TIME_SERIES_DISPLAY_TYPES
...
from clairview.clairql_queries.insights.utils.aggregations import (
...
class AggregationOperations(DataWarehouseInsightQueryMixin):
    ...
    def select_aggregation(self) -> ast.Expr:
        if self.series.math == "clairql" and self.series.math_clairql is not None:
            return parse_expr(self.series.math_clairql)
