...
from clairview.schema import CachedPathsQueryResponse
...
@patch("clairviewanalytics.feature_enabled", new=Mock(side_effect=insight_funnels_use_udf_funnel_flag_side_effect))
