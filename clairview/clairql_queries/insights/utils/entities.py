...
from clairview.types import AnyPropertyFilter, EntityNode, ExclusionEntityNode
...
def _semantic_property_repr(property: AnyPropertyFilter) -> str:
    if isinstance(property, EmptyPropertyFilter):
        return ""
    elif isinstance(property, ClairQLPropertyFilter) or isinstance(property, CohortPropertyFilter):
