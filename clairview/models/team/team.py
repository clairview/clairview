...
from clairview.helpers.dashboard_templates import create_dashboard_from_template
...
# keep in sync with clairview/frontend/src/scenes/project/Settings/ExtraTeamSettings.tsx
...
class TeamManager(models.Manager):
    ...
    def increment_id_sequence(self) -> int:
        ...
        cursor.execute("SELECT nextval('clairview_team_id_seq')")
...
class Team(UUIDClassicModel):
    ...
    def _person_on_events_person_id_no_override_properties_on_events(self) -> bool:
        ...
        # on ClairView Cloud, use the feature flag
        if is_cloud():
    ...
    def kick_off_demo_data_generation(self, initiating_user: "User") -> None:
        from clairview.tasks.demo_create_data import create_data_for_demo_team
