...
from clairview.settings import INSTANCE_TAG, SITE_URL
...
class User(AbstractUser, UUIDClassicModel):
    ...
    current_team = models.ForeignKey("clairview.Team", models.SET_NULL, null=True, related_name="teams_currently+")
