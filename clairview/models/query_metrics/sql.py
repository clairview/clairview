...
from clairview.clickhouse.kafka_engine import KAFKA_COLUMNS_WITH_PARTITION, kafka_engine
from clairview.clickhouse.table_engines import MergeTreeEngine
...
# Invoke via `python manage.py shell <  clairview/models/query_metrics/sql.py`
