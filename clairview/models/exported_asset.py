...
class ExportedAsset(models.Model):
    ...
    dashboard = models.ForeignKey("clairview.Dashboard", on_delete=models.CASCADE, null=True)
    insight = models.ForeignKey("clairview.Insight", on_delete=models.CASCADE, null=True)
