...
from clairview.utils import absolute_uri, generate_cache_key, generate_short_id
...
class InsightViewed(models.Model):
    ...
    class Meta:
        constraints = [models.UniqueConstraint(fields=["team", "user", "insight"], name="clairview_unique_insightviewed")]
