...
from clairview.models.integration import Integration, OauthIntegration, SlackIntegration, GoogleCloudIntegration
from clairview.test.base import BaseTest


def get_db_field_value(field, model_id):
    cursor = connection.cursor()
    cursor.execute(f"select {field} from clairview_integration where id='{model_id}';")
    return cursor.fetchone()[0]


def update_db_field_value(field, model_id, value):
    cursor = connection.cursor()
    cursor.execute(f"update clairview_integration set {field}='{value}' where id='{model_id}';")
...
class TestOauthIntegrationModel(BaseTest):
    ...
    @patch("clairview.models.integration.requests.post")
    ...
    @patch("clairview.models.integration.requests.post")
    @patch("clairview.models.integration.requests.get")
    ...
    @patch("clairview.models.integration.reload_integrations_on_workers")
    @patch("clairview.models.integration.requests.post")
...
class TestGoogleCloudIntegrationModel(BaseTest):
    mock_keyfile = {
        ...
        "project_id": "clairview-616",
        "private_key_id": "df3e129a722a865cc3539b4e69507bad",
        "private_key": "-----BEGIN PRIVATE KEY-----\nTHISISTHEKEY==\n-----END PRIVATE KEY-----\n",
        "client_email": "hog-pubsub-test@clairview-301601.iam.gserviceaccount.com",
        "client_id": "11223344556677889900",
        "auth_uri": "https://accounts.google.com/o/oauth2/auth",
        "token_uri": "https://oauth2.googleapis.com/token",
        "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
        "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/not-a-topic%40clairview-616.iam.gserviceaccount.com",
    ...
    def test_integration_from_key(self, mock_credentials):
        mock_credentials.return_value.project_id = "clairview-616"
        mock_credentials.return_value.service_account_email = "clairview@"
