...
class TestTeam(BaseTest):
    def test_all_users_with_access_simple_org_membership(self):
        ...
        another_user = User.objects.create_and_join(self.organization, "test2@clairview.com", None)
    ...
    def test_all_users_with_access_while_access_control_org_membership(self):
        ...
        User.objects.create_and_join(
            self.organization, email="test2@clairview.com", password=None, level=OrganizationMembership.Level.MEMBER
        )
