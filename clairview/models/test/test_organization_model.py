...
from clairview.models import Organization, OrganizationInvite, Plugin
...
from clairview.plugins.test.plugin_archives import HELLO_WORLD_PLUGIN_GITHUB_ZIP
...
class TestOrganization(BaseTest):
    ...
    def test_plugins_are_preinstalled_on_self_hosted(self, mock_get):
        ...
        mock_get.assert_any_call(
            f"https://github.com/ClairView/helloworldplugin/archive/{HELLO_WORLD_PLUGIN_GITHUB_ZIP[0]}.zip",
            headers={},
        )
