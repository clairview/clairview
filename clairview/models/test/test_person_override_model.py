...
from clairview.models import Person, PersonOverride, PersonOverrideMapping, Team
...
def _merge_people(
    ...
    Note that we don't actually handle the merge on the clairview_person table,
    ...
    # The following INSERTs and UPDATEs will lock clairview_personoverridemapping
    ...
    cursor.execute(
        """
            WITH insert_id AS (
                INSERT INTO clairview_personoverridemapping(
                    team_id,
                    uuid
                )
                VALUES (
            ...
            SELECT id
            FROM clairview_personoverridemapping
    ...
    cursor.execute(
        """
            INSERT INTO clairview_personoverride(
                team_id,
                old_person_id,
                override_person_id,
                oldest_event,
