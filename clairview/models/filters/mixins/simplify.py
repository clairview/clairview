...
from clairview.models.property import GroupTypeIndex, PropertyGroup
from clairview.schema import PropertyOperator

if TYPE_CHECKING:  # Avoid circular import
    from clairview.models import Property, Team
...
class SimplifyFilterMixin:
    ...
    def simplify(self: T, team: "Team", **kwargs) -> T:
        ...
        from clairview.models.property.util import clear_excess_levels
    ...
    def _simplify_entity(
        ...
        **kwargs,
        ...
        from clairview.models.entity import Entity, ExclusionEntity
    ...
    def _simplify_property(self, team: "Team", property: "Property", **kwargs) -> "PropertyGroup":
        if property.type == "cohort":
            ...
            from clairview.models.cohort.util import simplified_cohort_filter_properties
