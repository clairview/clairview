...
from clairview.models.property import Property, PropertyIdentifier
from clairview.models.property.property import OperatorType
...
def get_action_tables_and_properties(action: Action) -> TCounter[PropertyIdentifier]:
    from clairview.models.property.util import extract_tables_and_properties
