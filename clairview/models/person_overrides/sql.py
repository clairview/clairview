# Within ClairView, it is possible that two Persons are merged together. The
...
from clairview.kafka_client.topics import KAFKA_PERSON_OVERRIDE
...
PERSON_OVERRIDES_CREATE_TABLE_SQL = f"""
    ...
    ON CLUSTER '{CLICKHOUSE_CLUSTER}' (
        ...
        --`clairview_personoverrides` table
