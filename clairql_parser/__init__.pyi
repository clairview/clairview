from clairview.clairql.ast import SelectQuery, SelectUnionQuery, Program
from clairview.clairql.base import AST

def parse_expr(expr: str, /, *, is_internal: bool = False) -> AST:
    """Parse the ClairQL expression string into an AST.
...
def parse_select(expr: str, /, *, is_internal: bool = False) -> SelectQuery | SelectUnionQuery:
    """Parse the ClairQL SELECT statement string into an AST.
