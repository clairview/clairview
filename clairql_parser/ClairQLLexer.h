...
// Generated from ClairQLLexer.g4 by ANTLR 4.13.2
...
class  ClairQLLexer : public antlr4::Lexer {
public:
  enum {
  ...
  explicit ClairQLLexer(antlr4::CharStream *input);

  ~ClairQLLexer() override;
