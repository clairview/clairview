/**
 * Variables in the environment that Clairview will read as configuration
 */
export const CLAIRVIEW_VARIABLES = [
	// general
	'CONFIG_PATH',
	'HOST',
	'PORT',
...
/**
 * Variables in the environment that Clairview will read as configuration in RegExp format
 */
export const CLAIRVIEW_VARIABLES_REGEX = CLAIRVIEW_VARIABLES.map((name) => new RegExp(`^${name}$`));
