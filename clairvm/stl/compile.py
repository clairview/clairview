...
source = "clairvm/stl/src/*.hog"
target_ts = "clairvm/typescript/src/stl/bytecode.ts"
target_py = "clairvm/python/stl/bytecode.py"
...
with open(target_ts, "w") as output:
    output.write("// This file is generated by clairvm/stl/compile.py\n")
